...
$footer_bg_image           = ( ! empty( $options['footer-background-image'] ) && ! empty( $options['footer-background-image']['url'] ) ) ? republicpg_options_img( $options['footer-background-image'] ) : false;
...
republicpg_hook_before_body_close();
