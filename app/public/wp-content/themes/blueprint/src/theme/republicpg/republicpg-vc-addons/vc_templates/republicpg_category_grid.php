...
echo '<div class="republicpg-category-grid" data-columns="'. $columns .'" data-text-style="'.$text_style.'" data-grid-spacing="'.$grid_item_spacing.'" data-alignment="'.$text_content_alignment.'" data-text-color="'.$text_color.'" data-text-hover-color="'.$text_color_hover.'" data-shadow-hover="'.$shadow_on_hover.'" data-masonry="'. $enable_masonry .'">';
...
if($post_type == 'posts') {
    ...
    if($blog_category == 'all') {
      ...
      foreach( $categories as $temp_cat_obj_holder ){
            ...
            echo republicpg_grid_item_markup($temp_cat_obj_holder, $atts);
