<?php
   ...
   extract(shortcode_atts(array(
    ...
    'marker_image_height' => '50',
	  'republicpg_marker_color' => 'accent-color',
  ...
  if($map_type == 'google') {
  	wp_enqueue_script('republicpgMap', get_template_directory_uri() . '/js/map.js', array('jquery'), '8.5.4', TRUE);
