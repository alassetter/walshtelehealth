  ...
  if ( 'yes' !== $disable_element ) {
      ...
      if(!empty($translate_y) || !empty($translate_x)) {
    	...
    	if($video_bg) {
    		...
    		<div class="republicpg-video-wrap" data-bg-alignment="'.$bg_position.'">
    			
    			
    			<video class="republicpg-video-bg" width="1800" height="700" '.$poster_markup.' controls="controls" preload="auto" loop autoplay>';
