...
if($woocommerce) {
  ...
  return array(
    ...
    array(
      ...
      'save_always' => true,
      'description' => __( 'Select the alignment of your text content.', 'blueprint')
    ),
    ...
    array(
      ...
      'save_always' => true,
      'description' => __( 'Select what will display under the category names.', 'blueprint')
    ),
    array(
        "type" => "textfield",
