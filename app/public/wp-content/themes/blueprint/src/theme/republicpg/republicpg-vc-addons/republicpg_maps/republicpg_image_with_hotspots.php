...
return array(
		  ...
		  "weight" => 2,
		  "icon" => "icon-wpb-republicpg-image-withhotspots",
		  ...
		  "params" => array(
			...
			array(
		      ...
		      "param_name" => "preview",
		      "description" => esc_html__("Click to add - Drag to move - Edit content below. Note: this preview will not reflect hotspot style choices or show tooltips. This is only used as a visual guide for positioning. Requires Blueprint VC 4.12 or higher.", "js_composer"),
		      "value" => ''
		    ),	
			 array(
		      "type" => "textarea_html",
			...
			"admin_label" => true,
			"param_name" => "color_1",
			'description' => __( 'Choose a color from your','blueprint') . ' <a target="_blank" href="'. esc_url(admin_url()) .'?page=Blueprint&tab=6"> ' . esc_html__('globally defined color scheme','blueprint') . '</a>',
