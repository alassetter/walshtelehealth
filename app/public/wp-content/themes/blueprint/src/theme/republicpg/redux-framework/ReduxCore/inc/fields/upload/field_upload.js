...
jQuery(document).ready(function(){
	...
	jQuery(".redux-opts-media-upload").click( function( event ) {
                ...
                custom_file_frame.on( "select", function() {
				    ...
				    jQuery('#_republicpg_video_embed').trigger('keyup');
    ...
    function toggleParallaxOption(){
    	if(jQuery('#_republicpg_header_bg').length > 0){
	    	if(jQuery('#_republicpg_header_bg').attr('value').length > 0 || jQuery('#_republicpg_header_bg_color').length > 0 && jQuery('#_republicpg_header_bg_color').attr('value').length > 0){
	    		jQuery('#_republicpg_header_parallax').parents('tr').show();
	    	} else {
	    		jQuery('#_republicpg_header_parallax').parents('tr').hide();
	    		jQuery('#_republicpg_header_parallax').prop('checked', false);
	    	}
    	}
    }
