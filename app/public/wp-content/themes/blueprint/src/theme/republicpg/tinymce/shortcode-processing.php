...
//half columns
function republicpg_one_half( $atts, $content = null ) {
...
add_shortcode('one_half', 'republicpg_one_half');

function republicpg_one_half_last( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('one_half_last', 'republicpg_one_half_last');



//one third columns
function republicpg_one_third( $atts, $content = null ) {
	extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('one_third', 'republicpg_one_third');

function republicpg_one_third_last( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('one_third_last', 'republicpg_one_third_last');

function republicpg_two_thirds( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('two_thirds', 'republicpg_two_thirds');

function republicpg_two_thirds_last( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('two_thirds_last', 'republicpg_two_thirds_last');



//one fourth columns
function republicpg_one_fourth( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('one_fourth', 'republicpg_one_fourth');

function republicpg_one_fourth_last( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('one_fourth_last', 'republicpg_one_fourth_last');

function republicpg_three_fourths( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('three_fourths', 'republicpg_three_fourths');

function republicpg_three_fourths_last( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('three_fourths_last', 'republicpg_three_fourths_last');



//one sixth columns
function republicpg_one_sixth( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('one_sixth', 'republicpg_one_sixth');

function republicpg_one_sixth_last( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('one_sixth_last', 'republicpg_one_sixth_last');

function republicpg_five_sixths( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('five_sixths', 'republicpg_five_sixths');

function republicpg_five_sixths_last( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('five_sixths_last', 'republicpg_five_sixths_last');



function republicpg_one_whole( $atts, $content = null ) {
    extract(shortcode_atts(array("boxed" => 'false', "centered_text" => 'false', 'animation' => '', 'delay' => '0'), $atts));
	$column_classes = null;
	$box_border = null;
	$parsed_animation = null;
...
add_shortcode('one_whole', 'republicpg_one_whole');
...
//full width section
function republicpg_full_width_section($atts, $content = null) {
...
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode('full_width_section', 'republicpg_full_width_section');
}

//image with animation
function republicpg_image_with_animation($atts, $content = null) {
...
add_shortcode('image_with_animation', 'republicpg_image_with_animation');


//testimonial slider
function republicpg_testimonial_slider($atts, $content = null) {
...
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode('testimonial_slider', 'republicpg_testimonial_slider');
}

//testimonial
function republicpg_testimonial($atts, $content = null) {
    extract(shortcode_atts(array("name" => '', "quote" => ''), $atts));

    return '<blockquote><p>'.$quote.'</p>'. '<span>'.$name.'</span></blockquote>';
}
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode('testimonial', 'republicpg_testimonial');
}


//heading
function republicpg_heading($atts, $content = null) {
...
add_shortcode('heading', 'republicpg_heading');



//divider
function republicpg_divider($atts, $content = null) {
...
add_shortcode('divider', 'republicpg_divider');


//divider
function republicpg_dropcap_proc($atts, $content = null) {
	 extract(shortcode_atts(array("color" => ''), $atts));

	 $color_str = null;
	if(!empty($color)) $color_str = 'style=" color: '.$color.';"';
    return '<span class="republicpg-dropcap" '.$color_str.'>'.$content.'</span>';
}

add_shortcode('republicpg_dropcap', 'republicpg_dropcap_proc');


//milestone
function republicpg_milestone($atts, $content = null) {
    ...
    return $milestone_wrap . '<div class="republicpg-milestone '. $motion_blur . '" '. $symbol_markup.' data-ms-align="'.$milestone_alignment.'" > '.$number_markup.' '.$subject_markup.' </div>' . $milestone_wrap_close;
}
add_shortcode('milestone', 'republicpg_milestone');



//text with icon
function republicpg_text_with_icon($atts, $content = null) {
...
add_shortcode('text-with-icon', 'republicpg_text_with_icon');


//fancy list
function republicpg_fancy_list($atts, $content = null) {
	...
	if($icon_type == 'font_icon'){
		...
		$icon_markup = 'data-list-icon="icon-blueprint-thin-line" data-animation="'.$enable_animation.'" data-animation-delay="'.$delay.'" data-color="'. strtolower($color).'"';
	}

	$output .= '<div class="republicpg-fancy-ul" '.$icon_markup.' data-alignment="'.$alignment.'"> '.do_shortcode($content).' </div>';

    return $output;
}
add_shortcode('fancy-ul', 'republicpg_fancy_list');




//button
function republicpg_button($atts, $content = null) {
	...
	switch ($size) {
		case 'small' :
			$button_open_tag .= '<a class="republicpg-button small '. strtolower($color) . $has_icon . $stnd_button.'" '. $target;
			break;
		case 'medium' :
			$button_open_tag .= '<a class="republicpg-button medium ' . strtolower($color) . $has_icon . $stnd_button.'" '. $target;
			break;
		case 'large' :
			$button_open_tag .= '<a class="republicpg-button large '. strtolower($color) . $has_icon . $stnd_button.'" '. $target;
			break;
		case 'jumbo' :
			$button_open_tag .= '<a class="republicpg-button jumbo '. strtolower($color) . $has_icon . $stnd_button.'" '. $target;
			break;
		case 'extra_jumbo' :
			$button_open_tag .= '<a class="republicpg-button extra_jumbo '. strtolower($color) . $has_icon . $stnd_button.'" '. $target;
			break;
	}
	...
	if($color != 'see-through-3d') {
		...
		return '
		<div class="republicpg-3d-transparent-button" data-size="'.$size.'">
...
add_shortcode('button', 'republicpg_button');



//icon
function republicpg_icon($atts, $content = null) {
	...
	if(strpos($image,'.svg') !== false) {
		...
		//non gradient uses svg
			...
			$svg_icon = '<div class="republicpg_icon_wrap"><span class="svg-icon-holder" data-size="'. $icon_size . '" data-animation-speed="'.$animation_speed_time.'" data-animation="'.$enable_animation.'" data-animation-delay="'.$animation_delay.'" data-color="'.strtolower($color) .'"><span>';
...
add_shortcode('icon', 'republicpg_icon');



//bar graph - must remain for legacy users
function republicpg_bar_graph($atts, $content = null) {
    return do_shortcode($content);
}
add_shortcode('bar_graph', 'republicpg_bar_graph');


function republicpg_bar($atts, $content = null) {
	extract(shortcode_atts(array("title" => 'Title', "percent" => '1', 'color' => 'Accent-Color', 'id' => ''), $atts));
	$bar = '
	<div class="republicpg-progress-bar">
		<p>' . $title . '</p>
		<div class="bar-wrap"><span class="'.strtolower($color).'" data-width="' . $percent . '"> <strong><i>' . $percent . '</i>%</strong> </span></div>
	</div>';
    return $bar;
}
add_shortcode('bar', 'republicpg_bar');

//Team Member
function republicpg_team_member($atts, $content = null) {
  ...
  $link_new_tab_markup = ($team_member_link_new_tab == 'true') ? 'target="_blank"': '';
    ...
    if($team_memeber_style == 'bio_fullscreen') {
     ...
     $social_markup .= '</div>';
    	...
    	<div class="republicpg_team_bio_img" data-img-src="'.$bio_image_url_src.'"></div>
    	<div class="republicpg_team_bio">'.$team_member_bio.  $social_markup .'</div>
    	</div>';
	...
	if($team_memeber_style == 'meta_overlaid' || $team_memeber_style == 'meta_overlaid_alt'){
		...
		if(!empty($image_url)){
				...
				//image link
				if(!empty($link_url_2)){
					$html .= '<a href="'.$link_url_2.'" '.$link_new_tab_markup.'></a><div class="team-member-image" style="background-image: url('. REPUBLICPG_FRAMEWORK_DIRECTORY . 'assets/img/team-member-default.jpg);"></div>';
				} else {
					$html .= '<div class="team-member-image" style="background-image: url('. REPUBLICPG_FRAMEWORK_DIRECTORY . 'assets/img/team-member-default.jpg);"></div>';
				}
		...
		if(!empty($image_url)){
			...
			//image link
			if($link_element == 'image' || $link_element == 'both'){
				$html .= '<a href="'.$link_url.'" '.$link_new_tab_markup.'><img alt="'.$name.'" src="' . REPUBLICPG_FRAMEWORK_DIRECTORY . 'assets/img/team-member-default.jpg" title="' . $name . '" /></a>';
			} else {
				$html .= '<img alt="'.$name.'" src="' . REPUBLICPG_FRAMEWORK_DIRECTORY . 'assets/img/team-member-default.jpg" title="' . $name . '" />';
			}
...
add_shortcode('team_member', 'republicpg_team_member');

////////////////////////
//Home Builder
function republicpg_home_builder($atts, $content = null)
{
    extract(shortcode_atts(array(
      'description' => '',
      'home_builder_bio' => '',
      ...
      'link_element' => 'none',
      'bldr_home_site_size' => '',
      'bldr_home_size_range' => '',
      'bldr_arch_styles' => '',
      'bldr_sales_counselor' => '',
      'bldr_sales_counselor_email' => '',
      'bldr_phone' => '',
      'bldr_phone_link' => '',
      'model_address' => '',
      'model_arch_style' => '',
      ...
      'model_directions' => '',
      'schedule_a_tour' => '',
      'find_your_home_by_builder' => '',
    ), $atts));

    $html = null;

    //fullscreen bio
    if ($home_builder_style == 'bio_fullscreen') {
        $bio_image_url_src = null;
        $home_builder_alt = null;
        $find_your_home_url = '/find-a-home/';
        ...
        if (!empty($image_url)) {
            if (preg_match('/^\d+$/', $image_url)) {
                $home_builder_alt = get_post_meta($image_url, '_wp_attachment_image_alt', true);
                $image_src = wp_get_attachment_image_src($image_url, 'regular');
                $image_url = $image_src[0];
            }
        }
        ...
        $html .= '<div class="home-builder" data-style="'.$home_builder_style.'">

      <div class="home-builder-image"><img src="'.$image_url.'" alt="'.$home_builder_alt.'" width="500" height="500" /></div>
        <div class="home-builder-overlay"></div>
        <div class="home-builder-meta">
          <h3>' . $price_range . '</h3>
          <div class="arrow-end fa fa-angle-right"></div>
          <div class="arrow-line"></div>
        </div>

      <div class="republicpg_builder_bio_img" data-img-src="'.$bio_image_url_src.'"></div>

      <div class="republicpg_builder_bio">

      <div class="home-builder-meta2">
        <div class="title"><h3>' . $name . '</h3></div>
        <p>'.$home_builder_bio.'</p>
      </div>



          <div class="wpb_content_element  builder-profile-panel" data-interval="0">
            <div class="wpb_wrapper tabbed clearfix" data-style="minimal" data-spacing="default" data-icon-size="24" data-full-width-line="" data-color-scheme="accent-color" data-alignment="left">
              <ul class="wpb_tabs_nav ui-tabs-nav clearfix">
                <li><a href="#tab-details" class="active-tab">Details</a></li>
                <li><a href="#tab-model-home" class="">Model Home</a></li>
              </ul>


              <div id="tab-details" data-tab-icon="" class="wpb_tab ui-tabs-panel wpb_ui-tabs-hide clearfix" style="visibility: visible; position: relative; opacity: 1; left: 0px; display: block;">

                <div class="wpb_text_column wpb_content_element  builder-profile-panel-info">
                  <div class="wpb_wrapper">
                    <div class="item_labels">
                      <ul>
                        <li>
                          <h6>Home Site Sizes:</h6></li>
                        <li>
                          <h6>Home Sizes:</h6></li>
                        <li>
                        ...
                        <li>
                          <h6>Architecture Styles:</h6>
                        </li>
                        <li>
                          <h6>Sales Counselor:</h6>
                        </li>
                        <li>
                          <h6>Phone:</h6>
                        </li>
                    ...
                    <div class="item_info">
                      <ul>
                        <li>' . $bldr_home_site_size . '</li>
                        <li>' . $bldr_home_size_range .'</li>
                        <li>' . $starting_from_price .'</li>
                        <li>' . $price_range .'</li>
                        <li>' . $bldr_arch_styles .'</li>
                        <li><a class="text-link" href="mailto:' . $bldr_sales_counselor_email .'">' . $bldr_sales_counselor .'</a></li>
                        <li><a class="text-link external" href="tel:'. $bldr_phone_link .'">' . $bldr_phone .' </a> </li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <div id="tab-model-home" data-tab-icon="" class="wpb_tab ui-tabs-panel wpb_ui-tabs-hide clearfix" style="visibility: hidden; position: absolute; opacity: 0; left: -9999px; display: none;">
                ...
                <div class="wpb_text_column wpb_content_element  builder-profile-panel-info">
                  <div class="wpb_wrapper">
                    ...
                    <div class="item_info">
                      <ul>
                        <li>' . $model_address .'</li>
                        <li><a class="text-link" href="'. $model_directions .'" target="_blank" rel="noopener">View</a></li>
                        <li>' . $model_arch_style .'</li>
                        <li>' . $model_hours .'</li>
                        <li>' . $model_hours2 .'</li>
                        <li>' . $model_hours3 .'</li>
                      </ul>
            ...
            <div class="wpb_text_column wpb_content_element  builder-btn-panel">
              <div class="wpb_wrapper">
                <div class="tour-btn">
                  <ul>
                    <li>
                      <a class="republicpg-button medium see-through-2 full-width-btn '. $schedule_a_tour . ' pum-trigger" style="visibility: visible;"><span>Schedule A Tour</span></a>
                    </li>
                    <li>
                      <a class="republicpg-button medium see-through-2  full-width-btn" style="visibility: visible;" href="'. $find_your_home_url .'" target="_self"><span>Find Your Home</span></a>
                    </li>
                  </ul>
                </div>
    ...
    if ($home_builder_style == 'meta_overlaid' || $home_builder_style == 'meta_overlaid_alt') {
        $html .= '<div class="home-builder-overlay"></div>';

        //name link
        $html .= '<div class="home-builder-meta">';
        $html .= '<h3>' . $name . '</h3>';
        $html .= '<p>' . $price_range . '<p>';
        $html .= '</div>';
    }
}
add_shortcode('home_builder', 'republicpg_home_builder');


//carousel
function republicpg_carousel($atts, $content = null) {
...
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode('carousel', 'republicpg_carousel');
}

function republicpg_carousel_item($atts, $content = null) {
    return '<li class="col span_4">' . do_shortcode($content) . '</li>';
}
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode('item', 'republicpg_carousel_item');
}


//clients
function republicpg_clients($atts, $content = null) {
...
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode('clients', 'republicpg_clients');
}

function republicpg_client($atts, $content = null) {
...
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode('client', 'republicpg_client');
}



//pricing tables
function republicpg_pricing_table($atts, $content = null) {
...
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode('pricing_table', 'republicpg_pricing_table');
}

function republicpg_pricing_column($atts, $content = null) {
...
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode('pricing_column', 'republicpg_pricing_column');
}



//tabbed sections
function republicpg_tabs($atts, $content = null) {
    $GLOBALS['tab_count'] = 0;
...
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode('tabbed_section', 'republicpg_tabs');
}

function republicpg_tab( $atts, $content ){
...
if (!class_exists('WPBakeryVisualComposerAbstract') || class_exists('WPBakeryVisualComposerAbstract') && !defined('BLUEPRINT_VC_ACTIVE')) {
	add_shortcode( 'tab', 'republicpg_tab' );
}

//toggle panel - accordion chosen
function republicpg_toggles($atts, $content = null) {
...
add_shortcode('toggles', 'republicpg_toggles');

//toggle
function republicpg_toggle($atts, $content = null) {
...
add_shortcode('toggle', 'republicpg_toggle');
...
# Republicpg Slider
#-----------------------------------------------------------------#
function republicpg_slider_processing($atts, $content = null) {
  ...
  if($republicpg_using_VC_front_end_editor) {
	...
	return do_shortcode(republicpg_slider_display($slider_config));
}

add_shortcode('republicpg_slider', 'republicpg_slider_processing');
...
# Social Buttons
#-----------------------------------------------------------------#
function republicpg_social_buttons($atts, $content = null) {
	extract(shortcode_atts(array("full_width_icons" => "", "hide_share_count" => "true", "republicpg_love" => 'false', "facebook" => 'false', "twitter" => 'false', "google_plus" => 'false', "linkedin" => 'false', "republicpg-love" => 'false', "pinterest" => 'false'), $atts));

	$fw_class = ($full_width_icons == 'true') ? ' full-width' : null;
	$hide_share_count_class = ( $hide_share_count == 'true') ? ' hide-share-count' : null;

	$fw_items = 0;
	if($republicpg_love == 'true') $fw_items += 1;
	...
	$buttons = '<div class="republicpg-social '. $hide_share_count_class . $fw_class.' items_'.$fw_items.'">';

    if($republicpg_love == 'true'){
		$buttons .= '<span class="n-shortcode">'.republicpg_love('return').'</span>';
    }

	if($facebook == 'true'){
    	$buttons .= "<a class='facebook-share republicpg-sharing' href='#' title='".esc_html__( 'Share this', 'blueprint')."'> <i class='fa fa-facebook'></i> <span class='count'></span></a>";
    }

	if($twitter == 'true'){
    	$buttons .= "<a class='twitter-share republicpg-sharing' href='#' title='".esc_html__( 'Tweet this', 'blueprint')."'> <i class='fa fa-twitter'></i> <span class='count'></span></a>";
    }

	if($google_plus == 'true'){
    	$buttons .= "<a class='google-plus-share republicpg-sharing-alt' href='#' title='".esc_html__( 'Share this', 'blueprint')."'> <i class='fa fa-google-plus'></i> <span class='count'></span></a>";
    }

	if($linkedin == 'true'){
    	$buttons .= "<a class='linkedin-share republicpg-sharing' href='#' title='".esc_html__( 'Share this', 'blueprint')."'> <i class='fa fa-linkedin'></i> <span class='count'></span></a>";
    }

	if($pinterest == 'true'){
    	$buttons .= "<a class='pinterest-share republicpg-sharing' href='#' title='".esc_html__( 'Pin this', 'blueprint')."'> <i class='fa fa-pinterest'></i> <span class='count'></span></a>";
    }
...
add_shortcode('social_buttons', 'republicpg_social_buttons');
...
//Portfolio
function republicpg_portfolio_processing($atts, $content = null) {
	...
	$masonry_sizing_type = (!empty($republicpg_options['portfolio_masonry_grid_sizing']) && $republicpg_options['portfolio_masonry_grid_sizing'] == 'photography') ? 'photography' : 'default';
	...
	if( $enable_sortable == 'true' && $horizontal_filters == 'true') {
		...
		$filters_width = (!empty($republicpg_options['header-fullwidth']) && $republicpg_options['header-fullwidth'] == '1' && $cols == 'elastic') ? 'full-width-content ': 'full-width-section ';
		...
		<div class="<?php echo esc_attr( $filters_id ) . ' '; echo esc_attr( $filters_width );  if($layout == 'constrained_fullwidth') echo ' fullwidth-constrained '; if($span_num != 'elastic-portfolio-item' || $layout == 'constrained_fullwidth') echo 'non-fw'; ?>" data-alignment="<?php echo esc_attr( $filter_alignment ); ?>" data-color-scheme="<?php echo strtolower( esc_attr( $filter_color ) ); ?>">
			<div class="container <?php if($span_num == 'elastic-portfolio-item') { echo 'normal-container'; } ?>">
				<?php if($filter_alignment != 'center' && $filter_alignment != 'left') { ?> <span id="current-category"><?php echo esc_html__( 'All', 'blueprint'); ?></span> <?php } ?>
				<ul>
				   <?php if($filter_alignment != 'center' && $filter_alignment != 'left') { ?> <li id="sort-label"><?php echo (!empty($republicpg_options['portfolio-sortable-text'])) ? $republicpg_options['portfolio-sortable-text'] : esc_html__( 'Sort Portfolio','blueprint'); ?>:</li> <?php } ?>
	...
	<?php } else if($enable_sortable == 'true' && $horizontal_filters != 'true') { ?>
		<div class="<?php echo esc_attr( $filters_id );?>" data-color-scheme="<?php echo strtolower( esc_attr($filter_color ) ); ?>">
			<a href="#" data-sortable-label="<?php echo (!empty($republicpg_options['portfolio-sortable-text'])) ? $republicpg_options['portfolio-sortable-text'] :'Sort Portfolio'; ?>" id="sort-portfolio"><span><?php echo (!empty($republicpg_options['portfolio-sortable-text'])) ?  wp_kses_post( $republicpg_options['portfolio-sortable-text'] ) : esc_html__( 'Sort Portfolio','blueprint'); ?></span> <i class="icon-angle-down"></i></a>
			<ul>
			   <li><a href="#" data-filter="*"><?php echo esc_html__( 'All', 'blueprint'); ?></a></li>
           	   <?php wp_list_categories(array('title_li' => '', 'taxonomy' => 'project-type', 'show_option_none'   => '', 'walker' => new Walker_Portfolio_Filter())); ?>
			</ul>
	...
	<div class="portfolio-wrap <?php if($project_style == '1' && $span_num == 'elastic-portfolio-item') echo 'default-style ';  if($project_style == '6' && $span_num == 'elastic-portfolio-item') echo 'spaced'; ?>">
			...
			<span class="portfolio-loading <?php echo esc_attr( $default_loader_class ); ?> <?php echo (!empty($republicpg_options['loading-image-animation']) && !empty($republicpg_options['loading-image'])) ? $republicpg_options['loading-image-animation'] : null; ?>">  <?php echo $default_loader; // WPCS: XSS ok. ?> </span>
				...
				query_posts($portfolio_arr);
 				...
 				if(have_posts()) : while(have_posts()) : the_post(); ?>
					...
					<?php
					  ...
					  $custom_project_link = get_post_meta($post->ID, '_republicpg_external_project_url', true);
					  $the_project_link = (!empty($custom_project_link)) ? $custom_project_link : esc_url(get_permalink());

					  $project_excerpt = get_post_meta($post->ID, '_republicpg_project_excerpt', true);
					  $project_image_caption = get_post(get_post_thumbnail_id())->post_content;
					  $project_image_caption = strip_tags($project_image_caption);

					  $project_accent_color = get_post_meta($post->ID, '_republicpg_project_accent_color', true);
					  $project_title_color = get_post_meta($post->ID, '_republicpg_project_title_color', true);
					  $project_subtitle_color = get_post_meta($post->ID, '_republicpg_project_subtitle_color', true);

            $customProjectClass = get_post_meta($post->ID, '_republicpg_project_css_class', true);
                ...
                $large_size = ($large_size) ? $large_size[0] .' 900w, ' : null;
					...
					<div class="col <?php echo esc_attr( $span_num ) . ' '. esc_attr( $masonry_item_sizing ) . esc_attr( $customProjectClass ); ?> element <?php echo esc_attr( $project_cats ); ?>"  data-project-cat="<?php echo esc_attr( $project_cats ); ?>" <?php if(!empty($project_accent_color)) { echo 'data-project-color="' . esc_attr( $project_accent_color ) .'"'; } else { echo 'data-default-color="true"';} ?> data-title-color="<?php echo esc_attr( $project_title_color ); ?>" data-subtitle-color="<?php echo esc_attr( $project_subtitle_color ); ?>">
						...
						<?php //project style 1
							...
							$using_custom_content = get_post_meta($post->ID, '_republicpg_portfolio_custom_grid_item', true);
							$custom_content = get_post_meta($post->ID, '_republicpg_portfolio_custom_grid_item_content', true); ?>
							...
							<div class="work-item style-1" data-custom-content="<?php echo esc_attr( $using_custom_content ); ?>">
								...
								//custom thumbnail
								$custom_thumbnail = get_post_meta($post->ID, '_republicpg_portfolio_custom_thumbnail', true);

								if( !empty($custom_thumbnail) ){
									echo '<img class="custom-thumbnail skip-lazy" src="'.republicpg_ssl_check( esc_url( $custom_thumbnail ) ).'" alt="'. get_the_title() .'" />';
								}
								else {
                        ...
                        $image_srcset_values = wp_get_attachment_image_srcset($featured_ID, 'full');
                  			if($image_srcset_values) {
								...
								<div class="work-info">
									...
									//default
										...
										<div class="vert-center">
											...
											$video_embed = get_post_meta($post->ID, '_republicpg_video_embed', true);
											$video_m4v = get_post_meta($post->ID, '_republicpg_video_m4v', true);

											//video
										    if( !empty($video_embed) || !empty($video_m4v) ) {

										    	echo republicpg_portfolio_video_popup_link($post, $project_style, $video_embed, $video_m4v);
											...
											//image
										       ...
										       echo ' class="pretty_photo default-link">'.esc_html__("View Larger", 'blueprint').'</a> ';
										    }

											if($lightbox_only != 'true') {
										    	echo '<a class="default-link" href="' . esc_url( $the_project_link ) . '">'.esc_html__("More Details", 'blueprint').'</a>';
										    } ?>
								...
								<div class="work-meta">
									...
									<?php if(!empty($project_excerpt)) { echo '<p>'. wp_kses_post( $project_excerpt ) .'</p>'; } elseif(!empty($republicpg_options['portfolio_date']) && $republicpg_options['portfolio_date'] == 1) echo '<p>' . get_the_date() . '</p>'; ?>

								</div>
								<div class="republicpg-love-wrap">
									<?php if( function_exists('republicpg_love') ) republicpg_love(); ?>
								</div><!--/republicpg-love-wrap-->
                    ...
                    echo $project_featured_img; // WPCS: XSS ok.
						...
						<?php } //project style 5
							...
							<div class="work-item style-5" data-custom-content="<?php echo esc_attr( $using_custom_content ); ?>" data-text-align="<?php echo esc_attr( $masonry_item_content_pos ); ?>">
								...
								$custom_thumbnail = get_post_meta($post->ID, '_republicpg_portfolio_custom_thumbnail', true);
								$parallax_images = get_post_meta($post->ID, '_republicpg_3d_parallax_images', true);
								...
								//no parallax images set
									...
									if (!empty($custom_thumbnail)) {
										...
										echo '	<h4 class="title"> '.get_the_title().'</h4>';
												...
												elseif(!empty($republicpg_options['portfolio_date']) && $republicpg_options['portfolio_date'] == 1) echo '<p>' . get_the_date() . '</p>';
                           ...
                           <?php }
									...
									<div class="vert-center">
										...
										if(!empty($using_custom_content) && $using_custom_content == 'on') {
											...
											<?php if(!empty($project_excerpt)) { echo '<p><span>'. wp_kses_post( $project_excerpt ) .'</span></p>'; } elseif(!empty($republicpg_options['portfolio_date']) && $republicpg_options['portfolio_date'] == 1) echo '<p><span>' . get_the_date() . '</span></p>'; ?>
											<h3><?php echo get_the_title(); ?></h3>
            ...
            <div class="work-item style-1" data-custom-content="<?php echo esc_attr( $using_custom_content ); ?>">
              ...
              if( !empty($custom_thumbnail) ){
               ...
               $custom_thumbnail_id = fjarrett_get_attachment_id_from_url($custom_thumbnail);
                ...
                echo '<img class="custom-thumbnail skip-lazy" src="'.republicpg_ssl_check( esc_url( $custom_thumbnail ) ).'" '. $image_srcset. $image_sizes .' alt="'. get_the_title() .'" />';
		...
		<?php
		 ...
		 if( !empty($republicpg_options['portfolio_extra_pagination']) && $republicpg_options['portfolio_extra_pagination'] == '1' && $enable_pagination == 'true'){
				    ...
				    if ($total_pages > 1){
					  ...
					  echo '<div id="pagination" class="'. esc_attr( $fw_pagination ).' '. esc_attr( $masonry_padding ) . esc_attr( $infinite_scroll_class ) .'" data-is-text="'.esc_html__("All items loaded", 'blueprint').'">';
...
add_shortcode('republicpg_portfolio', 'republicpg_portfolio_processing');




//blog
function republicpg_blog_processing($atts, $content = null) {
    ...
    'blog_remove_post_comment_number' => '', 'blog_remove_post_republicpg_love' => ''
  ), $atts));
  ...
  if($blog_remove_post_republicpg_love == 'true') { $blog_remove_post_republicpg_love = '1'; }

	ob_start(); ?>

	<div class="row">

	 <?php $republicpg_options = get_republicpg_theme_options();
		...
		$GLOBALS['republicpg_blog_std_style'] = $blog_standard_type;
		$GLOBALS['republicpg_blog_masonry_style'] = 'inherit';
		...
		if($masonry_class != null) {
			if($blog_masonry_style != 'inherit') {
				...
				$masonry_style = (!empty($republicpg_options['blog_masonry_type'])) ? $republicpg_options['blog_masonry_type']: 'classic';
			}

			$GLOBALS['republicpg_blog_masonry_style'] = $masonry_style;
    ...
    if($masonry_style == null && $blog_standard_type == 'featured_img_left')
      ...
      if($orderby != 'view_count') {
        ...
        $republicpg_blog_arr = array(
          ...
          'meta_key' => 'republicpg_blog_post_view_count',
  				'category_name' => $category,
          'offset' => $post_offset,
  				'paged'=> $paged
  			);
			...
			query_posts($republicpg_blog_arr);
      ...
      add_filter('wp_get_attachment_image_attributes','republicpg_remove_lazy_load_functionality');
       ...
       $republicpg_post_format = (get_post_format() == 'image' || get_post_format() == 'aside') ? false : get_post_format();
			 get_template_part( 'includes/post-templates/entry', $republicpg_post_format );
      ...
      ?>
			...
			global $republicpg_options;
			//extra pagination
			if( !empty($republicpg_options['extra_pagination']) && $republicpg_options['extra_pagination'] == '1' && $enable_pagination == 'true'){
            ...
            if(defined('ICL_SITEPRESS_VERSION')) { $format = $query_type.'paged=%#%'; }
					  ...
					  echo '<div id="pagination" data-is-text="'.esc_html__("All items loaded", 'blueprint').'">';
  ...
  <?php if($layout == 'masonry-blog-full-screen-width') { echo '</div>'; } ?>
	...
	<?php  if($layout == 'std-blog-sidebar' || $layout == 'masonry-blog-sidebar') { ?>
		<div id="sidebar" data-republicpg-ss="<?php echo esc_attr( $enable_ss ); ?>" class="col span_3 col_last">
...
add_shortcode('republicpg_blog', 'republicpg_blog_processing');
...
//Recent Posts
function republicpg_recent_posts($atts, $content = null) {
  ...
  if( isset($_GET['vc_editable']) ) {
	...
	$recent_posts_title_text = (!empty($republicpg_options['recent-posts-title'])) ? $republicpg_options['recent-posts-title'] :'Recent Posts';
	$recent_posts_link_text = (!empty($republicpg_options['recent-posts-link'])) ? $republicpg_options['recent-posts-link'] :'View All Posts';
  ...
  if($blog_remove_post_republicpg_love == 'true') { $blog_remove_post_republicpg_love = '1'; }
	...
	if($style != 'slider' && $style != 'slider_multiple_visible' && $style != 'single_large_featured' && $style != 'multiple_large_featured') {
      ...
      ?>
			<div class="row blog-recent columns-<?php echo esc_attr( $columns ); ?>" data-style="<?php echo esc_attr( $modded_style ); ?>" data-color-scheme="<?php echo esc_attr( $color_scheme ); ?>" data-remove-post-date="<?php echo esc_attr( $blog_remove_post_date ); ?>" data-remove-post-author="<?php echo esc_attr( $blog_remove_post_author ); ?>" data-remove-post-comment-number="<?php echo esc_attr( $blog_remove_post_comment_number ); ?>" data-remove-post-republicpg-love="<?php echo esc_attr($blog_remove_post_republicpg_love ); ?>">
        ...
        $r_post_count++;
					...
					<?php
						...
						if($style == 'default') {
							...
							if(get_post_format() == 'video'){
								 ...
								 if ( $wp_version < "3.6" ) {
									...
									$video_embed = get_post_meta($post->ID, '_republicpg_video_embed', true);
								    $video_m4v = get_post_meta($post->ID, '_republicpg_video_m4v', true);
								    $video_ogv = get_post_meta($post->ID, '_republicpg_video_ogv', true);
								    $video_poster = get_post_meta($post->ID, '_republicpg_video_poster', true);
								...
								<div class="audio-wrap">
									<?php
									if ( $wp_version < "3.6" ) {
									    //republicpg_audio($post->ID);
									}
									else {
										$audio_mp3 = get_post_meta($post->ID, '_republicpg_audio_mp3', true);
									    $audio_ogg = get_post_meta($post->ID, '_republicpg_audio_ogg', true);
						...
						?>
							...
							<div class="post-header">
								...
								<?php comments_number( esc_html__( 'No Comments','blueprint'), esc_html__( 'One Comment','blueprint'), '% '. esc_html__( 'Comments','blueprint') ); ?></a> </span>
							</div><!--/post-header-->

							<?php
              $excerpt_length = (!empty($republicpg_options['blog_excerpt_length'])) ? intval($republicpg_options['blog_excerpt_length']) : 30;
							echo '<div class="excerpt">' . republicpg_excerpt($excerpt_length) . '</div>';
							...
							<div class="post-header">
								<span class="meta"> <span> <?php echo get_the_date() . '</span> ' . esc_html__( 'in','blueprint'); ?> <?php the_category(', '); ?> </span>
                ...
                $excerpt_length = (!empty($republicpg_options['blog_excerpt_length'])) ? intval($republicpg_options['blog_excerpt_length']) : 30;
  							echo '<div class="excerpt">' . republicpg_excerpt($excerpt_length) . '</div>';
              ?>
							<span><?php echo esc_html__( 'Read More','blueprint'); ?> <i class="icon-button-arrow"></i></span>
              ...
              $list_featured_image_size = ($r_post_count <= $columns) ? 'portfolio-thumb' : 'republicpg_small_square';
              ...
              if($r_post_count <= $columns) {
                $excerpt_length = (!empty($republicpg_options['blog_excerpt_length'])) ? intval($republicpg_options['blog_excerpt_length']) : 15;
                echo '<div class="excerpt">'.republicpg_excerpt($excerpt_length).'</div>';
              ...
              $post_link_target = (get_post_format() == 'link') ? 'target="_blank"' : '';
							...
							<div class="article-content-wrap">
								...
								<div class="excerpt">
									<?php
                  $excerpt_length = (!empty($republicpg_options['blog_excerpt_length'])) ? intval($republicpg_options['blog_excerpt_length']) : 30;
    							echo republicpg_excerpt($excerpt_length);
                  ?>
								</div>
							</div>

							<div class="post-meta">
								<span class="meta-author"> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"> <i class="icon-default-style icon-blueprint-m-user"></i> <?php the_author(); ?></a> </span>
    ...
    echo '<div id="'.uniqid('rps_').'" class="republicpg-recent-posts-single_featured parallax_section" data-padding="'. esc_attr( $large_featured_padding ) .'" data-bg-overlay="'. esc_attr( $bg_overlay ) .'" data-height="'. esc_attr( $slider_size ) .'" data-animate-in-effect="'. esc_attr( $animate_in_effect ) .'" data-remove-post-date="'. esc_attr( $blog_remove_post_date ) .'" data-remove-post-author="'. esc_attr( $blog_remove_post_author ) .'" data-remove-post-comment-number="'.$blog_remove_post_comment_number.'" data-remove-post-republicpg-love="'.$blog_remove_post_republicpg_love.'">';

    $i = 0;
    if( $recent_posts_query->have_posts() ) :  while( $recent_posts_query->have_posts() ) : $recent_posts_query->the_post(); global $post; ?>

        <?php
          $bg = get_post_meta($post->ID, '_republicpg_header_bg', true);
          $bg_color = get_post_meta($post->ID, '_republicpg_header_bg_color', true);
          $bg_image_id = null;
          $featured_img = null;
        ...
        <div class="republicpg-recent-post-slide <?php if($bg_image_id == null) echo 'no-bg-img'; ?> post-ref-<?php echo esc_attr($i); ?>">

          <div class="row-bg using-image" data-parallax-speed="fast"><div class="republicpg-recent-post-bg" style=" <?php if(!empty($bg_color)) { ?> background-color: <?php echo esc_attr( $bg_color );?>; <?php } ?> background-image: url(<?php echo esc_url( $featured_img ) ;?>);" > </div></div>
          ...
          echo '<div class="recent-post-container container"><div class="inner-wrap">';
            ...
            echo '<div class="grav-wrap"><a href="'.get_author_posts_url($post->post_author).'">'.get_avatar( get_the_author_meta('email'), 70,  null, get_the_author() ). '</a><div class="text"><span>'.esc_html__( 'By','blueprint').' <a href="'.get_author_posts_url($post->post_author).'" rel="author">' .get_the_author().'</a></span><span> '.esc_html__( 'In','blueprint').'</span> '. trim( $cat_output) . '</div></div>';
            ?>
            ...
            <?php echo '<div class="excerpt">' . republicpg_excerpt(20) . '</div>';  ?>
            ...
            if($button_color == 'extra-color-gradient-1' || $button_color == 'extra-color-gradient-2') {
          	...
          	if($republicpg_options['theme-skin'] == 'material' && $button_color == 'extra-color-gradient-1') {
          		$button_color = 'm-extra-color-gradient-1';
          	} else if( $republicpg_options['theme-skin'] == 'material' && $button_color == 'extra-color-gradient-2') {
          		$button_color = 'm-extra-color-gradient-2';
          	}
            ?>
            <a class="republicpg-button large regular <?php echo esc_attr( $button_color ) .  esc_attr( $regular_btn_class ); ?> has-icon" href="<?php echo esc_url(get_permalink()); ?>" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#fff" ><span><?php echo esc_html__( 'Read More', 'blueprint'); ?></span> <i class="icon-button-arrow"></i></a>
    ...
    $button_color = strtolower($button_color);
    $animate_in_effect = (!empty($republicpg_options['header-animate-in-effect'])) ? $republicpg_options['header-animate-in-effect'] : 'none';
    echo '<div id="'.uniqid('rps_').'" class="republicpg-recent-posts-single_featured multiple_featured parallax_section" data-button-color="'. esc_attr( $button_color ) .'" data-nav-location="'. esc_attr( $mlf_navigation_location ) .'" data-bg-overlay="'. esc_attr( $bg_overlay ) .'" data-padding="'. esc_attr( $large_featured_padding ) .'" data-autorotate="'. esc_attr( $auto_rotate ) .'" data-height="'. esc_attr( $slider_size ) .'" data-animate-in-effect="'. esc_attr( $animate_in_effect ) .'" data-remove-post-date="'. esc_attr( $blog_remove_post_date ) .'" data-remove-post-author="'. esc_attr( $blog_remove_post_author ) .'" data-remove-post-comment-number="'. esc_attr( $blog_remove_post_comment_number ) .'" data-remove-post-republicpg-love="'. esc_attr( $blog_remove_post_republicpg_love ) .'">';
    ...
    if( $recent_posts_query->have_posts() ) :  while( $recent_posts_query->have_posts() ) : $recent_posts_query->the_post(); global $post; ?>
        ...
        <div class="republicpg-recent-post-slide <?php if($bg_image_id == null) echo 'no-bg-img'; ?> <?php if($i == 0) echo 'active'; ?> post-ref-<?php echo esc_attr($i); ?>">
          ...
          echo '<div class="recent-post-container container"><div class="inner-wrap">';
            ...
            ?>
            <a class="republicpg-button large regular <?php echo esc_attr($button_color) .  esc_attr($regular_btn_class); ?> has-icon" href="<?php echo esc_url(get_permalink()); ?>" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#fff" ><span><?php echo esc_html__( 'Read Article', 'blueprint'); ?> </span><i class="icon-button-arrow"></i></a>
    ...
    $recent_posts_query = new WP_Query($recentBlogPosts);
      ...
      $animate_in_effect = (!empty($republicpg_options['header-animate-in-effect'])) ? $republicpg_options['header-animate-in-effect'] : 'none';
    echo '<div class="republicpg-recent-posts-slider_multiple_visible" data-columns="'.$columns.'" data-height="'.$slider_size.'" data-shadow-hover-type="'.$hover_shadow_type.'" data-animate-in-effect="'.$animate_in_effect.'" data-remove-post-date="'.$blog_remove_post_date.'" data-remove-post-author="'.$blog_remove_post_author.'" data-remove-post-comment-number="'.$blog_remove_post_comment_number.'" data-remove-post-republicpg-love="'.$blog_remove_post_republicpg_love.'">';

    echo '<div class="republicpg-recent-posts-slider-inner"><div class="flickity-viewport"><div class="flickity-slider">';
    $i = 0;
    if( $recent_posts_query->have_posts() ) :  while( $recent_posts_query->have_posts() ) : $recent_posts_query->the_post(); global $post; ?>
        ...
        <div class="republicpg-recent-post-slide <?php if($bg_image_id == null) echo 'no-bg-img'; ?> post-ref-<?php echo esc_attr($i); ?>">
          ...
          <div class="republicpg-recent-post-bg-wrap"><div class="republicpg-recent-post-bg"  style=" <?php if(!empty($bg_color)) { ?> background-color: <?php echo esc_attr($bg_color);?>; <?php } ?> background-image: url(<?php echo esc_url($featured_img);?>);" > </div></div>
          <div class="republicpg-recent-post-bg-blur"  style=" <?php if(!empty($bg_color)) { ?> background-color: <?php echo esc_attr($bg_color) ;?>; <?php } ?> background-image: url(<?php echo esc_url($featured_img) ;?>);" > </div>
          ...
          echo '<span class="strong">';
            ...
            <?php if(!empty($republicpg_options['theme-skin']) && $republicpg_options['theme-skin'] == 'material') { ?>
              <a class="republicpg-button large regular  <?php echo esc_attr($button_color) .  esc_attr($regular_btn_class); ?>" href="<?php echo esc_url(get_permalink()); ?>" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#fff" ><span><?php echo esc_html__( 'Read Article','blueprint'); ?> </span></a>
            <?php } else { ?>
                <a class="republicpg-button large regular  <?php echo esc_attr($button_color) .  esc_attr($regular_btn_class); ?> has-icon" href="<?php echo esc_url(get_permalink()); ?>" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#fff" ><span><?php echo esc_html__( 'Read Article','blueprint'); ?> </span><i class="icon-button-arrow"></i></a>
            <?php } ?>
    ...
    ob_end_clean();
      ...
      if($orderby != 'view_count') {
	    ...
	    $animate_in_effect = (!empty($republicpg_options['header-animate-in-effect'])) ? $republicpg_options['header-animate-in-effect'] : 'none';
		echo '<div class="republicpg-recent-posts-slider" data-height="'.$slider_size.'" data-animate-in-effect="'.$animate_in_effect.'" data-remove-post-date="'.$blog_remove_post_date.'" data-remove-post-author="'.$blog_remove_post_author.'" data-remove-post-comment-number="'.$blog_remove_post_comment_number.'" data-remove-post-republicpg-love="'.$blog_remove_post_republicpg_love.'">';

		echo '<div class="republicpg-recent-posts-slider-inner generate-markup">';
		$i = 0;
		if( $recent_posts_query->have_posts() ) :  while( $recent_posts_query->have_posts() ) : $recent_posts_query->the_post(); global $post; ?>
				...
				<div class="republicpg-recent-post-slide <?php if($bg_image_id == null) echo 'no-bg-img'; ?> post-ref-<?php echo esc_attr($i); ?>">
					...
					<div class="republicpg-recent-post-bg"  style=" <?php if(!empty($bg_color)) { ?> background-color: <?php echo esc_attr( $bg_color ) ;?>; <?php } ?> background-image: url(<?php echo esc_url($featured_img) ;?>);" > </div>
...
add_shortcode('recent_posts', 'republicpg_recent_posts');



//recent projects
function republicpg_recent_projects($atts, $content = null) {
	...
	$title_label_output = null;
	$recent_projects_title_text = (!empty($republicpg_options['carousel-title'])) ? $republicpg_options['carousel-title'] : 'Recent Work';
	$recent_projects_link_text = (!empty($republicpg_options['carousel-link'])) ? $republicpg_options['carousel-link'] : 'View All Work';
	$portfolio_link = get_portfolio_page_link(get_the_ID());
	if(!empty($republicpg_options['main-portfolio-link'])) $portfolio_link = $republicpg_options['main-portfolio-link'];
		...
		$title_label_output .= '</h2>';
          ...
          'offset' => $project_offset,
				...
				if(	$project_style != 'fullscreen_zoom_slider') {
					...
					if($full_width_carousel == 'true'){
						$arrow_markup = '<div class="controls"><a class="portfolio-page-link" href="'.$page_link_url.'"><i class="icon-blueprint-back-to-all"></i></a>
										 <a class="carousel-prev" href="#"><i class="icon-blueprint-left-arrow-thin"></i></a>
						    	         <a class="carousel-next" href="#"><i class="icon-blueprint-right-arrow-thin"></i></a></div>';
					} else {
				...
				if($project_style == '1'){
					...
					if ( $the_query->have_posts() ) {
					    ...
					    if( !empty($video_embed) || !empty($video_m4v) ) {
							...
							$media = republicpg_portfolio_video_popup_link($post, $project_style, $video_embed, $video_m4v);

				        }

						//image
					    else {
					       $media .= '<a href="'. $featured_image[0].'" class="pretty_photo default-link">'.esc_html__("View Larger", 'blueprint').'</a> ';
					    }
						...
						} elseif(!empty($republicpg_options['portfolio_date']) && $republicpg_options['portfolio_date'] == 1) {
						...
						if( !empty($custom_thumbnail) ){
							$project_img = '<img class="custom-thumbnail skip-lazy" src="'.republicpg_ssl_check($custom_thumbnail).'" alt="'. get_the_title() .'" />';
						}

						$more_details_html = ($lightbox_only != 'true') ? '<a class="default-link" href="' . $the_project_link . '">'.esc_html__("More Details", 'blueprint').'</a>' : null;
						...
						$recent_projects_content .='<li class="col span_4" '.$project_accent_color_markup.' data-title-color="'.$project_title_color.'" data-subtitle-color="'.$project_subtitle_color.'">
							...
							<div class="work-meta">
								...
								'.$date.'
							</div><div class="republicpg-love-wrap">
					...
					if ( $the_query->have_posts() ) {
						...
						if($lightbox_only != 'true') {
						    ...
						    if( !empty($video_embed) || !empty($video_m4v) ) {
								...
								$link_markup = republicpg_portfolio_video_popup_link($post, $project_style, $video_embed, $video_m4v);
			...
			if($project_style == 'fullscreen_zoom_slider') {
				...
				$recent_projects_content = '<div class="republicpg_fullscreen_zoom_recent_projects" data-autorotate="'.$autorotate.'" data-slider-text-color="'.$slider_text_color.'" data-slider-controls="'.$slider_controls.'" data-overlay-opacity="'.$overlay_strength.'"><div class="project-slides">';
                ...
                if($display_project_excerpt == 'true') {
                  $fullscreen_slider_excerpt = (!empty($project_excerpt)) ? '<p>'.$project_excerpt.'</p>' : '';
								...
								if( !empty($custom_thumbnail) ){
									$project_img = republicpg_ssl_check($custom_thumbnail);
								}
                ...
                if(!empty($custom_link_text)) {
                  ...
                  $fullscreen_slider_link_text = esc_html__("View Project", 'blueprint');
                }
				...
				$recent_projects_content .= '</div><div class="container normal-container">'.$next_prev_markup.'</div></div><!--republicpg_fullscreen_zoom_recent_projects-->';
			}
...
add_shortcode('recent_projects', 'republicpg_recent_projects');
...
if ( floatval(get_bloginfo('version')) < "3.6" ) {
	...
	//video
	function republicpg_shortcode_video($atts, $content = null) {
	...
	add_shortcode('video', 'republicpg_shortcode_video');
...
if ( floatval(get_bloginfo('version')) < "3.6" ) {
	...
	function republicpg_shortcode_audio($atts, $content = null) {
	...
	add_shortcode('audio', 'republicpg_shortcode_audio');
