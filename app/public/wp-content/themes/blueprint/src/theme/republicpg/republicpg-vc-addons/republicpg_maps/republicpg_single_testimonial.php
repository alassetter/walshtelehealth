<?php
	...
	return array(
	  ...
	  "base" => "republicpg_single_testimonial",
    "icon" => "icon-republicpg-single-testimonial",
    ...
    array(
      ...
      'description' => esc_html__('Choose a color from your','blueprint') . ' <a target="_blank" href="'. esc_url(admin_url()) .'?page=Blueprint&tab=6"> ' . esc_html__('globally defined color scheme','blueprint') . '</a>',
    ),
