...
if(strlen($cta_button_text) >= 1) {
     $tabs_nav .= '<li class="cta-button"><a class="republicpg-button medium regular-button '.$cta_button_style.'" data-color-override="false" href="'.$cta_button_link.'">' . $cta_button_text . '</a></li>';
}
