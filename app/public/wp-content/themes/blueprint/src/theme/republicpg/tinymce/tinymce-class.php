...
function enqueue_generator_scripts(){
	...
	wp_enqueue_style('tinymce',get_template_directory_uri() . '/republicpg/tinymce/shortcode_generator/css/tinymce.css');
	wp_enqueue_style('chosen',get_template_directory_uri() . '/republicpg/tinymce/shortcode_generator/css/chosen/chosen.css');
	...
	wp_enqueue_style('linea', get_template_directory_uri() . '/fonts/svg/font/style.css');
	wp_enqueue_style('iconsmind', get_template_directory_uri() . '/css/iconsmind.css');
	wp_enqueue_script('chosen',get_template_directory_uri() . '/republicpg/tinymce/shortcode_generator/js/chosen/chosen.jquery.min.js','jquery','1.0 ', TRUE);

	wp_enqueue_style('magnific',get_template_directory_uri() . '/republicpg/tinymce/shortcode_generator/css/magnific-popup.css');
	wp_enqueue_script('magnific',get_template_directory_uri() . '/republicpg/tinymce/shortcode_generator/js/magnific-popup.js','jquery','0.9.7 ', TRUE);

	wp_enqueue_script('republicpg-shortcode-generator-popup',get_template_directory_uri() . '/republicpg/tinymce/shortcode_generator/js/popup.js','jquery','0.9.7 ', TRUE);
	wp_enqueue_script('republicpg-shortcode-generator',get_template_directory_uri() . '/republicpg/tinymce/republicpg-shortcode-generator.js','jquery','0.9.7 ', TRUE);
...
add_action('admin_footer','republicpg_shortcode_content_display');


function republicpg_shortcode_content_display() {
...
//Half
$republicpg_shortcodes['header_1'] = array(
	'type'=>'heading',
	'title'=>esc_html__('Columns', 'blueprint')
);

$republicpg_shortcodes['one_half'] = array(
	'type'=>'checkbox',
	'title'=>esc_html__('One Half (1/2)', 'blueprint' ),
	'attr'=>array(
		'boxed'=>array('type'=>'custom', 'title'=>esc_html__('Boxed Column','blueprint')),
		'centered_text'=>array('type'=>'custom', 'title'=>esc_html__('Centered Text','blueprint')),
		'last'=>array( 'type'=>'custom', 'title'=>esc_html__('Last Column','blueprint'), 'desc' => esc_html__('Check this for the last column in a row. i.e. when the columns add up to 1.', 'blueprint')),
		'animation'=>array(
			'type'=>'select',
			'half_width' => 'true',
			'title'  => esc_html__('Animation','blueprint'),
			'values' => array(
			     "none" => "None",
			     "fade-in" => "Fade In",
		...
		'delay'=>array(
			...
			'title'=>esc_html__('Animation Delay', 'blueprint'),
			'desc' => esc_html__('Enter delay (in milliseconds) if needed e.g. 150. This parameter comes in handy when creating the animate in "one by one" effect in horizontal columns. ', 'blueprint'),
		)
	)
);
...
//Thirds
$republicpg_shortcodes['one_third'] = array(
	'type'=>'checkbox',
	'title'=>esc_html__('One Third Column (1/3)', 'blueprint' ),
	'attr'=>array(
		'boxed'=>array('type'=>'custom', 'title'=>esc_html__('Boxed Column','blueprint')),
		'centered_text'=>array('type'=>'custom', 'title'=>esc_html__('Centered Text','blueprint')),
		'last'=>array( 'type'=>'custom', 'title'=>esc_html__('Last Column','blueprint'), 'desc' => esc_html__('Check this for the last column in a row. i.e. when the columns add up to 1.', 'blueprint')),
		'animation'=>array(
			...
			'values' => array(
			     ...
			     "fade-in" => esc_html__("Fade In",'blueprint'),
		  		 "fade-in-from-left" => esc_html__("Fade In From Left",'blueprint'),
		  		 "fade-in-right" => esc_html__("Fade In From Right",'blueprint'),
		  		 "fade-in-from-bottom" => esc_html__("Fade In From Bottom",'blueprint'),
		  		 "grow-in" => esc_html__("Grow In",'blueprint')
			)
		),
		'delay'=>array(
			'type'=>'text',
...
$republicpg_shortcodes['two_thirds'] = array(
	'type'=>'checkbox',
	'title'=>esc_html__('Two Thirds Column (2/3)', 'blueprint' ),
	'attr'=>array(
		'boxed'=>array('type'=>'custom', 'title'=>esc_html__('Boxed Column','blueprint')),
		'centered_text'=>array('type'=>'custom', 'title'=>esc_html__('Centered Text','blueprint')),
		'last'=>array( 'type'=>'custom', 'title'=>esc_html__('Last Column','blueprint'), 'desc' => esc_html__('Check this for the last column in a row. i.e. when the columns add up to 1.', 'blueprint')),
...
//Fourths
$republicpg_shortcodes['one_fourth'] = array(
	'type'=>'checkbox',
	'title'=>esc_html__('One Fourth Column (1/4)', 'blueprint' ),
	'attr'=>array(
		'boxed'=>array('type'=>'custom', 'title'=>esc_html__('Boxed Column','blueprint')),
		'centered_text'=>array('type'=>'custom', 'title'=>esc_html__('Centered Text','blueprint')),
		'last'=>array( 'type'=>'custom', 'title'=>esc_html__('Last Column','blueprint'), 'desc' => esc_html__('Check this for the last column in a row. i.e. when the columns add up to 1.', 'blueprint')),
...
$republicpg_shortcodes['three_fourths'] = array(
	'type'=>'checkbox',
	'title'=>esc_html__('Three Fourths Column (3/4)', 'blueprint' ),
	'attr'=>array(
		'boxed'=>array('type'=>'custom', 'title'=>esc_html__('Boxed Column','blueprint')),
		'centered_text'=>array('type'=>'custom', 'title'=>esc_html__('Centered Text','blueprint')),
		'last'=>array( 'type'=>'custom', 'title'=>esc_html__('Last Column','blueprint'), 'desc' => esc_html__('Check this for the last column in a row. i.e. when the columns add up to 1.', 'blueprint')),
...
//Sixths
$republicpg_shortcodes['one_sixth'] = array(
	'type'=>'checkbox',
	'title'=>esc_html__('One Sixth Column (1/6)', 'blueprint' ),
	'attr'=>array(
		'boxed'=>array('type'=>'custom', 'title'=>esc_html__('Boxed Column','blueprint')),
		'centered_text'=>array('type'=>'custom', 'title'=>esc_html__('Centered Text','blueprint')),
		'last'=>array( 'type'=>'custom', 'title'=>esc_html__('Last Column','blueprint'), 'desc' => esc_html__('Check this for the last column in a row. i.e. when the columns add up to 1.', 'blueprint')),
...
$republicpg_shortcodes['five_sixths'] = array(
	'type'=>'checkbox',
	'title'=>esc_html__('Five Sixths Column (5/6)', 'blueprint' ),
	'attr'=>array(
		'boxed'=>array('type'=>'custom', 'title'=>esc_html__('Boxed Column','blueprint')),
		'centered_text'=>array('type'=>'custom', 'title'=>esc_html__('Centered Text','blueprint')),
		'last'=>array( 'type'=>'custom', 'title'=>esc_html__('Last Column','blueprint'), 'desc' => esc_html__('Check this for the last column in a row. i.e. when the columns add up to 1.', 'blueprint')),
...
$republicpg_shortcodes['one_whole'] = array(
	'type'=>'checkbox',
	'title'=>esc_html__('One Whole Column (1/1)', 'blueprint' ),
	'attr'=>array(
		'boxed'=>array('type'=>'custom', 'title'=>esc_html__('Boxed Column','blueprint')),
		'centered_text'=>array('type'=>'custom', 'title'=>esc_html__('Centered Text','blueprint')),
		'animation'=>array(
...
$republicpg_shortcodes['header_6'] = array(
	'type'=>'heading',
	'title'=>esc_html__('Elements', 'blueprint' )
);
...
$republicpg_disable_republicpg_slider = (!empty($republicpg_options['disable_republicpg_slider_pt']) && $republicpg_options['disable_republicpg_slider_pt'] == '1') ? true : false;
	...
	if($republicpg_disable_republicpg_slider != true) {
		...
		if (empty($locations)) {
			$location_desc =
		      '<div class="alert">' .
			 esc_html__('You currently don\'t have any Slider Locations setup. Please create some and add assign slides to them before using this!','blueprint').
			'<br/><br/>
			<a href="' . esc_url(admin_url('edit.php?post_type=republicpg_slider')) . '">'. esc_html__('Link to Republicpg Slider', 'blueprint') . '</a>
			</div>';
		} else { $location_desc = ''; }

		$republicpg_shortcodes['republicpg_slider'] = array(
			'type'=>'regular',
			'title'=>esc_html__('Republicpg Slider', 'blueprint' ),
			'attr'=>array(
				'location'=>array(
					'type'=>'select',
					'desc' => $location_desc,
					'title'  => esc_html__('Select Slider','blueprint'),
					'values' => $locations
				),
				...
				'slider_height'=>array(
					...
					'desc' => esc_html__('Don\'nt include "px" in your string. e.g. 650', 'blueprint'),
				),

				'flexible_slider_height'=>array('type'=>'checkbox',  'desc' => 'Would you like the height of your slider to constantly scale in porportion to the screen size?', 'title'=>esc_html__('Flexible Slider Height', 'blueprint')),
				'full_width'=>array('type'=>'checkbox',  'desc' => 'Would you like this slider to display the full width of the page?', 'title'=>esc_html__('Display Full Width?', 'blueprint')),
				'arrow_navigation'=>array('type'=>'checkbox',  'desc' => 'Would you like this slider to display arrows on the right and left sides?', 'title'=>esc_html__('Display Arrow Navigation', 'blueprint')),
				'bullet_navigation'=>array('type'=>'checkbox',  'desc' => 'Would you like this slider to display bullets on the bottom?', 'title'=>esc_html__('Display Bullet Navigation', 'blueprint')),
				'bullet_navigation_style'=>array(
					'type'=>'select',
					'desc' => 'Please select your overall bullet navigation style here.',
					'title'  => esc_html__('Bullet Navigation Style','blueprint'),
					'values' => array(
						'See Through & Solid On Active' => 'see_through',
						'Solid & Scale On Active' => 'scale'
					)
				),
				'desktop_swipe'=>array('type'=>'checkbox',  'desc' => 'Would you like this slider to have swipe interaction on desktop?', 'title'=>esc_html__('Enable Swipe on Desktop?', 'blueprint')),
				'parallax'=>array('type'=>'checkbox',  'desc' => 'will only activate if the slider is the <b>top level element</b> in the page', 'title'=>esc_html__('Parallax Slider?', 'blueprint')),
				'loop'=>array('type'=>'checkbox',  'desc' => 'Would you like your slider to loop infinitely?', 'title'=>esc_html__('Loop Slider?', 'blueprint')),
				'fullscreen'=>array('type'=>'checkbox',  'desc' => 'This will only become active when used in combination with the full width option', 'title'=>esc_html__('Fullscreen Slider?', 'blueprint')),
				'slider_transition'=>array(
					'type'=>'select',
					'desc' => 'Please select your slider transition here',
					'title'  => esc_html__('Slider Transition','blueprint'),
					'values' => array(
						'slide' => 'slide',
						'fade' => 'fade'
					)
				...
				'button_sizing'=>array(
					...
					'title'  => esc_html__('Button Sizing','blueprint'),
					'values' => array(
						"regular" => "regular",
						"large" => "large",
						"jumbo" => "jumbo"
				...
				'autorotate'=>array('type'=>'text',  'desc' => 'If you would like this slider to autorotate, enter the rotation speed in <b>miliseconds</b> here. i.e 5000', 'title'=>esc_html__('Autorotate?', 'blueprint'))
			)
		);
...
//Full Width Section
$republicpg_shortcodes['full_width_section'] = array(
	'type'=>'custom',
	'title'=>esc_html__('Full Width Section', 'blueprint' ),
	'attr'=>array(
	    'color' =>array('type'=>'custom', 'title'  => esc_html__('Background Color','blueprint')),
		'image'=>array('type'=>'custom', 'title'  => esc_html__('Background Image','blueprint')),
		'bg_pos'=>array(
			'type'=>'select',
			'title'  => esc_html__('Background Position','blueprint'),
			'values' => array(
			     "left top" => esc_html__("Left Top",'blueprint'),
		  		 "left center" => esc_html__("Left Center",'blueprint'),
		  		 "left bottom" => esc_html__("Left Bottom",'blueprint'),
		  		 "center top" => esc_html__("Center Top",'blueprint'),
		  		 "center center" => esc_html__("Center Center",'blueprint'),
		  		 "center bottom" => esc_html__("Center Bottom",'blueprint'),
		  		 "right top" => esc_html__("Right Top",'blueprint'),
		  		 "right center" => esc_html__("Right Center",'blueprint'),
		  		 "right bottom" => esc_html__("Right Bottom",'blueprint')
			)
		),
		'bg_repeat'=>array(
			'type'=>'select',
		...
		'parallax_bg'=>array('type'=>'checkbox', 'title'=>esc_html__('Parallax Background', 'blueprint')),
		'text_color'=>array(
			'type'=>'select',
			'title'  => esc_html__('Text Color','blueprint'),
			'values' => array(
		  		 "light_text" => esc_html__("Light",'blueprint'),
		  		 "dark_text" => esc_html__("Dark",'blueprint')
			)
		),

		'top_padding'=>array(
			'type'=>'text',
			'title'=>esc_html__('Top Padding', 'blueprint'),
			'desc' => esc_html__('Don\'nt include "px" in your string. e.g. 40', 'blueprint'),
		),
		'bottom_padding'=>array(
			'type'=>'text',
			'title'=>esc_html__('Bottom Padding', 'blueprint'),
			'desc' => esc_html__('Don\'nt include "px" in your string. e.g. 40', 'blueprint'),
		),
...
$republicpg_shortcodes['image_with_animation'] = array(
	'type'=>'custom',
	'title'=>esc_html__('Image With Animation', 'blueprint' ),
	'attr'=>array(
		'image'=>array('type'=>'custom', 'title'  => esc_html__('Image','blueprint')),
		'animation'=>array(
			'type'=>'select',
			'title'  => esc_html__('Image Animation','blueprint'),
			'values' => array(
			    "fade-in" => esc_html__("Fade In",'blueprint'),
		  		 "fade-in-from-left" => esc_html__("Fade In From Left",'blueprint'),
		  		 "fade-in-right" => esc_html__("Fade In From Right",'blueprint'),
		...
		'delay'=>array(
			'type'=>'text',
			'title'=>esc_html__('Delay', 'blueprint'),
			'desc' => esc_html__('Enter delay (in milliseconds) if needed e.g. 150. This parameter comes in handy when creating the animate in "one by one" effect in horizontal columns. ', 'blueprint'),
		),
	)
);
...
//Heading
$republicpg_shortcodes['heading'] = array(
	'type'=>'simple',
	'title'=>esc_html__('Centered Heading', 'blueprint' ),
	'attr'=>array(
		'subtitle'=>array('type'=>'text', 'title'=>esc_html__('Subtitle', 'blueprint'))
	)
);

//Divider
$republicpg_shortcodes['divider'] = array(
	'type'=>'regular',
	'title'=>esc_html__('Divider', 'blueprint' ),
	'attr'=>array(
		'line_type'=>array(
			'type'=>'select',
			'title'  => esc_html__('Display Line?','blueprint'),
			'values' => array(
			     "no-line" => esc_html__("No Line",'blueprint'),
		  		 "full-width" => esc_html__("Full Width Line",'blueprint'),
		  		 "small" => esc_html__("Small Line",'blueprint')
			)
		),
		'custom_height'=>array(
			'type'=>'text',
			...
			'title'=>esc_html__('Custom Dividing Height', 'blueprint')
		)
	)
);

//Divider
$republicpg_shortcodes['republicpg_dropcap'] = array(
	'type'=>'simple',
	'title'=>esc_html__('Dropcap', 'blueprint' ),
	'attr'=>array(
		'text_color' =>array(
			'type'=>'custom',
			'title'  => esc_html__('Color','blueprint')
		)
	)
);

//Milestone
$republicpg_shortcodes['milestone'] = array(
	'type'=>'regular',
	'title'=>esc_html__('Milestone', 'blueprint'),
	'attr'=>array(
		'number'=>array('type'=>'text', 'desc' => 'The number/count of your milestone e.g. "13"', 'title'=>esc_html__('Milestone Number', 'blueprint')),
		'subject'=>array('type'=>'text', 'desc' => 'The subject of your milestones e.g. "Projects Completed"', 'title'=>esc_html__('Milestone Subject', 'blueprint')),
		'symbol'=>array('type'=>'text', 'desc' => 'An optional symbol to place next to the number counted to. e.g. "%" or "+"', 'title'=>esc_html__('Milestone Symbol', 'blueprint')),
		'symbol_position'=>array(
			'type'=>'select',
			'title'  => esc_html__('Milestone Symbol Position','blueprint'),
			'values' => array(
			    "after" => "after",
		 		"before" => "before",
			)
		...
		'number_font_size'=>array('type'=>'text', 'desc' => 'Enter your size in pixels, the default is 62.', 'title'=>esc_html__('Milestone Number Font Size', 'blueprint')),
		'symbol_font_size'=>array('type'=>'text', 'desc' => 'Enter your size in pixels', 'title'=>esc_html__('Milestone Symbol Font Size', 'blueprint')),
		'symbol_alignment'=>array(
			'type'=>'select',
			'title'  => esc_html__('Color','blueprint'),
			'values' => array(
			     "default" => "Default",
			     "superscript" => esc_html__("Superscript",'blueprint')
			)
		)
	)
);
...
$republicpg_shortcodes['icon'] = array(
	'type'=>'regular',
	'title'=>esc_html__('Icon', 'blueprint'),
	'attr'=>array(
		'size'=>array(
			'type'=>'radio',
			'title'=>esc_html__('Icon Style', 'blueprint'),
			'desc' => esc_html__('Tiny is recommended to be used inline with regular text. Small is recommended to be used inline right before heading text. Regular can be used in a variety of places. Large is recommended to be used at the top of columns.', 'blueprint'),
			'opt'=>array(
				'tiny'=>esc_html__('Tiny','blueprint'),
				'small'=>esc_html__('Small Circle','blueprint'),
				'regular'=>esc_html__('Regular','blueprint'),
				'large'=>esc_html__('Large Circle','blueprint'),
				'large-2'=>esc_html__('Large Circle Alt','blueprint'),
			)
		),
		'color'=>array(
			'type'=>'select',
			...
			'values' => array(
			     "accent-color" => esc_html__("Accent-Color",'blueprint'),
		  		 ...
		  		 "extra-color-2" => esc_html__("Extra-Color-2",'blueprint'),
		  		 "extra-color-3" => esc_html__("Extra-Color-3",'blueprint'),
		  		 "extra-color-gradient-1" => esc_html__("Extra-Color-Gradient-1",'blueprint'),
		  		 "extra-color-gradient-2" => esc_html__("Extra-Color-Gradient-2",'blueprint')
			)
		),
		'icons' => array(
			'type'=>'icons',
		...
		'icon_size'=>array('type'=>'text', 'title'=>esc_html__('Icon Size', 'blueprint'), 'desc' => esc_html__('Don\'nt include "px" in your string. e.g. 40 - the default is 64', 'blueprint')),
		'enable_animation'=>array('type'=>'checkbox', 'title'=>esc_html__('Enable Animation','blueprint'), 'desc' => esc_html__('This will cause the icon to appear to draw itself', 'blueprint')),
		'animation_delay'=>array('type'=>'text', 'title'=>esc_html__('Animation Delay', 'blueprint'), 'desc' => esc_html__('Enter time in milliseconds e.g. 400', 'blueprint')),
		'animation_speed'=>array(
			'type'=>'select',
			'title'  => esc_html__('Animation Speed','blueprint'),
			'values' => array(
			     "slow" => esc_html__("Slow",'blueprint'),
		  		 "medium" => esc_html__("Medium",'blueprint'),
		  		 "fast" => esc_html__("Fast",'blueprint')
			)
		),
...
//Button
$republicpg_shortcodes['button'] = array(
	'type'=>'radios',
	'title'=>esc_html__('Button', 'blueprint'),
	'attr'=>array(
		'size'=>array(
			'type'=>'radio',
			'title'=>esc_html__('Size', 'blueprint'),
			'opt'=>array(
				'small'=> esc_html__('Small', 'blueprint'),
				'medium'=> esc_html__('Medium', 'blueprint'),
				'large'=> esc_html__('Large', 'blueprint'),
				'jumbo'=> esc_html__('Jumbo', 'blueprint'),
				'extra_jumbo'=> esc_html__('Extra Jumbo', 'blueprint')
			)
		),
		'url'=>array(
			'type'=>'text',
		...
		'text'=>array(
			'type'=>'text',
			'title'=>esc_html__('Text', 'blueprint')
		),
		'open_new_tab'=>array('type'=>'checkbox', 'title'=>esc_html__('Open Link In New Tab?','blueprint')),
		'color'=>array(
			'type'=>'regular-select',
			'title'  => esc_html__('Style','blueprint'),
			'values' => array(
			     "accent-color" => esc_html__("Regular + Accent Color", 'blueprint'),
		  		 "extra-color-1" => esc_html__("Regular + Extra Color-1", 'blueprint'),
		  		 "extra-color-2" => esc_html__("Regular + Extra Color-2", 'blueprint'),
		  		 "extra-color-3" => esc_html__("Regular + Extra Color-3", 'blueprint'),
		  		 "extra-color-gradient-1" => esc_html__("Regular + Color Gradient 1", 'blueprint'),
		  		 "extra-color-gradient-2" => esc_html__("Regular + Color Gradient 2", 'blueprint'),
		  		 "accent-color-tilt" => esc_html__("Regular W/ Tilt + Accent Color", 'blueprint'),
		  		 "extra-color-1-tilt" => esc_html__("Regular W/ Tilt + Extra Color 1", 'blueprint'),
		  		 "extra-color-2-tilt" => esc_html__("Regular W/ Tilt + Extra Color 2", 'blueprint'),
		  		 "extra-color-3-tilt" => esc_html__("Regular W/ Tilt + Extra Color 3", 'blueprint'),
		  		 "see-through" => esc_html__("See-Through", 'blueprint'),
		  		 "see-through-2" => esc_html__("See-Through + Solid On Hover", 'blueprint'),
		  		 "see-through-3" => esc_html__("See-Through + Solid On Hover Alt", 'blueprint'),
		  		 "see-through-extra-color-gradient-1" => esc_html__("See-Through + Color Gradient 1", 'blueprint'),
		  		 "see-through-extra-color-gradient-2" => esc_html__("See-Through + Color Gradient 2", 'blueprint'),
		  		 "see-through-3d" => esc_html__("See-Through + 3D On Hover", 'blueprint'),
			)
		),
		'color_override' =>array('type'=>'custom', 'title'  => esc_html__('Button Color Override','blueprint')),
		'hover_color_override' =>array('type'=>'custom', 'title'  => esc_html__('Button Hover Color Override','blueprint')),
		'hover_text_color_override'=>array(
			'type'=>'regular-select',
			'title'  => esc_html__('Hover Text Color','blueprint'),
			'values' => array(
			     "#fff" => "Light",
		  		 "#000" => "Dark",
			)
...
//Toggle
$republicpg_shortcodes['toggles'] = array(
	'type'=>'dynamic',
	'title'=>esc_html__('Toggle Panels', 'blueprint' ),
	'attr'=>array(
...
//Tabbed Sections
$republicpg_shortcodes['tabbed_section'] = array(
	'type'=>'dynamic',
	'title'=>esc_html__('Tabbed Section', 'blueprint' ),
	'attr'=>array(
...
//Testimonial Slider
$republicpg_shortcodes['testimonial_slider'] = array(
	'type'=>'dynamic',
	'title'=>esc_html__('Testimonial Slider', 'blueprint' ),
	'attr'=>array(
...
//Bar Graph
/*
$republicpg_shortcodes['bar_graph'] = array(
	'type'=>'dynamic',
	'title'=>esc_html__('Bar Graph', 'blueprint' ),
	'attr'=>array(
...
//Clients
$republicpg_shortcodes['clients'] = array(
	'type'=>'dynamic',
	'title'=>esc_html__('Clients', 'blueprint' ),
	'attr'=>array(
		'clients'=>array('type'=>'custom', 'title'  => esc_html__('Image','blueprint'))
	)
);


//Pricing Table
$republicpg_shortcodes['pricing_table'] = array(
	'type'=>'direct_to_editor',
	'title'=>esc_html__('Pricing Table', 'blueprint' ),
	'attr'=>array(
		'columns'=>array(
			'type'=>'radio',
			'title'=>esc_html__('Columns', 'blueprint'),
			'desc' => esc_html__('How many columns would you like?', 'blueprint'),
			'opt'=>array(
				'2'=>'Two',
				'3'=>'Three',
				'4'=>'Four',
...
//Team Member
$republicpg_shortcodes['team_member'] = array(
	'type'=>'regular',
	'title'=>esc_html__('Team Member', 'blueprint' ),
	'attr'=>array(
		'image'=>array('type'=>'custom', 'title'  => esc_html__('Image','blueprint')),
		'name'=>array('type'=>'text', 'title'=>esc_html__('Name', 'blueprint')),
		'job_position'=>array('type'=>'text', 'title'=>esc_html__('Job Position', 'blueprint')),
		'description'=>array('type'=>'textarea', 'title'=> esc_html__('Description', 'blueprint')),
		'social'=>array('type'=>'textarea', 'title'=>esc_html__('Social Media', 'blueprint'), 'desc' => esc_html__('Enter any social media links with a comma separated list. e.g. Facebook,http://facebook.com, Twitter,http://twitter.com', 'blueprint')),
		'link_element'=>array(
			'type'=>'regular-select',
			'title'  => esc_html__('Team Member Link Type','blueprint'),
			'values' => array(
			     "none" => "None",
		  		 "image" => "Image",
		  		 "name" => "Name",
		...
		'link_url'=>array('type'=>'text', 'title'=>esc_html__('Team Member Link URL', 'blueprint'),'desc' => esc_html__('Will only be used if Link Type is not set to "None".','blueprint')),
		'color'=>array(
			'type'=>'select',
			'title'  => esc_html__('Link Color','blueprint'),
			'values' => array(
			     "accent-color" => esc_html__("Accent-Color",'blueprint'),
		  		 "extra-color-1" => esc_html__("Extra-Color-1",'blueprint'),
		  		 "extra-color-2" => esc_html__("Extra-Color-2",'blueprint'),
...
//Carousel
$republicpg_shortcodes['carousel'] = array(
	'type'=>'direct_to_editor',
	'title'=>esc_html__('Carousel', 'blueprint' ),
	'attr'=>array(
		'carousel_title'=>array(
			'type'=>'text',
			'title'=> esc_html__('Carousel Title', 'blueprint')
		),
		'scroll_speed'=>array(
			'type'=>'text',
			'title'=> esc_html__('Scroll Speed', 'blueprint'),
			'desc' => esc_html__('Enter in milliseconds (default is 700)', 'blueprint'),
		),
		'autorotate'=>array(
			'type'=>'checkbox',
			'title'=> esc_html__('Autorotate', 'blueprint'),
			'desc' => esc_html__('Would you like the carousel the transition automatically?', 'blueprint'),
		),
		'easing'=>array(
			'type'=>'select',
			'title'=> esc_html__('Easing', 'blueprint'),
			'values'=>array(
				'linear'=>'linear',
				'swing'=>'swing',
			...
			'desc' => '<a href="http://jqueryui.com/resources/demos/effect/easing.html" target="_blank">'. esc_html__("Click here",'blueprint') .'</a> ' . esc_html__("to see examples of these.", 'blueprint')
		),
	)
);


$republicpg_shortcodes['social_buttons'] = array(
	'type'=>'regular',
	'title'=>esc_html__('Social Buttons', 'blueprint' ),
	'attr'=>array(
		'full_width_icons'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Display full width?', 'blueprint'),
			'desc' => esc_html__('This will make your social icons expand to fit edge to edge in whatever space they\'re placed.', 'blueprint')
		),
		'hide_share_count'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Hide Share Count?', 'blueprint'),
			'desc' => esc_html__('This will remove your share counts from displaying to the user', 'blueprint')
		),

		'republicpg_love'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Republicpg Love', 'blueprint'),
			'desc' => esc_html__('Check to enable', 'blueprint')
		),
		'facebook'=>array(
			'type'=>'checkbox',
...
//Video
$republicpg_shortcodes['video'] = array(
	'type'=>'regular',
	'title'=>esc_html__('Video', 'blueprint' ),
	'attr'=>array(
		  'mp4'=>array('type'=>'text', 'title'=>esc_html__('MP4 File URL', 'blueprint'), 'desc' => esc_html__('Only supply the formats you desire, this shortcode is just a shortcut to place the default WordPress video player.', 'blueprint') ),
		  'webm'=>array('type'=>'text', 'title'=>esc_html__('WEBM File URL', 'blueprint')),
			'ogv'=>array('type'=>'text', 'title'=>esc_html__('OGV FILE URL', 'blueprint')),
			'poster' => array(
				'type'  =>'custom',
				'title' => esc_html__('Preview Image','blueprint'),
				'desc'  => esc_html__('The preview image should be the same dimensions as your video.','blueprint')
			)
	 )
);

//Audio
$republicpg_shortcodes['audio'] = array(
	'type'=>'regular',
	'title'=>esc_html__('Audio', 'blueprint' ),
	'attr'=>array(
		'mp3'=>array('type'=>'text', 'title'=>esc_html__('MP3 File URL', 'blueprint')),
		'ogg'=>array('type'=>'text', 'title'=>esc_html__('OGA File URL', 'blueprint'))
	)
);
...
$republicpg_shortcodes['header_7'] = array(
	'type'=>'heading',
	'title'=>esc_html__('Portfolio/Blog', 'blueprint' )
);
...
$republicpg_shortcodes['republicpg_portfolio'] = array(
	'type'=>'regular',
	'title'=>esc_html__('Portfolio', 'blueprint' ),
	'attr'=>array(
		'layout'=>array(
			'type'=>'radio',
		...
		'constrain_max_cols'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Constrain Max Columns to 4?', 'blueprint'),
			'desc' => esc_html__("This will change the max columns to 4 (default is 5 for fullwidth). Activating this will make it easier to create a grid with no empty spaces at the end of the list on all screen sizes.", 'blueprint')
		),
		'category' => array(
			'type' => 'multi-select',
			'title' => esc_html__('Portfolio Categories','blueprint'),
			'desc' => esc_html__('Please select the categories you would like to display for your portfolio. You can select multiple categories too (ctrl + click on PC and command + click on Mac).','blueprint'),
			'values' => $types_options
		),
		'starting_category' => array(
			'type' => 'regular-select',
			'title' => esc_html__('Starting Category','blueprint'),
			'desc' => esc_html__('Please select the category you would like you\'re portfolio to start filtered on','blueprint'),
			'values' => $types_options
		),
		'project_style' => array(
			'type' => 'regular-select',
			'title' => esc_html__('Project Style','blueprint'),
			'desc' => esc_html__('Please select the style you would like your projects to display in.','blueprint'),
			'values' => array(
		...
		'masonry_style'=>array(
			...
			'desc' => esc_html__('This will allow your portfolio items to display in a masonry layout as opposed to a fixed grid. You can define your masonry sizes in each project. If using the full width layout, will only be active with the alternative project style.', 'blueprint')
		),

		'enable_sortable'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Enable Sortable', 'blueprint'),
			'desc' => esc_html__('Checking this box will allow your portfolio to display sortable filters', 'blueprint')
		),

		'horizontal_filters'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Horizontal Filters', 'blueprint'),
			'desc' => esc_html__('This will allow your filters to display horizontally instead of in a dropdown. (Only used if you enable sortable above.)', 'blueprint')
		),
		'enable_pagination'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Enable Pagination', 'blueprint'),
			'desc' => esc_html__('Would you like to enable pagination for this portfolio?', 'blueprint')
		),
		...
		'projects_per_page'=>array(
			'type'=>'text',
			'title'=>esc_html__('Projects Per Page', 'blueprint'),
			'desc' => esc_html__('How many projects would you like to display per page? If pagination is not enabled, will simply show this number of projects. Enter as a number example "20"', 'blueprint')
		),
		'lightbox_only'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Lightbox Only?', 'blueprint'),
			'desc' => esc_html__('This will remove the single project page from being accessible thus rendering your portfolio into only a gallery.', 'blueprint')
		)
	)
);
...
$republicpg_shortcodes['recent_projects'] = array(
	'type'=>'direct_to_editor',
	'title'=>esc_html__('Recent Projects', 'blueprint' ),
	'attr'=>array(
		'full_width'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Full Width Carousel?', 'blueprint'),
			'desc' => esc_html__('This will make your carousel extend the full width of the page. Won\'t work in a column shortcode!', 'blueprint')
		),
		'heading'=>array(
			'type'=>'text',
			'title'=>esc_html__('Heading Text', 'blueprint'),
			'desc' => esc_html__('Enter any text you would like for the heading of your carousel', 'blueprint')
		),
		'page_link_text'=>array(
			'type'=>'text',
			'title'=>esc_html__('Page Link Text', 'blueprint'),
			'desc' => esc_html__('This will be the text that is in a link leading users to your desired page (will be omitted for full width carousels and an icon will be used instead)', 'blueprint')
		),
		'page_link_url'=>array(
			'type'=>'text',
			'title'=>esc_html__('Page Link URL', 'blueprint'),
			'desc' => esc_html__('Enter portfolio page URL you would like to link to. Remember to include "http://"!', 'blueprint')
		),

		'hide_controls'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Hide Carousel Controls?', 'blueprint'),
			'desc' => esc_html__('Checking this box will remove the controls from your carousel', 'blueprint')
		),

		'number_to_display'=>array(
			'type'=>'text',
			'title'=>esc_html__('Number of Projects To Show', 'blueprint'),
			'desc' => esc_html__('Enter as a number example "6"', 'blueprint')
		),
		'category' => array(
			'type' => 'multi-select',
			'title' => esc_html__('Category To Display From','blueprint'),
			'values' => $types_options
		),
		'project_style' => array(
			'type' => 'regular-select',
...
$republicpg_shortcodes['republicpg_blog'] = array(
	'type'=>'regular',
	'title'=>esc_html__('Blog', 'blueprint' ),
	'attr'=>array(
		'layout'=>array(
			'type'=>'regular-select',
			'title'=>esc_html__('Layout', 'blueprint'),
		...
		'category' => array(
			'type' => 'multi-select',
			'title' => esc_html__('Blog Categories', 'blueprint'),
			'desc' => esc_html__('Please select the categories you would like to display for your blog. You can select multiple categories too (ctrl + click on PC and command + click on Mac).', 'blueprint'),
			'values' => $blog_options
		),
		'enable_pagination'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Enable Pagination', 'blueprint'),
			'desc' => esc_html__('Would you like to enable pagination?', 'blueprint')
		),
		'pagination_type'=>array(
			'type'=>'regular-select',
			'title'=>esc_html__('Pagination Type', 'blueprint'),
		...
		'posts_per_page'=>array(
			'type'=>'text',
			'title'=>esc_html__('Posts Per Page', 'blueprint'),
			'desc' => esc_html__('How many posts would you like to display per page? If pagination is not enabled, will simply show this number of posts. Enter as a number example "10"', 'blueprint')
		)
	)
);
...
$republicpg_shortcodes['recent_posts'] = array(
	'type'=>'direct_to_editor',
	'title'=>esc_html__('Recent Posts', 'blueprint' ),
	'attr'=>array(
		'title_labels'=>array(
			'type'=>'checkbox',
			'title'=>esc_html__('Enable Title Labels?', 'blueprint'),
			'desc' => esc_html__('These labels are defined by you in the "Blog Options" tab of your theme options panel.', 'blueprint')
		),
		'category' => array(
			'type' => 'multi-select',
			'title' => esc_html__('Category To Display From', 'blueprint'),
		...
		<div id="republicpg-sc-heading">

		<div id="republicpg-sc-generator" class="mfp-hide mfp-with-anim">

			<div class="shortcode-content">
				<div id="republicpg-sc-header">
					<div class="label"><strong>'.esc_html__('Republicpg Shortcodes', 'blueprint').'</strong></div>
					<div class="content"><select id="republicpg-shortcodes" data-placeholder="' . esc_html__("Choose a shortcode", 'blueprint') .'">
				    <option></option>';

					foreach( $republicpg_shortcodes as $shortcode => $republicpg_options ){

						if(strpos($shortcode,'header') !== false) {
							$shortcode_html .= '<optgroup label="'.$republicpg_options['title'].'">';
						}
						else {
							$shortcode_html .= '<option value="'.$shortcode.'">'.$republicpg_options['title'].'</option>';
							$html_options .= '<div class="shortcode-options" id="options-'.$shortcode.'" data-name="'.$shortcode.'" data-type="'.$republicpg_options['type'].'">';

							if( !empty($republicpg_options['attr']) ){
								 foreach( $republicpg_options['attr'] as $name => $attr_option ){
									$html_options .= republicpg_option_element( $name, $attr_option, $republicpg_options['type'], $shortcode );
								 }
							}
		 ...
		 echo $shortcode_html . $html_options; ?>
			...
			<div id="shortcode-content">
				...
				<div class="label"><label id="option-label" for="shortcode-content"><?php echo __( 'Content: ', 'blueprint' ); ?> </label></div>
			...
			<a class="btn" id="add-shortcode"><?php echo __( 'Add Shortcode', 'blueprint' ); ?></a>
...
function republicpg_option_element( $name, $attr_option, $type, $shortcode ){
	...
	case 'custom':
		...
		if( $name == 'tabs' ){
			...
			<a href="#" class="btn blue remove-list-item">'.esc_html__('Remove Tab', 'blueprint' ). '</a> <a href="#" class="btn blue add-list-item">'.esc_html__('Add Tab', 'blueprint' ).'</a>';
		...
		if( $name == 'toggles' ){
			...
			<a href="#" class="btn blue remove-list-item">'.esc_html__('Remove Toggle', 'blueprint' ). '</a> <a href="#" class="btn blue add-list-item">'.esc_html__('Add Toggle', 'blueprint' ).'</a>';
		...
		elseif( $name == 'bar_graph' ){
			...
			<a href="#" class="btn blue remove-list-item">'.esc_html__('Remove Bar', 'blueprint' ). '</a> <a href="#" class="btn blue add-list-item">'.esc_html__('Add Bar', 'blueprint' ).'</a>';
		...
		elseif( $name == 'testimonials' ){
			...
			<a href="#" class="btn blue remove-list-item">'.esc_html__('Remove Testimonial', 'blueprint' ). '</a> <a href="#" class="btn blue add-list-item">'.esc_html__('Add Testimonial', 'blueprint' ).'</a>';
			...
			$option_element .= '
				<div class="shortcode-dynamic-item" id="options-item" data-name="image-upload">
					...
					<div class="content">
			         ...
			         <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload button-secondary" rel-id="">' . esc_html__('Upload', 'blueprint') . '</a>
			         <a href="javascript:void(0);" class="redux-opts-upload-remove" style="display: none;">' . esc_html__('Remove Upload', 'blueprint') . '</a>';
		...
		elseif( $name == 'clients' ){
			...
			<a href="#" class="btn blue remove-list-item">'.esc_html__('Remove Client', 'blueprint' ). '</a> <a href="#" class="btn blue add-list-item">'.esc_html__('Add Client', 'blueprint' ).'</a>';
