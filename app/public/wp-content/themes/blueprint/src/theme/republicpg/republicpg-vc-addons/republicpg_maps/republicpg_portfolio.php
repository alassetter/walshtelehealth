		...
		array(
	      ...
	      "value" => Array(esc_html__("Yes, please", "js_composer") => 'true')
			...
			array(
		      ...
		      "description" => esc_html__("Enabling this will cause your portfolio to bypass the default Blueprint image cropping which varies based on project settings/above layout selection. The result will be a traditional masonry layout rather than a structured grid.", "js_composer"),
		      "value" => Array(esc_html__("Yes, please", "js_composer") => 'true')
		    ),
