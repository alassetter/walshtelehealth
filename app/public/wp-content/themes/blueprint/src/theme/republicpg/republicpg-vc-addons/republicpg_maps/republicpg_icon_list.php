<?php 
	...
	return array(
	  ...
	  ,
	  'default_content' => '
	  [republicpg_icon_list_item title="'.esc_html__('List Item','js_composer').'" id="'.$tab_id_1.'"]  [/republicpg_icon_list_item]
	  [republicpg_icon_list_item title="'.esc_html__('List Item','js_composer').'" id="'.$tab_id_2.'"] [/republicpg_icon_list_item]
	  ',
