...
$blog_types = ($is_admin) ? get_categories() : array('All' => 'all');
		...
		return array(
		  ...
		  "weight" => 8,
		  "icon" => "icon-wpb-blog",
		  "category" => esc_html__('Republicpg Elements', 'js_composer'),
		  ...
		  "params" => array(
			...
			array(
			  ...
			  "admin_label" => false,
			  "value" => array(
			  		 esc_html__('Inherit from Theme Options', 'blueprint') => 'inherit',
						 esc_html__('Material Style', 'blueprint') => 'material',
				     esc_html__('Classic Style', 'blueprint') => 'classic',
             esc_html__('Classic Enhanced Style', 'blueprint') => 'classic_enhanced',
             esc_html__('Meta Overlaid Style', 'blueprint') => 'meta_overlaid',
						 esc_html__('Auto Masonry: Meta Overlaid Spaced', 'blueprint') => 'auto_meta_overlaid_spaced'
				),
			  'save_always' => true,
			...
			array(
			  ...
			  "admin_label" => false,
			  "value" => array(
			  	   esc_html__('4px', 'blueprint') => '4px',
			  		 esc_html__('8px', 'blueprint') => '8px',
             esc_html__('12px', 'blueprint') => '12px',
						 esc_html__('16px', 'blueprint') => '16px',
						 esc_html__('20px', 'blueprint') => '20px',
				),
			  'save_always' => true,
			...
			array(
			  ...
			  "value" => array(
			  	   esc_html__('Inherit from Theme Options', 'blueprint') => 'inherit',
			  		 esc_html__('Classic Style', 'blueprint') => 'classic',
             esc_html__('Minimal Style', 'blueprint') => 'minimal',
						 esc_html__('Featured Image Left Style', 'blueprint') => 'featured_img_left',
				),
			  'save_always' => true,
			...
			array(
					"type" => 'checkbox',
					"heading" => esc_html__("Remove Republicpg Love Button", "js_composer"),
					"param_name" => "blog_remove_post_republicpg_love",
					"description" => esc_html__("Enable this to remove the republicpg love button from displaying on your blog layout", "js_composer"),
					"value" => Array(esc_html__("Yes, please", "js_composer") => 'true')
				),
