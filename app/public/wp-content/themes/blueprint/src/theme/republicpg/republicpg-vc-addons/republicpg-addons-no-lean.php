...
function republicpg_has_shortcode( $shortcode = NULL ) {
...
function republicpg_custom_maps() {
	...
	if(republicpg_has_shortcode('full_width_section')) {  
	...
	if($republicpg_disable_republicpg_slider != true) {
		...
		if(republicpg_has_shortcode('republicpg_slider')) { 
			...
			if (empty($locations)) {
				$location_desc = 
			      '<div class="alert">' .
				 __('You currently don\'t have any Slider Locations setup. Please create some and add assign slides to them before using this!','blueprint'). 
				'<br/><br/>
				<a href="' . admin_url('edit.php?post_type=republicpg_slider') . '">'. __('Link to Republicpg Slider', 'blueprint') . '</a>
				</div>';
			} else { $location_desc = ''; }

			vc_map( array(
			  "name" => __("Republicpg Slider", "js_composer"),
			  "base" => "republicpg_slider",
			  "icon" => "icon-wpb-republicpg-slider",
			  "category" => __('Republicpg Elements', 'js_composer'),
			  "description" => __('The jaw-dropping slider by Republicpg', 'js_composer'),
			  "weight" => 10,
			  "params" => array(
			    array(
			      "type" => "dropdown",
	...
	if(republicpg_has_shortcode('bar')) { 
...
class WPBakeryShortCode_Republicpg_Cascading_Images extends WPBakeryShortCode {}
	...
	$republicpg_offset_vals_arr = array(
	     "0%" => "0%",
		 "5%" => "5%",
		 "10%" => "10%",
		 "15%" => "15%",	
	...
	vc_map( array(
	  ...
	  "base" => "republicpg_cascading_images",
	  ...
	  "params" => array(
	    ...
	    array(
		  ...
		  "value" => $republicpg_offset_vals_arr,
		  'save_always' => true
		),
		 array(
		  "type" => "dropdown",
	...
	vc_map( array(
	  ...
	  "base" => "republicpg_image_comparison",
	  "icon" => "icon-wpb-single-image",
	  "category" => __('Republicpg Elements', 'js_composer'),
	...
	vc_map( array(
	  ...
	  "base" => "republicpg_video_lightbox",
	  ...
	  "params" => array(
		  ...
		  "value" => array(
			 ...
			 "Republicpg Button" => "republicpg-button"
		   ),
		  'save_always' => true,
		  "admin_label" => true,
	    ...
	    array(
		  ...
		  "param_name" => "republicpg_play_button_color",
		  "value" => array(
	    ...
	    array(
	      ...
	      "admin_label" => false,
	      "dependency" => array('element' => "link_style", 'value' => "republicpg-button"),
	     ...
	     array(
		  ...
		  "param_name" => "republicpg_button_color",
		  "value" => array(
			 "Accent-Color" => "Default-Accent-Color",
		...
		vc_map( array(
		  ...
		  "params" => array(
		    array(
		      ...
		      "param_name" => "size",
		      "description" => __('Enter map height in pixels. Example: 200. <span>As of June 2016, a Google map API key is needed to allow this element to display. Please See the Blueprint options panel > general settings > css/script related tab to enter this.</span>', "js_composer")
		    ),
		    array(
		      "type" => "textfield",
	...
	class WPBakeryShortCode_Republicpg_Flip_Box extends WPBakeryShortCode { }
		vc_map( array(
		  ...
		  "base" => "republicpg_flip_box",
		  "icon" => "icon-wpb-republicpg-flip-box",
		  "category" => __('Republicpg Elements', 'js_composer'),
	...
	class WPBakeryShortCode_Republicpg_Gradient_Text extends WPBakeryShortCode { }
		vc_map( array(
		  ...
		  "base" => "republicpg_gradient_text",
		  "icon" => "icon-wpb-republicpg-gradient-text",
		  "category" => __('Republicpg Elements', 'js_composer'),
	...
	class WPBakeryShortCode_Republicpg_Image_With_Hotspots extends WPBakeryShortCode { }
		...
		vc_map( array(
		  ...
		  "base" => "republicpg_image_with_hotspots",
		  "weight" => 2,
		  "icon" => "icon-wpb-single-image",
		  "category" => __('Republicpg Elements', 'js_composer'),
		  ...
		  "params" => array(
			...
			array(
		      ...
		      "param_name" => "preview",
		      "description" => __("Click to add - Drag to move - Edit content below <br/><br/> Note: this preview will not reflect hotspot style choices or show tooltips. <br/>This is only used as a visual guide for positioning. <br/><strong>Requires Blueprint VC 4.12 or higher</strong>", "js_composer"),
		      "value" => ''
		    ),	
			 array(
		      "type" => "textarea_html",
		...
		vc_map( array(
		  "name" => __("Republicpg Hotspot", "js_composer"),
		  "base" => "republicpg_hotspot",
		  "allowed_container_element" => 'vc_row',
		  "content_element" => false,
		  "params" => array(
		    array(
	...
	class WPBakeryShortCode_Republicpg_Animated_Title extends WPBakeryShortCode { }
		vc_map( array(
		  ...
		  "base" => "republicpg_animated_title",
		  "icon" => "icon-wpb-republicpg-gradient-text",
		  "category" => __('Republicpg Elements', 'js_composer'),
	...
	vc_map( array(
	  ...
	  ,
	  'default_content' => '
	  [republicpg_icon_list_item title="'.__('List Item','js_composer').'" id="'.$tab_id_1.'"]  [/republicpg_icon_list_item]
	  [republicpg_icon_list_item title="'.__('List Item','js_composer').'" id="'.$tab_id_2.'"] [/republicpg_icon_list_item]
	  ',
	  "js_view" => ($vc_is_wp_version_3_6_more ? 'VcTabsView' : 'VcTabsView35')
	));
	...
	vc_map( array(
	  ...
	  "base" => "republicpg_icon_list_item",
	  "allowed_container_element" => 'vc_row',
	  "is_container" => true,
	  "content_element" => false,
	  "params" => array(
	...
	vc_map( array(
	  ...
	  "params" => array(
	   ...
	   /* array(
	 	 ...
	 	 array(
	      "type" => 'checkbox',
	      "heading" => __("Republicpg Love", "js_composer"),
	      "param_name" => "republicpg_love",
	      "value" => Array(__("Yes", "js_composer") => 'true')
	    ),
	    array(
	      "type" => 'checkbox',
	...
	if(republicpg_has_shortcode('vc_gallery')) { 
		vc_add_param("vc_gallery",array(
		      ...
		      "value" => array(
		         ...
		         __("Republicpg Slider Style", "js_composer") => "republicpgslider_style",
	...
	vc_map( array(
	  ...
	  "params" => array(
		...
		array(
	      ...
	      "param_name" => "content",
	      "value" => '',
	      "description" => "Please use the Unordered List button <img src='".get_template_directory_uri() ."/republicpg/assets/img/icons/ul.png' alt='unordered list' /> on the editor to create the points of your fancy list."
	    )
	  )
	));
