...
$output = '<div class="republicpg-flip-box" data-min-height="'.$min_height.'" data-flip-direction="'.$flip_direction.'" data-h_text_align="'.$h_text_align.'" data-v_text_align="'.$v_text_align.'">';
