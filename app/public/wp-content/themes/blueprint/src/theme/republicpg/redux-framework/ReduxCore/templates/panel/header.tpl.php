...
<div id="redux-header">
    <?php if ( ! empty( $this->parent->args['display_name'] ) ) { ?>
        <div class="display_header">
            ...
            /* republicpg addition */
            ?>
            <img src="<?php echo REPUBLICPG_FRAMEWORK_DIRECTORY . 'assets/img/icons/blueprint.svg'; ?>" height="20px"  alt="blueprint"/>
        ...
        <div class="secondary-header"><h4><?php echo __('Options Panel','blueprint'); ?></h4></div>
    <?php } ?>
