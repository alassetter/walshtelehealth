		    ...
		    array(
			  ...
			  "value" => array(
			     "Default Style" => "default",
				  "Republicpg Animated" => "republicpg",
			   ),
			  'save_always' => true,
			  "description" => esc_html__("Please select the marker style you would like. Default Style will display the standard map marker and also allow you to optionally override it with an image. Republicpg Animated will use a custom Republicpg CSS based marker (the modern option).", "js_composer")
			),

		    array(
			  "type" => "dropdown",
			  "heading" => esc_html__("Marker Color", "js_composer"),
			  "param_name" => "republicpg_marker_color",
			  "value" => array(
			  ...
			  'save_always' => true,
			  "dependency" => Array('element' => "map_type", 'value' => array('google')),
			  "description" => esc_html__("Please select the color for your republicpg marker. Will only be used with the Republicpg Animated Marker Style", "js_composer")
			),
