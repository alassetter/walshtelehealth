...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		...
		public function __construct( $parent, $redux_instance ) {
			...
			$this->republicpg_import_demo_content = $this->parent->republicpg_import_demo_content;
			$this->republicpg_import_theme_option_settings = $this->parent->republicpg_import_theme_option_settings;
			$this->republicpg_import_demo_widgets = $this->parent->republicpg_import_demo_widgets;
		...
		public function initSettings() {
			...
			if ( isset( $this->active_import_id ) && !empty( $this->active_import_id ) ) {
			  ...
			  //chosen to skip in import
				if($this->republicpg_import_demo_content == 'false') {
				...
				//chosen to skip in import
				if($this->republicpg_import_theme_option_settings == 'false') {
				...
				//chosen to skip in import
				if($this->republicpg_import_demo_widgets == 'false') {
