...
echo '<a href="#" class="mobile-menu-link"><i class="blueprint-page-submenu-icon"></i>'.__('Menu','blueprint').'</a><ul  style="background-color:'.$bg_color.'; color: '.$link_color.';" >'.do_shortcode($content).'</ul>';
