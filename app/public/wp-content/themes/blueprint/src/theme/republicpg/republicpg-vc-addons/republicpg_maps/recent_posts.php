			...
			array(
		      ...
		      "dependency" => Array('element' => "style", 'value' => 'default')
				...
				array(
					...
					'description' => __( 'Choose a color from your','blueprint') . ' <a target="_blank" href="'. esc_url(admin_url()) .'?page=Blueprint&tab=6"> ' . __('globally defined color scheme','blueprint') . '</a>',
				),
				array(
					'type' => 'dropdown',
