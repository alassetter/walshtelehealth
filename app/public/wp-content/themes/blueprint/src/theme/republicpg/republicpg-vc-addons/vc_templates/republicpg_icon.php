...
echo '<div class="republicpg_icon_wrap" data-style="'.$icon_style.'" data-draw="'.$enable_animation.'" data-border-thickness="'.$icon_border_thickness.'" data-padding="'.$icon_padding.'" data-color="'.strtolower($icon_color).'" style="'.$margins.'" >
		<div class="republicpg_icon" '.$grad_dimensions.'>'.$icon_link.$icon_markup.'</div>
	</div>';
