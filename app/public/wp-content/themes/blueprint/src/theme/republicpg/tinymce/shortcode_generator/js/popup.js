jQuery(document).ready(function($){
  ...
  $('#shortcode-content textarea').val('');
    ...
    function directToEditor() {
    	var name = $('#republicpg-shortcodes').val();
    	var content = '';
  ...
  $('#add-shortcode').click(function(){
    ...
    $('#republicpg-shortcodes').change(function(){
  ...
  //moved to republicpg-shortcode-generator.js
  ...
  //moved to republicpg-shortcode-generator.js
	...
	$('#options-republicpg_portfolio #starting_category option:first').remove();
	$('#options-republicpg_portfolio #starting_category').prepend('<option value="default">Default</option>')
	$('#options-republicpg_portfolio #starting_category option:first').attr('selected','selected');
	
	$('#options-republicpg_portfolio #enable_sortable').click(function(){
		var $this = $(this);
	    if ($this.is(':checked')) {
	...
	$("#options-republicpg_portfolio #category").change(function(){
		var selectedCats = $(this).val();
		
		if(selectedCats == 'all') {
			$('#options-republicpg_portfolio #starting_category option').removeAttr('disabled').removeAttr('selected').show();
		} else {
			$('#options-republicpg_portfolio #starting_category option:not([value="default"])').attr('disabled','disabled').removeAttr('selected').hide();
			for(var i=0; i < selectedCats.length; i++){
				$('#options-republicpg_portfolio #starting_category option[value="' + selectedCats[i] + '"]').removeAttr('disabled').show();
			}
			$('#options-republicpg_portfolio #starting_category option:not([disabled])').first().attr('selected','selected');
		}
	});
  ...
  //moved to republicpg-shortcode-generator.js
	...
	function resetFileds(){
		//reset data
		$('#republicpg-sc-generator').find('input:text, input:password, input:file, textarea').val('');
		$('#republicpg-sc-generator').find('select:not(#republicpg-shortcodes) option:first-child').attr("selected", "selected");
		$('#republicpg-sc-generator').find('input:radio, input:checkbox').removeAttr('checked').removeAttr('selected');
		$('#republicpg-sc-generator').find('.shortcode-options').each(function(){
		...
		$('#republicpg-sc-generator').find('.redux-opts-screenshot').attr('src','');
		$('#republicpg-sc-generator').find('.redux-opts-upload-remove').hide();
		$('#republicpg-sc-generator').find('.redux-opts-upload').show();
		$('#republicpg-sc-generator').find('.wp-color-result').attr('style','');
		$('select[name="icon-set-select"]').trigger('change');
		...
		//reset icons
		$('#republicpg-sc-generator').find('.icon-option i').removeClass('selected');
