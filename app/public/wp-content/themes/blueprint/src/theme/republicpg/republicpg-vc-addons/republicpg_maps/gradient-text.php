...
return array(
		  ...
		  "params" => array(
		    ...
		    array(
				...
				'description' => __( 'Choose a color from your','blueprint') . ' <a target="_blank" href="'. esc_url(admin_url()) .'?page=Blueprint&tab=6"> ' . __('globally defined color scheme','blueprint') . '</a> <br/> Will fallback to the first color of the gardient on non webkit browsers.',
			),
			array(
				"type" => "dropdown",
				"class" => "",
