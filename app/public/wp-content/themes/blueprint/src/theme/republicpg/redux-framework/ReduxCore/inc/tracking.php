                    ...
                    (function( $ ) {
                        $( document ).ready(
                            function() {
                                ...
                                redux_pointer_options = $.extend(
                                    redux_pointer_options, {
                                        buttons: function( event, t ) {
                                            button = jQuery( '<a id="pointer-close" style="margin-left:5px" class="button-secondary">' + '<?php echo esc_html( $button1 ); //republicpg addition ?>' + '</a>' );
                                            button.bind(
                                ...
                                setup = function() {
                                    $( '<?php echo esc_html( $selector ); //republicpg addition ?>' ).pointer( redux_pointer_options ).pointer( 'open' );
                                    <?php if ($button2) { ?>
                                    jQuery( '#pointer-close' ).after( '<a id="pointer-primary" class="button-primary">' + '<?php echo esc_html( $button2 ); //republicpg addition ?>' + '</a>' );
