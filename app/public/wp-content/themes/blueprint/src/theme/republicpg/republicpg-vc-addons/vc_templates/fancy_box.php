...
if($box_style == 'parallax_hover') {
	...
	$output = '<div class="republicpg-fancy-box style-5 '.$using_img_class.' '.$css_class.'" data-style="'. $box_style .'" data-animation="'.strtolower($parsed_animation).'" data-delay="'.$delay.'" data-color="'.strtolower($color).'">';
	...
	$output = '<div class="republicpg-fancy-box '.$using_img_class.' '.$css_class.'" data-style="'. $box_style .'" data-animation="'.strtolower($parsed_animation).'" data-border="'.$enable_border.'" data-box-color-opacity="'.$box_color_opacity.'" data-delay="'.$delay.'" data-alignment="'.$box_alignment.'" data-color="'.strtolower($color).'" '.$style2.'>';
