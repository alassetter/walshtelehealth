...
if($btn_style == 'material') {
  echo '<div class="republicpg-cta '.$class.'" data-style="'.$btn_style.'" data-alignment="'.$alignment.'"  data-text-color="'.$text_color.'" '.$style_markup.'>';
  ...
  if($btn_type == 'down-arrow-bounce') {
    echo '<div class="republicpg-next-section-wrap bounce" '.$style_markup.'><a href="#" class="republicpg-next-section skip-hash"> <i class="fa fa-angle-down"></i> </a></div>';
  } else if($btn_type == 'down-arrow-bordered') {
    echo '<div class="republicpg-next-section-wrap down-arrow-bordered" '.$style_markup.'><a href="#" class="republicpg-next-section skip-hash"><i class="fa fa-angle-down top"></i><i class="fa fa-angle-down"></i></a></div>';
  } else if($btn_type == 'mouse-wheel') {
    echo '<div class="republicpg-next-section-wrap mouse-wheel" '.$style_markup.'><a href="#" class="republicpg-next-section skip-hash"><svg class="republicpg-scroll-icon" viewBox="0 0 30 45" enable-background="new 0 0 30 45">
