...
function($) {
    vc.events.on("vc:access:initialize", function(access) {
        ...
        var $btnLocation = ($('#republicpg-metabox-portfolio-extra').length == 0) ? $titleDiv : $('#post-body-content');
        $buttonsContainerSelector = ($('#republicpg-metabox-portfolio-extra').length == 0) ? '#post-body-content > .composer-switch' : '#post-body > .composer-switch';
