...
function($) {
    ...
    vc.EditElementPanelView = vc.PanelView.vcExtendUI(vc.HelperAjax).vcExtendUI(vc.ExtendPresets).vcExtendUI(vc.ExtendTemplates).vcExtendUI(vc.HelperPrompts).extend({
        ...
        buildParamsContent: function(data) {
            ...
            $('div[data-vc-shortcode="republicpg_flip_box"] .republicpg-shortcode-generator').addClass('slim');
            ...
            function verticallyCenterColumns() {
                 ...
                 if($('select[name="type"]').val() == 'full_width_content' && $('._republicpg_full_screen_rows label[for="republicpg_meta_on"].ui-state-active').length > 0) {

                    $('select[name="full_screen_row_position"] .full_height').show();

                 } else if($('select[name="type"]').val() == 'full_width_background' && $('._republicpg_full_screen_rows label[for="republicpg_meta_on"].ui-state-active').length > 0) {
                ...
                if($('._republicpg_full_screen_rows label[for="republicpg_meta_on"].ui-state-active').length > 0 && $('select#_republicpg_full_screen_rows_row_bg_animation').val() == 'ken_burns')
            ...
            if($('._republicpg_full_screen_rows label[for="republicpg_meta_on"].ui-state-active').length > 0) {
            ...
            //hotspot
            if($('[data-vc-shortcode="republicpg_image_with_hotspots"]').length > 0) { 

                $('body').on('click','[data-vc-shortcode="republicpg_image_with_hotspots"] .vc_icon-remove',function(){
                    $('#republicpg_image_with_hotspots_preview').addClass('no-img');
                });
                
                if($('[data-vc-shortcode="republicpg_image_with_hotspots"]  [name="preview"]').val().length == 0) {
                    $('#republicpg_image_with_hotspots_preview').addClass('no-img');
                }
                ...
                if($('[data-vc-shortcode-param-name="content"] .vc_textarea_html_content').val().length > 0) {
                    ...
                    var hotspotRegex = wp.shortcode.regexp('republicpg_hotspot'),
                        matches;
                ...
                if($hotSpotData.length > 0) {
                    ...
                    $.each($hotSpotData,function(k,v){
                        //hotspot
                        $('#republicpg_image_with_hotspots_preview').append('<div class="hotspot" data-rel="'+(k+1)+'" style="top: '+v.top+'; left: '+v.left+';">'+(k+1)+'</div>');
                ...
                function updateHotSpotData(rel,x,y) {
                    ...
                    $that.$convertedData = '';
                    $.each($hotSpotData,function(k,v){
                        $that.$convertedData += '[republicpg_hotspot left="'+v.left+'" top="'+v.top+'" position="'+v.position+'"]'+v.content+'[/republicpg_hotspot]';
                    });
                ...
                ////add new with click
                $('#republicpg_image_with_hotspots_preview:not(#republicpg_image_with_hotspots_preview .hotspot)').click(function(e){
                    ...
                    if($('.ui-draggable-dragging').length > 0)
                     ...
                     var posX = $(this).offset().left,
                        ...
                        hotSpots = $('#republicpg_image_with_hotspots_preview .hotspot').length;
                        hotSpots++;
                ...
                function hotspotMakeDraggable() {
                    $('#republicpg_image_with_hotspots_preview .hotspot:not(.ui-draggable)').draggable({
                         containment: 'parent',
                ...
                $('body').on('click.hotspot-delete-event','.hotspot-content a.delete',function(e){
                    ...
                    $('#republicpg_image_with_hotspots_preview .hotspot').each(function(i){
                ...
                $('body').on('keyup','.hotspot-content textarea',function(){
                     ...
                     updateHotSpotData($rel, $('#republicpg_image_with_hotspots_preview .hotspot[data-rel="'+$rel+'"]')[0].style.left , $('#republicpg_image_with_hotspots_preview .hotspot[data-rel="'+$rel+'"]')[0].style.top);
                });
        ...
        save: function() {
            ...
            /* republicpg addition */ 
              ...
              if($('[data-vc-shortcode="republicpg_image_with_hotspots"]').length > 0 && this.$convertedData.length > 0) {
        ...
        vc.edit_form_callbacks = [], vc.atts = {
            ...
            init: function(param, $field) {
              ...
              $(".vc_color-control", $field).each(function() {
                /* republicpg addition of palettes logic only*/
                  var $alpha, $alpha_output, $pickerContainer, $control = $(this),
                      value = $control.val().replace(/\s+/g, ""),
                      alpha_val = 100;

                      var $republicpgColor1 = ( $(this).is('[data-color-1]') ) ? $(this).attr('data-color-1') : '#dd3333';
                      var $republicpgColor2 = ( $(this).is('[data-color-2]') ) ? $(this).attr('data-color-2') : '#dd9933';
                      var $republicpgColor3 = ( $(this).is('[data-color-3]') ) ? $(this).attr('data-color-3') : '#eeee22';
                      var $republicpgColor4 = ( $(this).is('[data-color-4]') ) ? $(this).attr('data-color-4') : '#81d742';

                      var $republicpgPalColors = ['#000', '#fff', $republicpgColor1, $republicpgColor2, $republicpgColor3, $republicpgColor4];
              ...
              /* republicpg addition end of palettes logic only*/
            }
    ...
    function($) {
        vc.debug = !1, vc.map = _.isUndefined(window.vc_mapper) ? {} : window.vc_mapper, vc.roles = _.isUndefined(window.vc_roles) ? {} : window.vc_roles, vc.Storage = function() {
            ...
            getContent: function() {
                ...
                if($('#republicpg-metabox-portfolio-extra').length == 0){ 
                      return window.vc_wpnop($('#content').val() || "");
                 } 
                //portfolio extra
                 else {
                     return window.vc_wpnop($('textarea#_republicpg_portfolio_extra_content').val());
                 }
                 /* republicpg addition end */ 
            },
            ...
            setContent: function(content) {
                ...
                //portfolio extra
                   ...
                   var contentTinyMce = window.tinyMCE && window.tinyMCE.get && window.tinyMCE.get("_republicpg_portfolio_extra_content");
                   content = vc_wpautop(content), $("textarea#_republicpg_portfolio_extra_content").val(content), contentTinyMce && contentTinyMce.setContent(content) && contentTinyMce.fire("change")
                 }
        ...
        vc.saved_custom_css = !1, vc.createPreLoader = function() {
            ...
            render: function() {
              ...
              //portfolio extra
                  ...
                  this.$post = $('#republicpg-metabox-portfolio-extra');
              }
        ...
        window.VcRowView = vc.shortcode_view.extend({
            ...
            addTab: function(e) {
                ...
                var tab_title = window.i18nLocale.tab,
                   ...
                   } else if(this.model.get('shortcode') === 'republicpg_icon_list'){
                      tab_title = window.i18nLocale.republicpg_icon_list_item;
                      return vc.shortcodes.create({shortcode:'republicpg_icon_list_item', params:{title:tab_title, id:tab_id}, parent_id:this.model.id});
            ...
            changedContent: function(view) {
             ...
             if (view.model.get('cloned') === true) {
                 ...
                 if(!params.title && this.model.get('shortcode') === 'republicpg_icon_list') params.title = window.i18nLocale.republicpg_icon_list_item;
            ...
            cloneModel: function(model, parent_id, save_order) {
              ...
              if (model.get('shortcode') === 'republicpg_icon_list_item') _.extend(new_params, {id:+new Date() + '-' + this.$tabs.find('[data-element-type=republicpg_icon_list_item]').length + '-' + Math.floor(Math.random() * 11)});
              ...
              else if (model.get('shortcode') === 'republicpg_icon_list_item') { 
                  model_clone = Shortcodes.create({shortcode:model.get('shortcode'), id:vc_guid(), parent_id:parent_id, order:new_order, cloned:(model.get('shortcode') === 'republicpg_icon_list_item' ? false : true), cloned_from:model.toJSON(), params:new_params});
                  _.each(Shortcodes.where({parent_id:model.id}), function (shortcode) {
                      this.cloneModel(shortcode, model_clone.get('id'), true);
                  }, this);
          ...
          cloneModel:function (model, parent_id, save_order) {
              var shortcodes_to_resort = [],
                  new_order = _.isBoolean(save_order) && save_order === true ? model.get('order') : parseFloat(model.get('order')) + vc.clone_index,
                  new_params = _.extend({}, model.get('params'));
              if (model.get('shortcode') === 'tab' || model.get('shortcode') === 'client' || model.get('shortcode') === 'republicpg_icon_list_item'  || model.get('shortcode') === 'page_link' ||  model.get('shortcode') === 'testimonial' || model.get('shortcode') === 'pricing_column' || model.get('shortcode') === 'item') _.extend(new_params, {id:+new Date() + '-' + this.$tabs.find('[data-element_type=tab]').length + '-' + Math.floor(Math.random() * 11)});
            ...
            $(".media-modal").addClass("processing-media"), processImages(_.extend({}, selection), function(newAttachments) {
                ...
                switch (type) {
                    ...
                    case "single":
                      ...
                      //hotspot logic
                      if($('[data-vc-shortcode="republicpg_image_with_hotspots"]').length > 0) {
                          $('#republicpg_image_with_hotspots_preview img').remove();
                          $('#republicpg_image_with_hotspots_preview').removeClass('no-img').append('<img src="'+objects[0]['url']+'" alt="preview" />');
                          $('#republicpg_image_with_hotspots_preview input[type="hidden"]').attr('value',objects[0]['url']);
                      }
                      /* republicpg addition end */ 
