<?php
/*
Plugin Name: Blueprint WPBakery Page Builder
Plugin URI: http://wpbakery.com
Description: Drag and drop page builder for WordPress. Take full control over your WordPress site, build any layout you can imagine – no programming knowledge required.
Version: 5.6
Author: Michael M - WPBakery.com | Modified by Republicpg
...
/*republicpg addition*/
define( 'BLUEPRINT_VC_ACTIVE', true );
...
class Vc_Manager {
	 ...
	 */
	 /*republicpg addition*/
  private $plugin_name = 'js_composer_blueprint/js_composer.php';
  /*republicpg addition end*/
	...
	public function setEditorDefaultPostTypes( array $type ) {
		...
		$options = get_option( 'blueprint_redux' );
		$republicpg_vc_post_types = (!empty($options['product_tab_position']) && $options['product_tab_position'] == 'fullwidth') ? array('page','post','portfolio','product') : array('page','post','portfolio');
		$republicpg_vc_post_types = $type;
		/*republicpg addition end */
	}
	...
	public function editorDefaultPostTypes() {
		...
		$options = get_option( 'blueprint_redux' );
		$republicpg_vc_post_types = (!empty($options['product_tab_position']) && $options['product_tab_position'] == 'fullwidth') ? array('page','post','portfolio','product') : array('page','post','portfolio');
		return $republicpg_vc_post_types;
		/*republicpg addition end */
	}
