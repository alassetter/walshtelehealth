...
! function($) {
    vc_iframe.showNoContent = function(show) {
      ...
      $('.republicpg-vc-el-outline-active').removeClass('republicpg-vc-el-outline-active');
        ...
        /*republicpg addition - just adding wrapping span for text */ 
        ...
        //republicpg addition - full page row ordering
        ...
        setTimeout(function(){
         $('#fp-nav ul').sortable({
             ...
             stop: function(event, ui) {
               ...
               var FProwToMove = $('#republicpg_fullscreen_rows > .vc_element:nth-child('+FPstartingIndex+')').detach();
               
               if(FPendingIndex === 0) {
                 $('#republicpg_fullscreen_rows').prepend(FProwToMove);
               } else {
                 FProwToMove.insertAfter( $('#republicpg_fullscreen_rows > .vc_element:nth-child('+FPendingIndex+')') );
               }
             ...
             update: function(event, ui) {
               ...
               var rowEmulatinoObj = {
                 item : $('#republicpg_fullscreen_rows > div:first-child')
               }
                parent.vc.app.saveRowOrder(event, rowEmulatinoObj)
             }
         });
       },400);
        //republicpg adition end
        ...
        if(view.$el && $(view.$el).find('.tabbed[data-style*="vertical"]').length > 0 ) {
          var $republicpgTabbedAxis = "y";
        } else {
          var $republicpgTabbedAxis = "x";
        }
        /* republicpg addition end */
        $controls.hasClass("ui-sortable") && $controls.sortable("destroy"), $controls.sortable({
            axis: $republicpgTabbedAxis,
      ...
      else if( view.$accordion.hasClass('republicpg-icon-list')) {
        $(view.$accordion.get(0)).sortable({
            handle: ".vc_move-republicpg_icon_list_item",
            update: view.stopSorting,
            placeholder: "vc_placeholder-accord"
        });
      } 
      else if( view.$accordion.hasClass('slides') || view.$accordion.hasClass('flickity-slider') && view.$accordion.parents('.republicpg-carousel').length === 0) {
        $(view.$accordion.get(0)).sortable({
            ...
            placeholder: "vc_placeholder-accord",
            start: function(event, ui) {
              ui.helper.parent().addClass('republicpg-sortable-block-display');
            ...
            stop: function(event, ui) {
              ui.item.parent().removeClass('republicpg-sortable-block-display');
      ...
      } else if( view.$accordion.hasClass('owl-stage') || view.$accordion.hasClass('flickity-slider') && view.$accordion.parents('.republicpg-carousel').length > 0) {
