...
jQuery( window ).on( 'YoastSEO:ready', function () {
	...
	var contentModification = function ( data ) {
		...
		/*republicpg addition*/
		if($('#republicpg-metabox-portfolio-extra').length > 0 && $('textarea#_republicpg_portfolio_extra_content').length > 0){ 
			var contentPortfolioTinyMce = window.vc_wpnop($('textarea#_republicpg_portfolio_extra_content').val());
