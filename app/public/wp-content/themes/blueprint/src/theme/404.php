...
$page_404_bg_image               = ( ! empty( $options['page-404-bg-image'] ) && isset( $options['page-404-bg-image'] ) ) ? republicpg_options_img( $options['page-404-bg-image'] ) : null;
		...
		<div class="row">
			...
			<div class="col span_12">
				...
				?>
				 >
					<h1>404</h1>
					<h2><?php echo esc_html__( 'Page Not Found', 'blueprint' ); ?></h2>
					
					<?php if ( $page_404_home_button == '1' ) { ?>
						   <a class="republicpg-button large regular-button accent-color has-icon" data-color-override="false" data-hover-color-override="false" href="<?php echo esc_url( home_url() ); ?>"><span><?php echo esc_html__( 'Back Home', 'blueprint' ); ?> </span><i class="icon-button-arrow"></i></a>
						<?php } ?>
				</div>
