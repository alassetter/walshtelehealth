...
$tab_style = (!empty($republicpg_options['product_tab_position'])) ? $republicpg_options['product_tab_position'] : 'default';
$fullwidth_tabs = (!empty($republicpg_options['product_tab_position']) && $republicpg_options['product_tab_position'] == 'fullwidth' || !empty($republicpg_options['product_tab_position']) && $republicpg_options['product_tab_position'] == 'fullwidth_centered') ? true : false;
