...
global $post, $product, $woocommerce, $republicpg_options;

$product_gallery_style = (!empty($republicpg_options['single_product_gallery_type'])) ? $republicpg_options['single_product_gallery_type'] : 'default';
...
wp_enqueue_script('republicpg_single_product');
