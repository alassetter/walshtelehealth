...
$display_sortable = get_post_meta( $post->ID, 'republicpg-metabox-portfolio-display-sortable', true );
...
<?php republicpg_page_header($post->ID); ?>
...
<div class="container-wrap">
	...
	<div class="container" data-col-num="<?php echo esc_attr( $cols ); ?>">
		...
		<?php //inline portfolio filters
			...
			<div class="<?php echo esc_attr( $filters_id ) .' '; echo esc_attr( $filters_width ); if($span_num != 'elastic-portfolio-item') echo 'non-fw'; ?>" data-color-scheme="default">
				<div class="container <?php if($span_num == 'elastic-portfolio-item') { echo 'normal-container'; } ?>">
					<span id="current-category"><?php echo esc_html__('All', 'blueprint'); ?></span>
					<ul>
					   <li id="sort-label"><?php echo (!empty($options['portfolio-sortable-text'])) ? wp_kses_post( $options['portfolio-sortable-text'] ) : esc_html__('Sort Portfolio','blueprint'); ?>:</li>
		...
		<div class="portfolio-wrap <?php if($project_style == '1' && $span_num == 'elastic-portfolio-item') echo 'default-style'; if($project_style == '6' && $span_num == 'elastic-portfolio-item') echo 'spaced'; ?>">
			...
			//get categories 
			global $post;
			$categories = get_post_meta($post->ID, 'republicpg-metabox-portfolio-display', true);
		...
		if ( ! empty( $options['portfolio_extra_pagination'] ) && $options['portfolio_extra_pagination'] == '1' ) {
		 ...
		 if ( $total_pages > 1 ) {
			 ...
			 echo '<div id="pagination" class="' . esc_attr( $fw_pagination ) . ' ' . esc_attr( $masonry_padding ) . esc_attr( $infinite_scroll_class ) . '" data-is-text="' . esc_attr__( 'All items loaded', 'blueprint' ) . '">';
