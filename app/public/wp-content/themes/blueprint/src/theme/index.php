...
<?php republicpg_page_header( get_option( 'page_for_posts' ) ); ?>
...
<div class="container-wrap">
	...
	<div class="container main-content">
		...
		<div class="row">
			...
			$remove_post_republicpg_love    = ( ! empty( $options['blog_remove_post_republicpg_love'] ) ) ? $options['blog_remove_post_republicpg_love'] : '0';
