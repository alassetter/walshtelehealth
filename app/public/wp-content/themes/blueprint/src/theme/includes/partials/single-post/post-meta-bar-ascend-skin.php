...
<div id="single-below-header" class="<?php echo esc_attr( $fullscreen_class ); // WPCS: XSS ok. ?> custom-skip" data-remove-post-comment-number="<?php echo esc_attr( $remove_single_post_comment_number ); ?>">
  ...
  <span class="meta-comment-count"><i class="icon-default-style steadysets-icon-chat-3"></i> <a class="comments-link" href="<?php comments_link(); ?>"><?php comments_number( esc_html__( 'No Comments', 'blueprint' ), esc_html__( 'One Comment ', 'blueprint' ), esc_html__( '% Comments', 'blueprint' ) ); ?></a></span>
