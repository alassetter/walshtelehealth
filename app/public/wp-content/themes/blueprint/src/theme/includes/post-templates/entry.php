						...
						<div class="article-content-wrap">
							...
							<div class="post-header">
								...
								<?php if ( ! ( $masonry_type == 'classic_enhanced' && $using_masonry == true ) && ! ( $using_masonry == true && $masonry_type == 'material' ) ) { ?>
									<span class="meta-author"><span><?php echo esc_html__( 'By', 'blueprint' ); ?></span> <?php the_author_posts_link(); ?></span> <span class="meta-category">| <?php the_category( ', ' ); ?></span>

									<?php if ( comments_open() ) { ?>
										<span class="meta-comment-count">| <a href="<?php comments_link(); ?>">
											<?php comments_number( esc_html__( 'No Comments', 'blueprint' ), esc_html__( 'One Comment ', 'blueprint' ), esc_html__( '% Comments', 'blueprint' ) ); ?></a>
										</span>
									<?php } ?>
