...
if ( $side_widget_area == '1' ) {
	...
	<div id="slide-out-widget-area" class="<?php echo esc_attr( $side_widget_class ); ?>" data-dropdown-func="<?php echo esc_attr( $dropdown_func ); ?>" data-back-txt="<?php echo esc_attr__( 'Back', 'blueprint' ); ?>">
		...
		<div class="inner" data-prepend-menu-mobile="<?php echo esc_attr( $prepend_mobile_menu ); ?>">
		  ...
		  <a class="slide_out_area_close" href="#">
			<?php
			if ( $theme_skin != 'material' ) {
				echo '<span class="icon-blueprint-x icon-default-style"></span>';
			} else {
			   ...
			   <div class="off-canvas-menu-container mobile-only">
					  ...
					  <?php
						...
						if ( ! empty( $options['secondary-header-text'] ) && $using_secondary == 'header_with_secondary' ) {
							$republicpg_secondary_link = ( ! empty( $options['secondary-header-link'] ) ) ? $options['secondary-header-link'] : '';
							echo '<div class="secondary-header-text">';
							if ( ! empty( $republicpg_secondary_link ) ) {
								echo '<a href="' . esc_url( $republicpg_secondary_link ) . '">'; }
...
elseif ( ! has_nav_menu( 'off_canvas_nav' ) && $user_set_side_widget_area != 'off' ) :
	?>
		...
		<?php
			...
			republicpg_hook_ocm_bottom_meta();
...
elseif ( ! has_nav_menu( 'off_canvas_nav' ) && $user_set_side_widget_area != 'off' ) :
	?>
		...
		if ( ! empty( $options['header-slide-out-widget-area-social'] ) && $options['header-slide-out-widget-area-social'] == '1' ) {
			...
			republicpg_header_social_icons( 'off-canvas' );
			echo '</ul>';
		}
