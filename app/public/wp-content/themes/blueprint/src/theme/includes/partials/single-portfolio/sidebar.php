  ...
  <div id="sidebar-inner">
	...
	<div id="project-meta" data-sharing="<?php echo ( ! empty( $options['portfolio_social'] ) && $options['portfolio_social'] == 1 ) ? '1' : '0'; ?>">
		...
		if ( ! empty( $options['portfolio_social'] ) && $options['portfolio_social'] == 1 && $project_social_style != 'fixed_bottom_right' ) {
			...
			echo '<li class="meta-share-count"><a href="#"><i class="icon-default-style steadysets-icon-share"></i><span class="share-count-total">0</span> <span class="plural">' . esc_html__( 'Shares', 'blueprint' ) . '</span> <span class="singular">' . esc_html__( 'Share', 'blueprint' ) . '</span></a> <div class="republicpg-social">';
		...
		echo '<li><span class="n-shortcode">' . republicpg_love( 'return' ) . '</span></li>';
