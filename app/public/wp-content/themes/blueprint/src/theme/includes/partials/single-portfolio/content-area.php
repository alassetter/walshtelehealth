...
$fwp = get_post_meta( $post->ID, '_republicpg_portfolio_item_layout', true );
if ( empty( $fwp ) ) {
	$fwp = 'false';
}
...
$hidden_featured_media     = get_post_meta( $post->ID, '_republicpg_hide_featured', true );
$hidden_project_title      = get_post_meta( $post->ID, '_republicpg_hide_title', true );
