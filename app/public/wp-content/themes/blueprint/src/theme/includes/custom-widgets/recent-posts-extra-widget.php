...
class Recent_Posts_Extra_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'recent_posts_extra_widget', 'description' => __( "The most recent posts on your site, including post thumbnails & dates.",'blueprint'));
		parent::__construct('recent-posts-extra', esc_html__('Republicpg Recent Posts Extra','blueprint'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Recent Posts Extra','blueprint') : $instance['title']);
...
?>
		...
		<ul class="republicpg_blog_posts_recent_extra republicpg_widget" data-style="<?php echo esc_attr( $post_style ); ?>">
...
?>	
		<p><label for="<?php echo esc_attr( $this->get_field_id('title') ); ?>"><?php _e('Title:', 'blueprint'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_attr_e( 'Category:', 'blueprint' ); ?></label>
			<select id="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'category' ) ); ?>" class="widefat" style="width:100%;">	

				<option <?php if ( esc_attr__( 'All', 'blueprint' ) == $instance['category'] ) { echo 'selected="selected"'; } ?>><?php esc_attr_e( 'All', 'blueprint' ); ?></option>
		...
		<p><label for="<?php echo esc_attr( $this->get_field_id('number') ); ?>"><?php _e('Number of posts to show:', 'blueprint'); ?></label>
		...
		<small><?php _e('(at most 15)', 'blueprint'); ?></small></p>
<?php
	}
}
