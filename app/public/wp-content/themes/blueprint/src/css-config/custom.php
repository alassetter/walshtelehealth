...
$external_dynamic = (!empty($options['external-dynamic-css']) && $options['external-dynamic-css'] == 1) ? 'on' : 'off';
	...
	if($external_dynamic != 'on') {
		...
		if(!empty($options['boxed_layout']) && $options['boxed_layout'] == '1')  {
			...
			echo '<style type="text/css">
			 body {
			 	background-image: url("'.republicpg_options_img($options["background_image"]).'");
  ...
  $headerResize = (!empty($options['header-resize-on-scroll']) && $perm_trans != '1' && $headerFormat != 'centered-menu-bottom-bar') ? $options['header-resize-on-scroll'] : '0';
	...
	if(isset($options['loading-image']['id'])){
		$custom_loading_icon = ' .portfolio-loading, #ajax-loading-screen .loading-icon, .loading-icon, .pp_loaderIcon { background-image: url("'.republicpg_options_img( $options["loading-image"] ).'"); } ';
	} else {
	...
	if($external_dynamic != 'on') { echo '<style type="text/css">'; }
	  ...
	  if($headerFormat != 'left-header') {
		  ...
		  @media only screen and (min-width: 1001px) {
				...
				#header-outer[data-format="centered-menu-bottom-bar"] header#top .span_9 nav >ul >li:not(#social-in-menu):not(#republicpg-user-account):not(#search-btn):not(.slide-out-widget-area-toggle) > a { padding-bottom: '.$header_padding.'px;  }
		 ...
		 body:not(.material) header#top nav > ul li#republicpg-user-account,
		...
		.ascend #header-outer[data-full-width="true"] header#top nav > ul li#republicpg-user-account a,
	...
	if($theme_skin == 'material') {
		echo '@media only screen and (max-width: 1000px) {
			...
			.using-mobile-browser #republicpg_fullscreen_rows:not(.afterLoaded):not([data-mobile-disable="on"]) > div {
			...
			if(is_admin_bar_showing()) {
				echo '.admin-bar #page-header-wrap.fullscreen-header,
				.admin-bar #page-header-wrap.fullscreen-header #page-header-bg,
				html:not(.republicpg-box-roll-loaded) .admin-bar .republicpg-box-roll > #page-header-bg.fullscreen-header,
				.admin-bar .republicpg_fullscreen_zoom_recent_projects,
				.admin-bar .republicpg-slider-wrap[data-fullscreen="true"]:not(.loaded),
				.admin-bar .republicpg-slider-wrap[data-fullscreen="true"]:not(.loaded) .swiper-container,
				.admin-bar #republicpg_fullscreen_rows:not(.afterLoaded):not([data-mobile-disable="on"]) > div  {
				...
				#page-header-wrap.fullscreen-header #page-header-bg,
				 html:not(.republicpg-box-roll-loaded) .republicpg-box-roll > #page-header-bg.fullscreen-header,
				 .republicpg_fullscreen_zoom_recent_projects,
				 .republicpg-slider-wrap[data-fullscreen="true"]:not(.loaded),
				 .republicpg-slider-wrap[data-fullscreen="true"]:not(.loaded) .swiper-container,
				 #republicpg_fullscreen_rows:not(.afterLoaded):not([data-mobile-disable="on"]) > div {
			...
			html:not(.republicpg-box-roll-loaded) [data-bg-header="true"][data-permanent-transparent="1"] .republicpg-box-roll > #page-header-bg.fullscreen-header,
			[data-bg-header="true"][data-permanent-transparent="1"] .republicpg_fullscreen_zoom_recent_projects,
			[data-permanent-transparent="1"] .republicpg-slider-wrap[data-fullscreen="true"]:not(.loaded), [data-permanent-transparent="1"] .republicpg-slider-wrap[data-fullscreen="true"]:not(.loaded) .swiper-container {
				height: 100vh;
			}
    ...
    display: -ms-flexbox;     -webkit-align-items: center;  -moz-align-items: center;  -ms-align-items: center;-ms-flex-align: center; align-items: center; height: 100%; }
			...
			body.material #header-outer[data-using-secondary="1"][data-format="centered-menu-bottom-bar"][data-condense="true"]:not([data-format="left-header"]) {
	 		...
	 		body #header-outer[data-full-width="false"] header#top nav ul #search-btn >div, body #header-outer[data-full-width="false"] header#top nav ul #republicpg-user-account >div { border-left: none!important}
	...
	echo $custom_loading_icon; // WPCS: XSS ok.
	 ...
	 //republicpg slider font calcs
	 $heading_size = (!empty($options['use-custom-fonts']) && $options['use-custom-fonts'] == 1 && $options['republicpg_slider_heading_font_size'] != '-') ? intval($options['republicpg_slider_heading_font_size']) : 60;
	 ...
	 echo '@media only screen and (min-width: 1000px) and (max-width: 1300px) {
	    .republicpg-slider-wrap[data-full-width="true"] .swiper-slide .content h2,
	    .republicpg-slider-wrap[data-full-width="boxed-full-width"] .swiper-slide .content h2,
	...
	@media only screen and (max-width : 690px) {
		.republicpg-slider-wrap[data-full-width="true"][data-fullscreen="false"] .swiper-slide .content h2,
		.republicpg-slider-wrap[data-full-width="boxed-full-width"][data-fullscreen="false"] .swiper-slide .content h2,
	    .full-width-content .vc_span12 .republicpg-slider-wrap[data-fullscreen="false"] .swiper-slide .content h2 {
		...
		.republicpg-slider-wrap[data-full-width="true"][data-fullscreen="false"] .swiper-slide .content p,
		.republicpg-slider-wrap[data-full-width="boxed-full-width"][data-fullscreen="false"]  .swiper-slide .content p,
	    .full-width-content .vc_span12 .republicpg-slider-wrap[data-fullscreen="false"] .swiper-slide .content p {
	...
	if($external_dynamic != 'on') {
		...
		if($body_border == '1') {
			...
			#header-outer, body #header-outer-bg-only  {box-shadow: none; -webkit-box-shadow: none;}
			 ...
			 #republicpg_fullscreen_rows, body:not(.material) #slide-out-widget-area-bg:not(.fullscreen-alt) { margin-top: '.$body_border_size.'px; }
			...
			.republicpg-social-sharing-fixed { margin-bottom: '.$body_border_size.'px; margin-right: '.$body_border_size.'px; }
		...
		if( $woocommerce && version_compare( $woocommerce->version, "3.0", ">=" ) ) {
			...
			if(is_shop() || is_product_category() || is_product_tag()) {
				$font_color = get_post_meta(wc_get_page_id('shop'), '_republicpg_header_font_color', true);
			} else {
		 ...
		 $page_header_title = get_post_meta($post->ID, '_republicpg_header_title', true);
		 ...
		 if(!empty($font_color) && !is_search()) {
			 ...
			 $colorB = hexdec( substr( $font_color_no_hash, 4, 2 ) );
		 	 ...
		 	 echo '.single #page-header-bg #single-meta ul li.meta-share-count .republicpg-social a i { color: rgba('.$colorR.','.$colorG.','.$colorB.',0.7)!important; }';
		 	 echo '.single #page-header-bg #single-meta ul li.meta-share-count .republicpg-social a:hover i { color: rgba('.$colorR.','.$colorG.','.$colorB.',1)!important; }';
		 }
	...
	if(!empty($options['transparent-header']) && $options['transparent-header'] == '1') {
		...
		echo '
				#header-outer.transparent header#top #logo, #header-outer.transparent header#top #logo:hover {
				 ...
				 #header-outer.transparent header#top nav ul #search-btn a span.icon-blueprint-search,
				 #header-outer.transparent header#top nav ul #republicpg-user-account a span,
				 #header-outer.transparent nav > ul > li > a > .sf-sub-indicator [class^="icon-"],
				 #header-outer.transparent nav > ul > li > a > .sf-sub-indicator [class*=" icon-"],
				 #header-outer.transparent .cart-menu .cart-icon-wrap .icon-blueprint-cart,
				 .ascend #boxed #header-outer.transparent .cart-menu .cart-icon-wrap .icon-blueprint-cart
				  {
				 	color: '.$starting_color.'!important;
				...
				#header-outer.transparent header#top nav > ul > li > a:hover > .sf-sub-indicator > i, #header-outer.transparent header#top nav > ul > li.sfHover > a > span > i,  #header-outer.transparent header#top nav ul #republicpg-user-account a:hover span, #header-outer.transparent header#top nav ul #search-btn a:hover span, #header-outer.transparent header#top nav ul #republicpg-user-account a:hover span, #header-outer.transparent header#top nav ul .slide-out-widget-area-toggle a:hover span,
				...
				#header-outer.transparent .cart-outer:hover .icon-blueprint-cart, .ascend #boxed #header-outer.transparent .cart-outer:hover .cart-menu .cart-icon-wrap .icon-blueprint-cart
				...
				#header-outer.transparent:not(.directional-nav-effect) .midnightHeader.republicpg-slider header#top nav ul .slide-out-widget-area-toggle a i.lines,
				#header-outer.transparent:not(.directional-nav-effect) .midnightHeader.republicpg-slider header#top nav ul .slide-out-widget-area-toggle a i.lines:before,
				#header-outer.transparent:not(.directional-nav-effect) .midnightHeader.republicpg-slider header#top nav ul .slide-out-widget-area-toggle a i.lines:after,
				#header-outer.transparent.directional-nav-effect .midnightHeader.republicpg-slider header#top nav ul .slide-out-widget-area-toggle a span.light .lines-button i, #header-outer.transparent.directional-nav-effect .midnightHeader.republicpg-slider header#top nav ul .slide-out-widget-area-toggle a span.light .lines-button i:after, #header-outer.transparent.directional-nav-effect .midnightHeader.republicpg-slider header#top nav ul .slide-out-widget-area-toggle a span.light .lines-button i:before  {
					background-color: '.$starting_color.'!important;
				}
		...
		#header-outer.transparent.dark-row > header#top nav > ul > li > a,
		 #header-outer.transparent.dark-slide:not(.directional-nav-effect) > header#top nav ul #search-btn a span,
		  #header-outer.transparent.dark-row:not(.directional-nav-effect) > header#top nav ul #search-btn a span,
			#header-outer.transparent.dark-slide:not(.directional-nav-effect) > header#top nav ul #republicpg-user-account a span,
			  #header-outer.transparent.dark-row:not(.directional-nav-effect) > header#top nav ul #republicpg-user-account a span,
		 #header-outer.transparent.dark-slide > header#top nav > ul > li > a > .sf-sub-indicator [class^="icon-"],
		 #header-outer.transparent.dark-slide > header#top nav > ul > li > a > .sf-sub-indicator [class*=" icon-"],
		  #header-outer.transparent.dark-row > header#top nav > ul > li > a > .sf-sub-indicator [class*=" icon-"],
		 #header-outer.transparent.dark-slide:not(.directional-nav-effect) .cart-menu .cart-icon-wrap .icon-blueprint-cart,
		  #header-outer.transparent.dark-row:not(.directional-nav-effect) .cart-menu .cart-icon-wrap .icon-blueprint-cart,
		 body.ascend[data-header-color="custom"] #boxed #header-outer.transparent.dark-slide > header#top .cart-outer .cart-menu .cart-icon-wrap i,
		 body.ascend #boxed #header-outer.transparent.dark-slide > header#top .cart-outer .cart-menu .cart-icon-wrap i,
		 #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav > ul > li > a,
		 #header-outer.transparent.dark-slide:not(.directional-nav-effect) .midnightHeader.republicpg-slider header#top nav ul #search-btn a span,
		 #header-outer.transparent.dark-slide:not(.directional-nav-effect) .midnightHeader.republicpg-slider header#top nav ul #republicpg-user-account a span,
		 #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav > ul > li > a > .sf-sub-indicator [class^="icon-"],
		 #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav > ul > li > a > .sf-sub-indicator [class*=" icon-"],
		 #header-outer.transparent.dark-slide:not(.directional-nav-effect) .midnightHeader.republicpg-slider header#top .cart-menu .cart-icon-wrap .icon-blueprint-cart,
		 body.ascend[data-header-color="custom"] #boxed #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top .cart-outer .cart-menu .cart-icon-wrap i,
		 body.ascend #boxed #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top .cart-outer .cart-menu .cart-icon-wrap i,
		 .material #header-outer[data-permanent-transparent="1"].transparent.dark-slide .mobile-search .icon-blueprint-search,
		 .material #header-outer[data-permanent-transparent="1"].transparent.dark-slide .mobile-user-account .icon-blueprint-m-user,
		...
		#header-outer.transparent.dark-slide:not(.directional-nav-effect) .midnightHeader.republicpg-slider header#top nav ul .slide-out-widget-area-toggle a .lines-button i,
		#header-outer.transparent.dark-slide:not(.directional-nav-effect) .midnightHeader.republicpg-slider header#top nav ul .slide-out-widget-area-toggle a .lines-button i:after,
		#header-outer.transparent.dark-slide:not(.directional-nav-effect) .midnightHeader.republicpg-slider header#top nav ul .slide-out-widget-area-toggle a .lines-button i:before,
		...
		#header-outer.transparent.dark-slide:not(.directional-nav-effect) .midnightHeader.republicpg-slider header#top nav ul .slide-out-widget-area-toggle[data-icon-animation="simple-transform"] .lines-button:after,
		...
		#header-outer.transparent.dark-slide > header#top nav ul #republicpg-user-account a:hover span,
		...
		#header-outer.transparent.dark-slide  > header#top .cart-outer:hover .icon-blueprint-cart,
		body.ascend[data-header-color="custom"] #boxed #header-outer.transparent.dark-slide > header#top .cart-outer:hover .cart-menu .cart-icon-wrap i,
		#header-outer.transparent.dark-slide > header#top #logo,
		#header-outer[data-permanent-transparent="1"].transparent.dark-slide .midnightHeader.republicpg-slider header#top .span_9 > .slide-out-widget-area-toggle i,
		...
		#header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav > ul > li > a:hover, #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav .sf-menu > li.sfHover > a, #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav .sf-menu > li.current_page_ancestor > a,
		#header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav .sf-menu > li.current-menu-item > a, #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav .sf-menu > li.current-menu-ancestor > a, #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav .sf-menu > li.current_page_item > a,
		#header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav > ul > li > a:hover > .sf-sub-indicator > i, #header-outer.transparent.dark-slide header#top nav > ul > li.sfHover > a > span > i, #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav ul #search-btn a:hover span,
		#header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav ul #republicpg-user-account a:hover span,
		#header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav .sf-menu > li.current-menu-item > a i, #header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top nav .sf-menu > li.current-menu-ancestor > a i,
		#header-outer.transparent.dark-slide  .midnightHeader.republicpg-slider header#top .cart-outer:hover .icon-blueprint-cart,
		body.ascend[data-header-color="custom"] #boxed #header-outer.transparent.dark-slide > header#top .cart-outer:hover .cart-menu .cart-icon-wrap i,
		#header-outer.transparent.dark-slide .midnightHeader.republicpg-slider header#top #logo,
	...
	if(!empty($options['responsive']) && $options['responsive'] == 1 && !empty($options['ext_responsive']) && $options['ext_responsive'] == '1') {
		echo '@media only screen and (min-width: 1000px) {
			    ...
			    .container, body[data-header-format="left-header"] .container, .woocommerce-tabs .full-width-content .tab-container, .republicpg-recent-posts-slider .flickity-page-dots, .post-area.standard-minimal.full-width-content article.post .inner-wrap, .material #search-outer #search  {
			      max-width: 1425px;
				  width: 100%;
				  margin: 0 auto;
				  padding: 0px 90px;
			    ...
			    body[data-header-format="left-header"] .container, body[data-header-format="left-header"] .woocommerce-tabs .full-width-content .tab-container, body[data-header-format="left-header"] .republicpg-recent-posts-slider .flickity-page-dots,
			    body[data-header-format="left-header"] .post-area.standard-minimal.full-width-content article.post .inner-wrap {
			    	padding: 0 60px;
			    }

			    body .container .page-submenu.stuck .container:not(.tab-container):not(.normal-container), .republicpg-recent-posts-slider .flickity-page-dots,
			    #republicpg_fullscreen_rows[data-footer="default"] #footer-widgets .container, #republicpg_fullscreen_rows[data-footer="default"] #copyright .container {
				...
				body[data-header-format="left-header"] .container .page-submenu.stuck .container:not(.tab-container),  body[data-header-format="left-header"] .republicpg-recent-posts-slider .flickity-page-dots {
