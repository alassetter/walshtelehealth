...
$external_dynamic = (!empty($options['external-dynamic-css']) && $options['external-dynamic-css'] == 1) ? 'on' : 'off';
	...
	if(!empty($current_options)) {
		$font_fields = array('navigation_font_family','navigation_dropdown_font_family','portfolio_filters_font_family','portfolio_caption_font_family','page_heading_font_family','page_heading_subtitle_font_family','off_canvas_nav_font_family','off_canvas_nav_subtext_font_family','body_font_family','h1_font_family','h2_font_family','h3_font_family','h4_font_family','h5_font_family','h6_font_family','i_font_family','label_font_family','republicpg_slider_heading_font_family','home_slider_caption_font_family','testimonial_font_family','sidebar_footer_h_font_family','team_member_h_font_family','republicpg_dropcap_font_family','republicpg_sidebar_footer_headers_font_family','republicpg_woo_shop_product_title_font_family','republicpg_woo_shop_product_secondary_font_family');
	...
	$republicpg_h1_small_desktop = ( !empty($options['h1-small-desktop-font-size']) && $using_custom_responsive_sizing) ? intval($options['h1-small-desktop-font-size'])/100 : 0.75;
	$republicpg_h1_tablet = ( !empty($options['h1-tablet-font-size']) && $using_custom_responsive_sizing) ? intval($options['h1-tablet-font-size'])/100 : 0.7;
	$republicpg_h1_phone = ( !empty($options['h1-phone-font-size']) && $using_custom_responsive_sizing) ? intval($options['h1-phone-font-size'])/100 : 0.65;
	$republicpg_h1_default_size = 54;

	$republicpg_h2_small_desktop = ( !empty($options['h2-small-desktop-font-size']) && $using_custom_responsive_sizing) ? intval($options['h2-small-desktop-font-size'])/100 : 0.85;
	$republicpg_h2_tablet = ( !empty($options['h2-tablet-font-size']) && $using_custom_responsive_sizing) ? intval($options['h2-tablet-font-size'])/100 : 0.8;
	$republicpg_h2_phone = ( !empty($options['h2-phone-font-size']) && $using_custom_responsive_sizing) ? intval($options['h2-phone-font-size'])/100 : 0.75;
	$republicpg_h2_default_size = 34;

	$republicpg_h3_small_desktop = ( !empty($options['h3-small-desktop-font-size']) && $using_custom_responsive_sizing) ? intval($options['h3-small-desktop-font-size'])/100 : 0.85;
	$republicpg_h3_tablet = ( !empty($options['h3-tablet-font-size']) && $using_custom_responsive_sizing) ? intval($options['h3-tablet-font-size'])/100 : 0.8;
	$republicpg_h3_phone = ( !empty($options['h3-phone-font-size']) && $using_custom_responsive_sizing) ? intval($options['h3-phone-font-size'])/100 : 0.8;
	$republicpg_h3_default_size = 22;

	$republicpg_h4_small_desktop = ( !empty($options['h4-small-desktop-font-size']) && $using_custom_responsive_sizing) ? intval($options['h4-small-desktop-font-size'])/100 : 1;
	$republicpg_h4_tablet = ( !empty($options['h4-tablet-font-size']) && $using_custom_responsive_sizing) ? intval($options['h4-tablet-font-size'])/100 : 1;
	$republicpg_h4_phone = ( !empty($options['h4-phone-font-size']) && $using_custom_responsive_sizing) ? intval($options['h4-phone-font-size'])/100 : 0.9;
	$republicpg_h4_default_size = 18;

	$republicpg_h5_small_desktop = ( !empty($options['h5-small-desktop-font-size']) && $using_custom_responsive_sizing) ? intval($options['h5-small-desktop-font-size'])/100 : 1;
	$republicpg_h5_tablet = ( !empty($options['h5-tablet-font-size']) && $using_custom_responsive_sizing) ? intval($options['h5-tablet-font-size'])/100 : 1;
	$republicpg_h5_phone = ( !empty($options['h5-phone-font-size']) && $using_custom_responsive_sizing) ? intval($options['h5-phone-font-size'])/100 : 1;
	$republicpg_h5_default_size = 16;

	$republicpg_h6_small_desktop = ( !empty($options['h6-small-desktop-font-size']) && $using_custom_responsive_sizing) ? intval($options['h6-small-desktop-font-size'])/100 : 1;
	$republicpg_h6_tablet = ( !empty($options['h6-tablet-font-size']) && $using_custom_responsive_sizing) ? intval($options['h6-tablet-font-size'])/100 : 1;
	$republicpg_h6_phone = ( !empty($options['h6-phone-font-size']) && $using_custom_responsive_sizing) ? intval($options['h6-phone-font-size'])/100 : 1;
	$republicpg_h6_default_size = 14;

	$republicpg_body_small_desktop = ( !empty($options['body-small-desktop-font-size']) && $using_custom_responsive_sizing) ? intval($options['body-small-desktop-font-size'])/100 : 1;
	$republicpg_body_tablet = ( !empty($options['body-tablet-font-size']) && $using_custom_responsive_sizing) ? intval($options['body-tablet-font-size'])/100 : 1;
	$republicpg_body_phone = ( !empty($options['body-phone-font-size']) && $using_custom_responsive_sizing) ? intval($options['body-phone-font-size'])/100 : 1;
	$republicpg_body_default_size = 14;
	...
	if($options['body_font_family']['attrs_in_use']) {
		...
		echo 'body, body .ui-widget, table, .bar_graph li span strong, #slide-out-widget-area .tagcloud a, body .container .woocommerce-message a.button, #search-results .result .title span, .woocommerce ul.products li.product h3, .woocommerce-page ul.products li.product h3, .row .col.section-title .republicpg-love span, body .republicpg-love span, body .republicpg-social .republicpg-love .republicpg-love-count, body .carousel-heading h2, .sharing-default-minimal .republicpg-social .social-text, body .sharing-default-minimal .republicpg-love, .widget ul.republicpg_widget[class*="republicpg_blog_posts_"] > li .post-date
		{'; ?>
		...
		<?php echo '}';
	     ...
	     if($options['body_font'] != '-') {
		   echo '.bold, strong, b { font-family: ' . $font_family .'; font-weight: 400; } ';
		   echo '.single #single-below-header span { font-family: ' . $font_family .';  }';
		 }

		 echo '.republicpg-fancy-ul ul li .icon-default-style[class^="icon-"] {';
			if(!empty($the_line_height)) echo 'line-height:' . $the_line_height .'!important;';
		 echo '}';



			 $defined_font_size = (!empty($options['body_font_size']) && $options['body_font_size'] != '-') ? intval($options['body_font_size']) : $republicpg_body_default_size;
			 $defined_line_height = (!empty($the_line_height)) ? intval($the_line_height) : intval($republicpg_body_default_size) * 1.8;
		 ?>

		 @media only screen and (max-width: 1300px) and (min-width: 1000px) {
			 body {
				 font-size: <?php echo esc_html( ceil($defined_font_size*$republicpg_body_small_desktop) ) . 'px'; ?>;
				 line-height: <?php echo esc_html( ceil($defined_line_height*$republicpg_body_small_desktop) ) . 'px'; ?>;
			 }
		 }
		 @media only screen and (max-width: 1000px) and (min-width: 690px) {
			 body {
				 font-size: <?php echo esc_html( ceil($defined_font_size*$republicpg_body_tablet) ) . 'px'; ?>;
				 line-height: <?php echo esc_html( ceil($defined_line_height*$republicpg_body_tablet) ) . 'px'; ?>;
			 }

		 }
		 @media only screen and (max-width: 690px) {
			 body {
				 font-size: <?php echo esc_html( ceil($defined_font_size*$republicpg_body_phone) ) . 'px'; ?>;
				 line-height: <?php echo esc_html( ceil($defined_line_height*$republicpg_body_phone) ) . 'px'; ?>;
			 }
 ...
 <?php } //attrs in use ?>
	...
	if($options['navigation_font_family']['attrs_in_use']) {
		...
		echo 'header#top nav > ul > li > a, .span_3 .pull-left-wrap > ul > li > a, body.material #search-outer #search input[type="text"], #header-secondary-outer .republicpg-center-text, #slide-out-widget-area .secondary-header-text
		{'; ?>
	...
	if($options['h1_font_family']['attrs_in_use']) {
			...
			echo '#page-header-bg h1, body h1, body .row .col.section-title h1, .full-width-content .republicpg-recent-posts-slider .recent-post-container .inner-wrap h2, body #error-404 h1
			{'; ?>
			...
			<?php
				$defined_font_size = (!empty($options['h1_font_size']) && $options['h1_font_size'] != '-') ? intval($options['h1_font_size']) : $republicpg_h1_default_size;
				$defined_line_height = (!empty($the_line_height)) ? intval($the_line_height) : $republicpg_h1_default_size + 6;
			?>

			@media only screen and (max-width: 1300px) and (min-width: 1000px) {
				body .row .col.section-title h1, body h1, .full-width-content .recent-post-container .inner-wrap h2 {
					font-size: <?php echo esc_html( $defined_font_size*$republicpg_h1_small_desktop ) . 'px'; ?>;
					line-height: <?php echo esc_html( $defined_line_height*$republicpg_h1_small_desktop ) . 'px'; ?>;
				}
			}
			@media only screen and (max-width: 1000px) and (min-width: 690px) {
				body .row .col.section-title h1, body h1, html body .row .col.section-title.span_12 h1, .full-width-content .republicpg-recent-posts-slider .recent-post-container .inner-wrap h2 {
					font-size: <?php echo esc_html( $defined_font_size*$republicpg_h1_tablet ) . 'px'; ?>;
					line-height: <?php echo esc_html( $defined_line_height*$republicpg_h1_tablet ) . 'px'; ?>;
				}
				...
				.wpb_wrapper h1.vc_custom_heading {
					font-size: <?php echo esc_html( $defined_font_size*$republicpg_h1_tablet ) . 'px!important'; ?>;
					line-height: <?php echo esc_html( $defined_line_height*$republicpg_h1_tablet ) . 'px!important'; ?>;
				}

			}
			@media only screen and (max-width: 690px) {
				body .row .col.section-title h1, body h1, html body .row .col.section-title.span_12 h1, .full-width-content .republicpg-recent-posts-slider .recent-post-container .inner-wrap h2 {
					font-size: <?php echo esc_html( $defined_font_size*$republicpg_h1_phone ) . 'px'; ?>;
					line-height: <?php echo esc_html( $defined_line_height*$republicpg_h1_phone ) . 'px'; ?>;
				}

				.wpb_wrapper h1.vc_custom_heading {
					font-size: <?php echo esc_html( $defined_font_size*$republicpg_h1_phone ) . 'px!important'; ?>;
					line-height: <?php echo esc_html( $defined_line_height*$republicpg_h1_phone ) . 'px!important'; ?>;
				}
...
<?php 	} // attrs in use ?>
	...
	if($options['h2_font_family']['attrs_in_use']) {
		...
		#call-to-action span, .woocommerce .full-width-tabs #reviews h3, .row .col.section-title h2, .republicpg_single_testimonial[data-style="bold"] p, .woocommerce-account .woocommerce > #customer_login .republicpg-form-controls .control,
		...
		<?php
			$defined_font_size = (!empty($options['h2_font_size']) && $options['h2_font_size'] != '-') ? intval($options['h2_font_size']) : $republicpg_h2_default_size;
			$defined_line_height = (!empty($the_line_height)) ? intval($the_line_height) : $republicpg_h2_default_size + 8;
		?>
		...
		@media only screen and (max-width: 1300px) and (min-width: 1000px) {
		 	body h2, .single-product div.product h1.product_title {
		 		font-size: <?php echo esc_html( $defined_font_size*$republicpg_h2_small_desktop ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h2_small_desktop ) . 'px'; ?>;
			}
		...
		@media only screen and (max-width: 1000px) and (min-width: 690px) {
		.col h2, h2, .single-product div.product h1.product_title, .woocommerce-account .woocommerce > #customer_login .republicpg-form-controls .control {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h2_tablet ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h2_tablet ) . 'px'; ?>;
			}
			.wpb_wrapper h2.vc_custom_heading {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h2_tablet ) . 'px!important'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h2_tablet ) . 'px!important'; ?>;
			}
		...
		@media only screen and (max-width: 690px) {
		.col h2, h2, .single-product div.product h1.product_title, .woocommerce-account .woocommerce > #customer_login .republicpg-form-controls .control {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h2_phone ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h2_phone ) . 'px'; ?>;
			}
			.wpb_wrapper h2.vc_custom_heading {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h2_phone ) . 'px!important'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h2_phone ) . 'px!important'; ?>;
			}
		}
	...
	echo 'body h3, .row .col h3, .ascend #respond h3, .ascend h3#comments, .woocommerce ul.products li.product.text_on_hover h3,
	.masonry.classic_enhanced .masonry-blog-item h3.title, .woocommerce ul.products li.product.material h3, .woocommerce-page ul.products li.product.material h3, .portfolio-items[data-ps="8"] .col h3,
	.republicpg-hor-list-item[data-font-family="h3"], .woocommerce ul.products li.product h2, .republicpg-quick-view-box h1
	{'; ?>
	...
	<?php
		$defined_font_size = (!empty($options['h3_font_size']) && $options['h3_font_size'] != '-') ? intval($options['h3_font_size']) : $republicpg_h3_default_size;
		$defined_line_height = (!empty($the_line_height)) ? intval($the_line_height) : $republicpg_h3_default_size + 10;
	?>

	@media only screen and (max-width: 1300px) and (min-width: 1000px) {
		.row .span_2 h3, .row .span_3 h3, .row .span_4 h3, .row .vc_col-sm-2 h3, .row .vc_col-sm-3 h3, .row .vc_col-sm-4 h3, .row .col h3, body h3 {
			font-size: <?php echo esc_html( $defined_font_size*$republicpg_h3_small_desktop ) . 'px'; ?>;
			line-height: <?php echo esc_html( $defined_line_height*$republicpg_h3_small_desktop ) . 'px'; ?>;
		}
	}

	@media only screen and (max-width: 1000px) and (min-width: 690px) {
		.row .span_2 h3, .row .span_3 h3, .row .span_4 h3, .row .vc_col-sm-2 h3, .row .vc_col-sm-3 h3, .row .vc_col-sm-4 h3, .row .col h3, body h3 {
			font-size: <?php echo esc_html( $defined_font_size*$republicpg_h3_tablet ) . 'px'; ?>;
			line-height: <?php echo esc_html( $defined_line_height*$republicpg_h3_tablet ) . 'px'; ?>;
		}
		.wpb_wrapper h3.vc_custom_heading {
			font-size: <?php echo esc_html( $defined_font_size*$republicpg_h3_tablet ) . 'px!important'; ?>;
			line-height: <?php echo esc_html( $defined_line_height*$republicpg_h3_tablet ) . 'px!important'; ?>;
		}
	}

	@media only screen and (max-width: 690px) {
		.row .span_2 h3, .row .span_3 h3, .row .span_4 h3, .row .vc_col-sm-2 h3, .row .vc_col-sm-3 h3, .row .vc_col-sm-4 h3, .row .col h3, body h3 {
			font-size: <?php echo esc_html( $defined_font_size*$republicpg_h3_phone ) . 'px'; ?>;
			line-height: <?php echo esc_html( $defined_line_height*$republicpg_h3_phone ) . 'px'; ?>;
		}
		.wpb_wrapper h3.vc_custom_heading {
			font-size: <?php echo esc_html( $defined_font_size*$republicpg_h3_phone ) . 'px!important'; ?>;
			line-height: <?php echo esc_html( $defined_line_height*$republicpg_h3_phone ) . 'px!important'; ?>;
		}
	}
...
<?php } // attrs in use ?>
	...
	<?php
		...
		echo 'body h4, .row .col h4, .portfolio-items .work-meta h4, .list-icon-holder[data-icon_type="numerical"] span, .portfolio-items .col.span_3 .work-meta h4, #respond h3, h3#comments, .portfolio-items[data-ps="6"] .work-meta h4,
		.republicpg-hor-list-item[data-font-family="h4"], .woocommerce #reviews #reply-title, p.woocommerce.add_to_cart_inline > span.woocommerce-Price-amount, p.woocommerce.add_to_cart_inline ins > span.woocommerce-Price-amount,
		...
		@media only screen and (min-width: 690px) {
			...
			.republicpg-slide-in-cart .widget_shopping_cart .cart_list .mini_cart_item > a:not(.remove) {
		...
		<?php
			$defined_font_size = (!empty($options['h4_font_size']) && $options['h4_font_size'] != '-') ? intval($options['h4_font_size']) : $republicpg_h4_default_size;
			$defined_line_height = (!empty($the_line_height)) ? intval($the_line_height) : $republicpg_h4_default_size + 10;
		?>

		@media only screen and (max-width: 1300px) and (min-width: 1000px) {
			.row .col h4, body h4 {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h4_small_desktop ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h4_small_desktop ) . 'px'; ?>;
			}
		}

		@media only screen and (max-width: 1000px) and (min-width: 690px) {
			.row .col h4, body h4 {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h4_tablet ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h4_tablet ) . 'px'; ?>;
			}
		}

		@media only screen and (max-width: 690px) {
			.row .col h4, body h4 {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h4_phone ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h4_phone ) . 'px'; ?>;
			}
		}
	...
	if($options['h5_font_family']['attrs_in_use']) {
		...
		echo 'body h5, .row .col h5, .portfolio-items .work-item.style-3-alt p, .republicpg-hor-list-item[data-font-family="h5"]
		{'; ?>
		...
		<?php
			$defined_font_size = (!empty($options['h5_font_size']) && $options['h5_font_size'] != '-') ? intval($options['h5_font_size']) : $republicpg_h5_default_size;
			$defined_line_height = (!empty($the_line_height)) ? intval($the_line_height) : $republicpg_h5_default_size + 10;
		?>

		@media only screen and (max-width: 1300px) and (min-width: 1000px) {
			.row .col h5, body h5 {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h5_small_desktop ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h5_small_desktop ) . 'px'; ?>;
			}
		}

		@media only screen and (max-width: 1000px) and (min-width: 690px) {
			.row .col h5, body h5 {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h5_tablet ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h5_tablet ) . 'px'; ?>;
			}
		}

		@media only screen and (max-width: 690px) {
			.row .col h5, body h5 {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h5_phone ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h5_phone ) . 'px'; ?>;
			}
		}
	...
	if($options['h6_font_family']['attrs_in_use']) {
		...
		echo 'body h6, .row .col h6, .republicpg-hor-list-item[data-font-family="h6"]
		{'; ?>
		...
		<?php
			$defined_font_size = (!empty($options['h6_font_size']) && $options['h6_font_size'] != '-') ? intval($options['h6_font_size']) : $republicpg_h6_default_size;
			$defined_line_height = (!empty($the_line_height)) ? intval($the_line_height) : $republicpg_h6_default_size + 10;
		?>

		@media only screen and (max-width: 1300px) and (min-width: 1000px) {
			.row .col h6, body h6 {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h6_small_desktop ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h6_small_desktop ) . 'px'; ?>;
			}
		}

		@media only screen and (max-width: 1000px) and (min-width: 690px) {
			.row .col h6, body h6 {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h6_tablet ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h6_tablet ) . 'px'; ?>;
			}
		}

		@media only screen and (max-width: 690px) {
			.row .col h6, body h6 {
				font-size: <?php echo esc_html( $defined_font_size*$republicpg_h6_phone ) . 'px'; ?>;
				line-height: <?php echo esc_html( $defined_line_height*$republicpg_h6_phone ) . 'px'; ?>;
			}
		}
	...
	if($options['label_font_family']['attrs_in_use']) {
		...
		.republicpg-progress-bar p, .republicpg-progress-bar span strong i, .republicpg-progress-bar span strong, .testimonial_slider:not([data-style="minimal"]) blockquote span,  .woocommerce-ordering .select2-container--default .select2-selection--single .select2-selection__rendered, .woocommerce-ordering .select2-container .select2-choice>.select2-chosen,
		.tabbed[data-style="minimal_alt"] > ul li a, .material .widget .republicpg_widget[class*="republicpg_blog_posts_"] > li .post-title, body.material .tagcloud a, .material .widget li a, .republicpg-recent-posts-slider_multiple_visible .recent-post-container.container .strong a,  .material .recentcomments .comment-author-link,
		.single .post-area .content-inner > .post-tags a,  .masonry.material .masonry-blog-item .grav-wrap a, .republicpg-recent-posts-single_featured .grav-wrap a, .masonry.material .masonry-blog-item .meta-category a, .post-area.featured_img_left article .meta-category a, .post-area.featured_img_left article .grav-wrap .text a, .related-posts[data-style="material"] .meta-category a,
		.masonry.auto_meta_overlaid_spaced article.post.quote .author, .masonry.material article.post.quote .author, body.search-results #search-results[data-layout="list-no-sidebar"] .result .inner-wrap h2 span,
		 .post-area.featured_img_left article.post.quote .author, .related-posts[data-style="material"] .grav-wrap .text a, .auto_meta_overlaid_spaced .masonry-blog-item .meta-category a, [data-style="list_featured_first_row"] .meta-category a, .republicpg-recent-posts-single_featured .strong a, .republicpg-recent-posts-single_featured.multiple_featured .controls li .title,
		body .woocommerce .republicpg-woo-flickity[data-controls="arrows-and-text"] .woo-flickity-count, body.woocommerce ul.products li.minimal.product span.onsale, .republicpg-woo-flickity ul.products li.minimal.product span.onsale, .republicpg-quick-view-box span.onsale,  .republicpg-quick-view-box .republicpg-full-product-link a, body .republicpg-quick-view-box .single_add_to_cart_button, .republicpg-quick-view-box .single_add_to_cart_button, .woocommerce .cart .quantity input.qty, .woocommerce .cart .quantity input.plus, .woocommerce .cart .quantity input.minus, .pum-theme-blueprint-page-builder-optimized .pum-container .pum-content+.pum-close,
		.republicpg-quick-view-box .cart .quantity input.qty, .republicpg-quick-view-box .cart .quantity input.plus, .republicpg-quick-view-box .cart .quantity input.minus, .woocommerce-account .woocommerce-form-login .lost_password, .woocommerce div.product .woocommerce-tabs .full-width-content[data-tab-style="fullwidth"] ul.tabs li a, .woocommerce div.product_meta,
		body.material .republicpg_single_testimonial[data-style="basic"] span.wrap, body.material .republicpg_single_testimonial[data-style="basic_left_image"] span.wrap, .woocommerce table.cart td.product-name, .woocommerce table.shop_table th, #header-outer .widget_shopping_cart .cart_list a, .woocommerce .yith-wcan-reset-navigation.button, .single-product .entry-summary p.stock.out-of-stock
		{'; ?>
   ...
   <?php } // attrs in use ?>
	...
	/*	Dropcap Font
	/*-------------------------------------------------------------------------*/
	$styles = explode('-', $options['republicpg_dropcap_font_style']);

	( intval( substr($options['republicpg_dropcap_font_size'],0,-2) ) > 8 ) ? $line_height =  intval(substr($options['republicpg_dropcap_font_size'],0,-2)) +10 .'px' : $line_height = null ;  ?>

	<?php

	if($options['republicpg_dropcap_font_family']['attrs_in_use']) {

		echo '.republicpg-dropcap
		{'; ?>
			<?php if($options['republicpg_dropcap_font'] != '-') {
				  $font_family = (1 === preg_match('~[0-9]~', $options['republicpg_dropcap_font'])) ? '"'. $options['republicpg_dropcap_font'] .'"' : $options['republicpg_dropcap_font'];
			}
				  if($options['republicpg_dropcap_font'] != '-') echo 'font-family: ' . $font_family .';';
				  if($options['republicpg_dropcap_font_transform'] != '-') echo 'text-transform: ' . $options['republicpg_dropcap_font_transform'] .';';
				  if($options['republicpg_dropcap_font_spacing'] != '-') echo 'letter-spacing: ' . $options['republicpg_dropcap_font_spacing'] .';';
			      if($options['republicpg_dropcap_font_size'] != '-') echo 'font-size:' . $options['republicpg_dropcap_font_size'] .'!important;'; ?>

			<?php
			//user set line-height
			 if($options['republicpg_dropcap_font_line_height'] != '-') {
			 	echo 'line-height:' . $options['republicpg_dropcap_font_line_height'] .';';
			 	$the_line_height = $options['republicpg_dropcap_font_line_height'];
			 } else if(!empty($line_height)) {
			//auto line-height
				echo 'line-height:' . $line_height .';';
				$the_line_height = $line_height;
  ...
  <?php } // attrs in use ?>
	...
	/*-------------------------------------------------------------------------*/
	$styles = explode('-', $options['republicpg_sidebar_footer_headers_font_style']);

	( intval( substr($options['republicpg_sidebar_footer_headers_font_size'],0,-2) ) > 8 ) ? $line_height =  intval(substr($options['republicpg_sidebar_footer_headers_font_size'],0,-2)) +10 .'px' : $line_height = null ;  ?>

	<?php

	if($options['republicpg_sidebar_footer_headers_font_family']['attrs_in_use']) {

		echo 'body #sidebar h4, body .widget h4, body #footer-outer .widget h4
		{'; ?>
			<?php if($options['republicpg_sidebar_footer_headers_font'] != '-') {
				  $font_family = (1 === preg_match('~[0-9]~', $options['republicpg_sidebar_footer_headers_font'])) ? '"'. $options['republicpg_sidebar_footer_headers_font'] .'"' : $options['republicpg_sidebar_footer_headers_font'];
			}
				  if($options['republicpg_sidebar_footer_headers_font'] != '-') echo 'font-family: ' . $font_family .';';
				  if($options['republicpg_sidebar_footer_headers_font_transform'] != '-') echo 'text-transform: ' . $options['republicpg_sidebar_footer_headers_font_transform'] .'!important;';
				  if($options['republicpg_sidebar_footer_headers_font_spacing'] != '-') echo 'letter-spacing: ' . $options['republicpg_sidebar_footer_headers_font_spacing'] .';';
			      if($options['republicpg_sidebar_footer_headers_font_size'] != '-') echo 'font-size:' . $options['republicpg_sidebar_footer_headers_font_size'] .'!important;'; ?>

			<?php
			//user set line-height
			 if($options['republicpg_sidebar_footer_headers_font_line_height'] != '-') {
			 	echo 'line-height:' . $options['republicpg_sidebar_footer_headers_font_line_height'] .';';
			 	$the_line_height = $options['republicpg_sidebar_footer_headers_font_line_height'];
			 } else if(!empty($line_height)) {
			//auto line-height
				echo 'line-height:' . $line_height .';';
				$the_line_height = $line_height;
	...
	if($options['page_heading_font_family']['attrs_in_use']) {
			...
			echo 'body #page-header-bg h1, html body .row .col.section-title h1, .republicpg-box-roll .overlaid-content h1
			{'; ?>
			...
			@media only screen and (min-width: 1000px) and (max-width: 1300px) {
				#page-header-bg .span_6 h1, .republicpg-box-roll .overlaid-content h1 {
	...
	if($options['page_heading_subtitle_font_family']['attrs_in_use']) {
			...
			echo 'body #page-header-bg .span_6 span.subheader, #page-header-bg span.result-num,  body .row .col.section-title > span, .republicpg-box-roll .overlaid-content .subheader
			{'; ?>
  ...
  <?php } // attrs in use ?>
	...
	if($options['off_canvas_nav_font_family']['attrs_in_use']) {
			...
			body #slide-out-widget-area.fullscreen-alt .inner .off-canvas-menu-container li a, body #slide-out-widget-area.slide-out-from-right-hover .inner .off-canvas-menu-container li a, body #republicpg-ocm-ht-line-check
			{'; ?>
  ...
  <?php } // attrs in use ?>
	...
	<?php
	/*-------------------------------------------------------------------------*/
	/*	Republicpg Slider Heading Font
	/*-------------------------------------------------------------------------*/
	$styles = explode('-', $options['republicpg_slider_heading_font_style']);
	( intval( substr($options['republicpg_slider_heading_font_size'],0,-2) ) > 8 ) ? $line_height =  intval(substr($options['republicpg_slider_heading_font_size'],0,-2)) + 19 .'px!important' : $line_height = null ;  ?>

	<?php

	if($options['republicpg_slider_heading_font_family']['attrs_in_use']) {

			echo '.swiper-slide .content h2
			{'; ?>
				<?php if($options['republicpg_slider_heading_font'] != '-') {
					  $font_family = (1 === preg_match('~[0-9]~', $options['republicpg_slider_heading_font'])) ? '"'. $options['republicpg_slider_heading_font'] .'"' : $options['republicpg_slider_heading_font'];
			     }
					  if($options['republicpg_slider_heading_font'] != '-') echo 'font-family: ' . $font_family .';';
					  if($options['republicpg_slider_heading_font_transform'] != '-') echo 'text-transform: ' . $options['republicpg_slider_heading_font_transform'] .';';
					  if($options['republicpg_slider_heading_font_spacing'] != '-') echo 'letter-spacing: ' . $options['republicpg_slider_heading_font_spacing'] .';';
					  if($options['republicpg_slider_heading_font_size'] != '-') echo 'font-size:' . $options['republicpg_slider_heading_font_size'] .';'; ?>

				<?php
				//user set line-height
				 if($options['republicpg_slider_heading_font_line_height'] != '-') {
				 	echo 'line-height:' . $options['republicpg_slider_heading_font_line_height'] .';';
				 	$the_line_height = $options['republicpg_slider_heading_font_line_height'];
				 } else if(!empty($line_height)) {
				//auto line-height
					echo 'line-height:' . $line_height .';';
					$the_line_height = $line_height;
			...
			@media only screen and (min-width: 1000px) and (max-width: 1300px) {
				body .republicpg-slider-wrap[data-full-width="true"] .swiper-slide .content h2,
				body .republicpg-slider-wrap[data-full-width="boxed-full-width"] .swiper-slide .content h2,
				body .full-width-content .vc_span12 .swiper-slide .content h2 {
					font-size: <?php if(!empty($options['republicpg_slider_heading_font_size']) && $options['republicpg_slider_heading_font_size'] != '-') echo intval($options['republicpg_slider_heading_font_size'])*0.8 . 'px!important' ?>;
			...
			@media only screen and (min-width: 690px) and (max-width: 1000px) {
				...
				body .republicpg-slider-wrap[data-full-width="boxed-full-width"] .swiper-slide .content h2,
				body .full-width-content .vc_span12 .swiper-slide .content h2 {
					font-size: <?php if(!empty($options['republicpg_slider_heading_font_size']) && $options['republicpg_slider_heading_font_size'] != '-') echo intval($options['republicpg_slider_heading_font_size'])*0.6 . 'px!important' ?>;
			...
			@media only screen and (max-width: 690px) {
				...
				body .republicpg-slider-wrap[data-full-width="boxed-full-width"] .swiper-slide .content h2,
				body .full-width-content .vc_span12 .swiper-slide .content h2 {
					font-size: <?php if(!empty($options['republicpg_slider_heading_font_size']) && $options['republicpg_slider_heading_font_size'] != '-') echo intval($options['republicpg_slider_heading_font_size'])*0.5 . 'px!important' ?>;
	...
	<?php
	/*-------------------------------------------------------------------------*/
	/*	Republicpg/Home Slider Caption
	/*-------------------------------------------------------------------------*/
	...
	if($options['home_slider_caption_font_family']['attrs_in_use']) {
			...
			<?php
				  ...
				  echo '.swiper-slide .content p.transparent-bg span { '; $republicpg_slider_line_height_2 = intval(substr($options["home_slider_caption_font_size"],0,-2)) + 25; ?>
			     <?php if(!empty($line_height)) echo 'line-height:' . $republicpg_slider_line_height_2 .'px;'; ?>
			<?php echo '}'; ?>

			@media only screen and (min-width: 1000px) and (max-width: 1300px) {
				.republicpg-slider-wrap[data-full-width="true"] .swiper-slide .content p,
				.republicpg-slider-wrap[data-full-width="boxed-full-width"] .swiper-slide .content p,
			...
			@media only screen and (max-width: 690px) {
				body .republicpg-slider-wrap[data-full-width="true"] .swiper-slide .content p,
				body .republicpg-slider-wrap[data-full-width="boxed-full-width"] .swiper-slide .content p,
	...
	/*	Woo Product Title
	/*-------------------------------------------------------------------------*/
	$styles = explode('-', $options['republicpg_woo_shop_product_title_font_style']);
	( intval( substr($options['republicpg_woo_shop_product_title_font_size'],0,-2) ) > 8 ) ? $line_height =  intval(substr($options['republicpg_woo_shop_product_title_font_size'],0,-2)) + 10 .'px!important' : $line_height = null ;  ?>

	<?php

	if($options['republicpg_woo_shop_product_title_font_family']['attrs_in_use']) {
			...
			{'; ?>
				<?php if($options['republicpg_woo_shop_product_title_font'] != '-') {
						$font_family = (1 === preg_match('~[0-9]~', $options['republicpg_woo_shop_product_title_font'])) ? '"'. $options['republicpg_woo_shop_product_title_font'] .'"' : $options['republicpg_woo_shop_product_title_font'];
				}
						if($options['republicpg_woo_shop_product_title_font'] != '-') echo 'font-family: ' . $font_family .';';
						if($options['republicpg_woo_shop_product_title_font_transform'] != '-') echo 'text-transform: ' . $options['republicpg_woo_shop_product_title_font_transform'] .';';
						if($options['republicpg_woo_shop_product_title_font_spacing'] != '-') echo 'letter-spacing: ' . $options['republicpg_woo_shop_product_title_font_spacing'] .';';
						if($options['republicpg_woo_shop_product_title_font_size'] != '-') echo 'font-size:' . $options['republicpg_woo_shop_product_title_font_size'] .'!important;'; ?>

				<?php
				//user set line-height
				 if($options['republicpg_woo_shop_product_title_font_line_height'] != '-') {
					echo 'line-height:' . $options['republicpg_woo_shop_product_title_font_line_height'] .'!important;';
					$the_line_height = $options['republicpg_woo_shop_product_title_font_line_height'];
				 } else if(!empty($line_height)) {
				//auto line-height
					echo 'line-height:' . $line_height .';';
					$the_line_height = $line_height;
	...
	/*-------------------------------------------------------------------------*/
	$styles = explode('-', $options['republicpg_woo_shop_product_secondary_font_style']);
	( intval( substr($options['republicpg_woo_shop_product_secondary_font_size'],0,-2) ) > 8 ) ? $line_height =  intval(substr($options['republicpg_woo_shop_product_secondary_font_size'],0,-2)) + 10 .'px!important' : $line_height = null ;  ?>

	<?php

	if($options['republicpg_woo_shop_product_secondary_font_family']['attrs_in_use']) {
			...
			{'; ?>
				<?php if($options['republicpg_woo_shop_product_secondary_font'] != '-') {
						$font_family = (1 === preg_match('~[0-9]~', $options['republicpg_woo_shop_product_secondary_font'])) ? '"'. $options['republicpg_woo_shop_product_secondary_font'] .'"' : $options['republicpg_woo_shop_product_secondary_font'];
				}
						if($options['republicpg_woo_shop_product_secondary_font'] != '-') echo 'font-family: ' . $font_family .';';
						if($options['republicpg_woo_shop_product_secondary_font_transform'] != '-') echo 'text-transform: ' . $options['republicpg_woo_shop_product_secondary_font_transform'] .'!important;';
						if($options['republicpg_woo_shop_product_secondary_font_spacing'] != '-') echo 'letter-spacing: ' . $options['republicpg_woo_shop_product_secondary_font_spacing'] .';';
						if($options['republicpg_woo_shop_product_secondary_font_size'] != '-') echo 'font-size:' . $options['republicpg_woo_shop_product_secondary_font_size'] .'!important;'; ?>

				<?php
				//user set line-height
				 if($options['republicpg_woo_shop_product_secondary_font_line_height'] != '-') {
					echo 'line-height:' . $options['republicpg_woo_shop_product_secondary_font_line_height'] .';';
					$the_line_height = $options['republicpg_woo_shop_product_secondary_font_line_height'];
				 } else if(!empty($line_height)) {
				//auto line-height
					echo 'line-height:' . $line_height .';';
					$the_line_height = $line_height;
	...
	<?php
	/*-------------------------------------------------------------------------*/
	/*	Sidear, Carousel & Republicpg Button Header Font
	/*-------------------------------------------------------------------------*/
	...
	if($options['sidebar_footer_h_font_family']['attrs_in_use']) {
			...
			.republicpg-button,
			.republicpg-button.medium,
			.republicpg-button.small,
			.republicpg-3d-transparent-button,
			body .widget_calendar table th,
			body #footer-outer #footer-widgets .col .widget_calendar table th, .swiper-slide .button a,
			...
			.meta_overlaid article.post.format-status .post-content h2, .meta_overlaid article .meta-author a,
			.pricing-column.highlight h3 .highlight-reason,
			.blog-recent[data-style="minimal"] .col > span,
			body .masonry.classic_enhanced .posts-container article .meta-category a,  body .masonry.classic_enhanced .posts-container article.wide_tall .meta-category a, .blog-recent[data-style*="classic_enhanced"] .meta-category a, .republicpg-recent-posts-slider .container .strong,  body.material #page-header-bg.fullscreen-header .inner-wrap >a, #page-header-bg[data-post-hs="default_minimal"] .inner-wrap > a, .single .heading-title[data-header-style="default_minimal"] .meta-category a, .republicpg-fancy-box .link-text, .woocommerce-account .woocommerce-form-login button.button, .woocommerce-account .woocommerce-form-register  button.button,
			 .post-area.standard-minimal article.post .post-meta .date a, .post-area.standard-minimal article.post .more-link span, .republicpg-slide-in-cart .widget_shopping_cart .buttons a, .material.product .product-wrap .product-add-to-cart a .price .amount,  .material.product .product-wrap .product-add-to-cart a span, ul.products li.material.product  span.onsale,
			...
			.woocommerce-page ul.products li.product.material .price, .woocommerce-page ul.products li.product.material .price ins span, body[data-form-submit="see-through-2"] input[type=submit], body[data-form-submit="see-through-2"] button[type=submit], body[data-form-submit="see-through"] input[type=submit], body[data-form-submit="see-through"] button[type=submit],
			 body[data-form-submit="regular"] input[type=submit] body[data-form-submit="regular"] button[type=submit], .republicpg_team_member_overlay .team_member_details .title, body:not([data-header-format="left-header"]) header#top nav > ul > li.megamenu > ul > li > ul > li.has-ul > a, .republicpg_fullscreen_zoom_recent_projects .project-slide .project-info .normal-container > a,
			 .republicpg-hor-list-item .republicpg-list-item-btn, .republicpg-category-grid-item .content span.subtext, body .woocommerce .republicpg-woo-flickity[data-controls="arrows-and-text"] .republicpg-woo-carousel-top, .products li.product.minimal .product-add-to-cart a, .woocommerce div.product form.cart .button, .republicpg-quick-view-box .republicpg-full-product-link, .woocommerce-page .republicpg-quick-view-box  button[type="submit"].single_add_to_cart_button, #header-outer .widget_shopping_cart a.button,
			 .woocommerce .classic .product-wrap .product-add-to-cart .add_to_cart_button, .text_on_hover.product .republicpg_quick_view, .woocommerce .classic .product-wrap .product-add-to-cart .button.product_type_variable, .woocommerce.add_to_cart_inline a.button.add_to_cart_button, .woocommerce .classic .product-wrap .product-add-to-cart .button.product_type_grouped, .woocommerce-page .woocommerce p.return-to-shop a.wc-backward, .yikes-easy-mc-form .yikes-easy-mc-submit-button
			{'; ?>
	...
	if($options['team_member_h_font_family']['attrs_in_use']) {
			...
			echo '.team-member h4, .row .col.section-title p, .row .col.section-title span, #page-header-bg .subheader, .republicpg-milestone .subject, .testimonial_slider blockquote span
			{'; ?>
