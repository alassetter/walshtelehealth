...
function republicpgWooProdSliderInit() {
  ...
  function republicpgWooProdSliderDestroy() {
  ...
  function leftAlignedRelationsInit() {
    ...
    $('[data-gallery-style="left_thumb_sticky"] .flickity.product-slider .slide').each(function(i){
      i = i + 1;
      $(this).find('.woocommerce-product-gallery__image').attr('id','republicpg_woo_gallery_slide_'+ i);
    ...
    $('[data-gallery-style="left_thumb_sticky"] .flickity.product-thumbs .thumb').each(function(i){
      i = i + 1;
      $(this).find('.thumb-inner').wrapInner('<a class="skip-hash" href="#republicpg_woo_gallery_slide_'+ i +'" />');
      ...
      if($('body.using-mobile-browser').length == 0) {
           ...
           $('body').on('mouseover','.product[data-gallery-style="left_thumb_sticky"] .images .slide',function(){
             ...
             if(imgWidth > $('.single-product .images .product-slider').width()) {
                 ...
                 $(this).removeClass('republicpg-no-larger-img');      
               ...
               $(this).addClass('republicpg-no-larger-img');
             }
  ...
  function republicpgWooProdSliderLiveOrDie() {
    
    if($(window).width() < 1000 && $mainProdSlider == false && $thumbProdSlider == false) {
      
      //carousel
      republicpgWooProdSliderInit();  
      ...
      republicpgWooProdSliderDestroy();
  ...
  if($('[data-gallery-style="left_thumb_sticky"]').length > 0) {
    republicpgWooProdSliderLiveOrDie();
    leftAlignedRelationsInit();
    $(window).on('resize',republicpgWooProdSliderLiveOrDie);
    leftAlignedZoomIcon();
		     		...
		     		$(attr_data).each(function(i, el){
                      ...
                      if(el.image.gallery_thumbnail_src) {
                          ...
                          if($('[data-gallery-style="left_thumb_sticky"]').length > 0 && $('body.mobile').length == 0) {
                            republicpg_scrollToY(0, 700, 'easeInOutQuint');
                          } 
                          //non left aligned
                          else {
  ...
  function productStickySS() {
	...
	if( $().theiaStickySidebar && $('.product[data-gallery-style="left_thumb_sticky"] .product-slider .slide').length > 0 ) {
     ...
     $('.single-product .product[data-gallery-style="left_thumb_sticky"]').prepend('<div class="republicpg-sticky-prod-wrap" />');
     $('.single-product .product[data-gallery-style="left_thumb_sticky"] .republicpg-sticky-prod-wrap').append(prodImg).append(prodDesc);
