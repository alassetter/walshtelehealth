...
jQuery(document).ready(function($){ 
	...
	var $captionTrans = 0;
	var $loading_bg_storage = $('.first-section .republicpg-slider-loading').css('background-image');
    ...
    function transparentheaderLoadingCalcs() {
    	...
    	if($('body #header-outer[data-transparent-header="true"]').length > 0) {
    		...
    		if($('#page-header-bg').length == 0) {
    			...
    			$('.republicpg-slider-wrap.first-section .swiper-container .swiper-wrapper .swiper-slide').addClass('not-loaded');
    			
    			if($('.container-wrap .main-content > .row > div').find('.republicpg-slider-wrap.first-section').length > 0) {
                ...
                if($('#header-outer[data-remove-border="true"]').length == 0) {
        			...
        			if($('.first-section .republicpg-slider-wrap[data-flexible-height="true"]').length == 0 && $('.first-section .republicpg-slider-wrap[data-fullscreen="true"]').length == 0) {
        				$('.first-section .republicpg-slider-loading').css({
        					'top': $('#header-space').height(),
        					'background-position' : 'center ' + ((($('.first-section .swiper-container').height()/2) + 15) - $('#header-space').height()) +'px'
        				});

                        $('.first-section .republicpg-slider-wrap .republicpg-slider-loading .loading-icon').css({
                            'opacity' : '1',
    ...
    $(window).on("pronto.request", function(){ 
        ...
        $('.republicpg-slider-wrap').each(function(){
    ...
    $(window).on("pronto.render vc_reload", function(){ 
        ...
        if($('.republicpg-slider-wrap').length > 0){
  ...
  var $onMobileBrowser = navigator.userAgent.match(/(Android|iPod|iPhone|iPad|BlackBerry|IEMobile|Opera Mini)/);
	...
	var republicpgSliderKenBurns;
	
	/*=========================
     Begin Republicpg Slider Main Construction
     ===========================*/
	var $republicpgSliders = [];
	
    function republicpgSliderMainInit() { 

        $republicpgSliders = [];

        //remove boxed full width attr when not needed
        $('.republicpg-slider-wrap[data-full-width="boxed-full-width"]').each(function(){ if($(this).parents('.wpb_column').length > 0 && $(this).parents('.full-width-content').length > 0) $(this).attr('data-full-width','false') });
        var $leftHeaderSize = ($('#header-outer[data-format="left-header"]').length > 0 && window.innerWidth >= 1000) ? parseInt($('#header-outer[data-format="left-header"]').width()) : 0;
        var $windowWidth = $(window).width() - $leftHeaderSize;

        if($('body > #boxed').length == 0 && $('.republicpg-slider-wrap[data-full-width="true"]').parent().attr('id') != 'portfolio-extra' && $('.republicpg-slider-wrap[data-full-width="true"]').parents('.post-area:not(".span_12")').length == 0){ 
            $('.republicpg-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .republicpg-slider-wrap').css({'left': -( ($windowWidth-$smoothSrollWidth)/2 - $('.main-content').width()/2), 'margin-left': '0' });
            $('.republicpg-slider-wrap[data-full-width="true"] .swiper-container, .republicpg-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .swiper-container, .parallax_slider_outer.first-section .republicpg-slider-wrap').css('width',$windowWidth);
        } 
        else if( $('.republicpg-slider-wrap[data-full-width="true"]').parent().attr('id') == 'portfolio-extra' && $('#full_width_portfolio').length != 0){  
            $('.republicpg-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .republicpg-slider-wrap').css({'left': -( ($windowWidth-$smoothSrollWidth)/2 - $('.main-content').width()/2), 'margin-left': '0' });
            $('.republicpg-slider-wrap[data-full-width="true"] .swiper-container, .republicpg-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .swiper-container, .parallax_slider_outer.first-section .republicpg-slider-wrap').css('width',$windowWidth);
        }
        else { 
            ...
            $('.republicpg-slider-wrap[data-full-width="true"] .swiper-container, .republicpg-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .swiper-container, .parallax_slider_outer.first-section .republicpg-slider-wrap').css('width',$($container).width());
        }
        
        //show slider once full width calcs have taken place
        $('.republicpg-slider-wrap, .slide-bg-overlay').show();
    	...
    	$('.republicpg-slider-wrap').each(function(i){
            ...
            if($(this).attr('data-transition') == 'fade' && $(this).attr('data-overall_style') != 'directional' && $(this).attr('data-button-styling') != 'btn_with_preview'){
                   ...
                   var touchRatio = 1.3;
                    ...
                    $sliderOptions = {
                        ...
                        onSlideChangeEnd: republicpgSlideRotateReset,
                        onTouchEnd: republicpgSlideRotateResetTouch,
                        
                        //onTouchEnd: captionTransition,
                        onSlideChangeStart: onChangeStart,
                        onTouchMove: clearAutoplay,
                        onFirstInit: republicpgInit,
                        progress: progressVar,
                        onProgressChange: function(swiper){
                           
                            if($(swiper.container).parents('.republicpg-slider-wrap').hasClass('loaded')) {
               ...
               var touchRatio = 0.6;
               var css3Trans = ($('#'+$(this).attr('id') + '.republicpg-slider-wrap[data-overall_style="directional"]').length == 1) ? false: true;
                $sliderOptions = {
                    loop: $useLoop,
                    grabCursor: $grab,
                    touchRatio: touchRatio,
    		...
    		$republicpgSliders[i] = new Swiper('#'+$(this).attr('id')+' .swiper-container', $sliderOptions);
    		$republicpgSliders[i].swipeReset();
        
        $('#'+$(this).attr('id')).addClass('republicpg-slider-enabled');
        ...
        ////default arrows
    		if($arrows == 'true' && $('#'+$(this).attr('id') +' .swiper-wrapper > div').length > 1 && $('#'+$(this).attr('id') + '.republicpg-slider-wrap[data-button-styling="btn_with_preview"]').length == 0 && $('#'+$(this).attr('id') + '.republicpg-slider-wrap[data-overall_style="directional"]').length == 0 ){
    			
    			$('.slide-count i').transition({ scale: 0.5, opacity: 0 });
    			
    			//hover event
    			$('body').on('mouseenter','.republicpg-slider-wrap[data-button-styling="btn_with_count"][data-overall_style="classic"]  .swiper-container .slider-prev, .republicpg-slider-wrap[data-button-styling="btn_with_count"] .swiper-container .slider-next',function(){
          ...
          $('body').on('mouseleave','.republicpg-slider-wrap[data-button-styling="btn_with_count"][data-overall_style="classic"] .swiper-container .slider-prev, .republicpg-slider-wrap[data-button-styling="btn_with_count"] .swiper-container .slider-next',function(){
                   ...
                   if($(this).parents('.swiper-container').attr('data-loop') != 'true') {
                       ...
                       if( $(this).parents('.swiper-container').find('.swiper-slide-active').index()+1 == 1 && !$('html').hasClass('no-video')){
                            ...
                            //make sure the animation is complete
                             ...
                             if( $(this).parents('.republicpg-slider-wrap ').attr('data-transition') != 'fade') {
            ...
            ////button with preview on hover
            else if($arrows == 'true' && $('#'+$(this).attr('id') +' .swiper-wrapper > div').length > 1 && $('#'+$(this).attr('id') + '.republicpg-slider-wrap[data-button-styling="btn_with_preview"]').length == 1 && $('#'+$(this).attr('id') + '.republicpg-slider-wrap[data-overall_style="directional"]').length == 0){
                ...
                function prevArrowAnimationWithPreview(e) {
                    ...
                    $(this).parents('.republicpg-slider-wrap').find('.swiper-slide-active').prev('.swiper-slide').removeClass('prev-high-z-index');
                    $(this).parents('.republicpg-slider-wrap').find('.swiper-slide-active').stop().removeClass('prev-move');
                ...
                function nextArrowAnimationWithPreview(e) {
                    ...
                    $(this).parents('.republicpg-slider-wrap').find('.swiper-slide-active').next('.swiper-slide').removeClass('high-z-index');
                    $(this).parents('.republicpg-slider-wrap').find('.swiper-slide-active').stop().removeClass('next-move');
                ...
                //hover event
                $('body').on('mouseenter','.republicpg-slider-wrap[data-button-styling="btn_with_preview"] .swiper-container .slider-next:not(.stophover)',function(){
                    
                    $(this).parents('.republicpg-slider-wrap').find('.swiper-slide-active').next('.swiper-slide').addClass('high-z-index');
                    $(this).parents('.republicpg-slider-wrap').find('.swiper-slide-active').stop().addClass('next-move');
                    $(this).stop().addClass('next-arrow-move');
                    darkSlideNextMouseOver($(this).parents('.republicpg-slider-wrap'), $(this).parents('.republicpg-slider-wrap').find('.swiper-slide-active').index());
                   
                });

                $('body').on('mouseleave','.republicpg-slider-wrap[data-button-styling="btn_with_preview"] .swiper-container .slider-next',function(){
                ...
                $('body').on('mouseenter','.republicpg-slider-wrap[data-button-styling="btn_with_preview"] .swiper-container .slider-prev:not(.stophover)',function(){
                    
                    $(this).parents('.republicpg-slider-wrap').find('.swiper-slide-active').prev('.swiper-slide').addClass('prev-high-z-index');
                    $(this).parents('.republicpg-slider-wrap').find('.swiper-slide-active').stop().addClass('prev-move');
                    $(this).stop().addClass('prev-arrow-move');
                    darkSlidePrevMouseOver($(this).parents('.republicpg-slider-wrap'), $(this).parents('.republicpg-slider-wrap').find('.swiper-slide-active').index());
                });

                $('body').on('mouseleave','.republicpg-slider-wrap[data-button-styling="btn_with_preview"] .swiper-container .slider-prev',function(){
            ...
            } else if($('#'+$(this).attr('id') + '.republicpg-slider-wrap[data-overall_style="directional"]').length == 1) {
                ...
                function prevArrowAnimationDirectional(e) {
                   ...
                   //make sure the animation is complete
                    ...
                    $timeout = setTimeout(function(){ 
                        ...
                        setTimeout(function(){ 
                            $republicpgSliders[i].updateActiveSlide();
                            $republicpgSliders[i].fixLoop();
                    ...
                    $timeout2 = setTimeout(function(){ 
                        ...
                        if($that.parents('.swiper-container').attr('data-loop') != 'true') {
                            if( $that.parents('.swiper-container').find('.swiper-slide-active').index()+1 != 1) {
                               onChangeStart($republicpgSliders[i]); 
                            }
                        }
                   ...
                   if($(this).parents('.swiper-container').attr('data-loop') != 'true') {
                    ...
                    if($that.parents('.republicpg-slider-wrap').is('[data-bg-animation="ken_burns"]')) {
                        
                        $that.parents('.swiper-container').find('.swiper-slide').attr('data-ken-burns','active');
                        
                        clearTimeout(republicpgSliderKenBurns);
                        republicpgSliderKenBurns = setTimeout(function(){
                ...
                function resetContentPos() {
                    $($republicpgSliders[i].container).find('.swiper-slide .content > *').transition({ 'x': '0px' }, 0); 
                }
    	    ...
    	    if($bullets != null && $('#'+$(this).attr('id') +' .swiper-wrapper > div').length > 1 ){
    		    $('#'+$(this).attr('id')+' .slider-pagination .swiper-pagination-switch').click(function(){
    		        $republicpgSliders[i].swipeTo($(this).index());
    		    });
    	    }
    	});
    ...
    function directionalNavColorInit(slider) {
        ...
        if(slider.attr('data-overall_style') == 'directional' && slider.find('.swiper-slide[data-color-scheme="dark"]').length > 0 && $('#header-outer[data-transparent-header="true"]').length > 0) {
            ...
            if( slider.parents('.parallax_slider_outer').length > 0 || slider.parents('.first-section').length > 0 ) {
                ...
                $selector = ($('#header-outer[data-permanent-transparent="1"]').length == 0) ? '#header-outer' : '#header-outer .midnightHeader.republicpg-slider';
                ...
                $($selector+' .cart-outer .cart-icon-wrap').each(function(){
                    $(this).find('> i').remove();
                    $(this).append('<span class="dark"><span><i class="icon-blueprint-cart"></i></span></span>');
                    $(this).append('<span class="light"><span><i class="icon-blueprint-cart"></i></span></span>');
                    $(this).append('<span class="original"><span><i class="icon-blueprint-cart"></i></span></span>');
                });
                setTimeout(function(){
                     $($selector+' .cart-outer .cart-icon-wrap').each(function(){
    ...
    function initialSlideLoad() {
        ...
        $('.swiper-wrapper').each(function(){
            if($(this).find('.swiper-slide:nth-child(2) video').length > 0) $(this).find('.swiper-slide:nth-child(2)').addClass('first_video_slide');
              ...
              //ken burns start
              if($(this).parents('.republicpg-slider-wrap[data-bg-animation="ken_burns"]').length > 0) {
        ...
        slideAnimationQueues[i] = {
    		...
    		var $sliderWrapCount = $('.republicpg-slider-wrap').length;
    		var $that = $(this);
        ...
        //store animation queue arr obj
    		...
    		if($(this).find('.swiper-slide-active video').length > 0){
                ...
                //var videoReady = setInterval(function(){
                    ...
                    if($('#ajax-loading-screen[data-effect="center_mask_reveal"]').length > 0 && $that.parents('.parallax_slider_outer').length > 0 ||
                       $('#ajax-loading-screen[data-effect="center_mask_reveal"]').length > 0 && $that.hasClass('first-republicpg-slider') ) {
                         $timeout = 450;
                    } 

          					setTimeout(function(){ captionTransition($republicpgSliders[i]); onChangeStart($republicpgSliders[i]); },$timeout); 
          					darkFirstSlide($that);
                    //clearInterval(videoReady);
  				
                    $that.addClass('loaded');
                    if($that.parents('.parallax_slider_outer').length > 0 || $that.hasClass('first-republicpg-slider')) {
            ...
            //},60);
    			...
    			//ie8
    				...
    				slideContentPos();
    				sliderLoadIn($that,i);
    				captionTransition($republicpgSliders[i]);
                    darkFirstSlide($that);
    			}
    		} 
    		...
    		if(navigator.userAgent.match(/(Android|iPod|iPhone|iPad|IEMobile|Opera Mini)/)){
              ...
              $('.republicpg-slider-wrap').find('.republicpg-slider-loading').fadeOut(800,'easeInOutExpo');
              $('.republicpg-slider-wrap.first-section .swiper-container .swiper-wrapper .swiper-slide').removeClass('not-loaded');
  ...
  for(var nsCount=0; nsCount<$republicpgSliders.length; nsCount++) {
    $republicpgSliders[nsCount].resizeFix();
  }
  
  $('.parallax_slider_outer .republicpg-slider-wrap .slide-bg-wrap').each(function(){
  ...
  document.addEventListener("visibilitychange", function() {
	...
	function dynamicHeightSliders(){
        ...
        if(window.innerWidth > 1000) {
            $('body.material:not("[data-header-format=\'left-header\']") .parallax_slider_outer.first-section .republicpg-slider-wrap').css('top',$('#ajax-content-wrap').offset().top);
        } else {
            $('body.material:not("[data-header-format=\'left-header\']") .parallax_slider_outer.first-section .republicpg-slider-wrap').css('top','0');
        }
           ...
           $(this).attr('data-fullscreen') == 'true' && $(this).parents('.full-width-content').length > 0 && $(this).parents('.vc_col-sm-12').length > 0 ) {
            ...
            if($(this).parents('#republicpg_fullscreen_rows').length == 0) {
                ...
                $resize = ($('#header-outer[data-header-resize="0"]').length > 0) ? 0 : parseInt(shrinkNum) + headerPadding*2;
                            ...
                            if($('#republicpg_fullscreen_rows').length > 0 || ($('body[data-header-format="left-header"]').length > 0 && window.innerWidth >= 1000)) $headerSize = $adminBarHeight;
    						//min height
              ...
              if($('#header-outer[data-remove-border="true"]').length == 0) {
        					if($('body #header-outer[data-transparent-header="true"]').length > 0
        					   && $('.first-section .republicpg-slider-wrap[data-fullscreen="true"]').length > 0 
				...
				if($(this).attr('data-flexible-height') == 'true' && $(this).attr('data-fullscreen') != 'true') {
					...
					//transparent header loading icon center
					if($('body #header-outer[data-transparent-header="true"]').length > 0 && 
					   $('.first-section .republicpg-slider-wrap[data-flexible-height="true"]').length > 0) {
	...
	function sliderSize(){
		...
		if( window.innerWidth < 1000 && window.innerWidth > 690 ) {
			...
			//fullwidth sliders
			$('.republicpg-slider-wrap[data-full-width="true"]:not([data-fullscreen="true"],[data-flexible-height="true"])').each(function(i){
				currentKey = $existingSliders.getKeyByValue($(this).attr('id')); 
				$(this).find('.swiper-container').attr('data-height',$sliderHeights[currentKey]/1.4 )	
			});
			
			//column sliders
			$('.republicpg-slider-wrap[data-full-width="false"]:not([data-fullscreen="true"]):not([data-flexible-height="true"])').each(function(i){
				currentKey = $existingSliders.getKeyByValue($(this).attr('id')); 
			...
			//boxed sliders
			$('.republicpg-slider-wrap[data-full-width="boxed-full-width"]:not([data-flexible-height="true"]):not([data-fullscreen="true"])').each(function(i){
				currentKey = $existingSliders.getKeyByValue($(this).attr('id')); 
		  ...
		  $('.republicpg-slider-wrap[data-full-width="boxed-full-width"]:not([data-flexible-height="true"]):not([data-fullscreen="true"])').each(function(i){
			...
			//boxed sliders
			$('.republicpg-slider-wrap[data-full-width="false"]:not([data-fullscreen="true"]), .republicpg-slider-wrap[data-full-width="boxed-full-width"]:not([data-flexible-height="true"]):not([data-fullscreen="true"])').each(function(i){
				currentKey = $existingSliders.getKeyByValue($(this).attr('id')); 
				if($(this).attr('data-flexible-height') != 'true') $(this).find('.swiper-container').attr('data-height',$sliderHeights[currentKey] )	
			});
		}
    ...
    function nsSliderContentResize(e){
         ...
         for(var i=0; i < $republicpgSliders.length; i++){

            //make sure the parent is not hidden
            if($($republicpgSliders[i].container).parent().attr('data-transition') && $($republicpgSliders[i].container).parent().attr('data-transition') == 'fade') {
                
                for(var k=0; k < $republicpgSliders[i].slides.length; k++){
                      $republicpgSliders[i].setTransition($republicpgSliders[i].slides[k], 0);
                }

                $('.swiper-wrapper').stop(true,true).css('transition-duration','0s');

                if($('.republicpg-slider-loading').css('display') == 'none') {
                    
                    //var captionTransString = $($republicpgSliders[i].container).parent().is('[data-caption-trans]') ? $($republicpgSliders[i].container).parent().attr('data-caption-trans') : 'fade_in_from_bottom';
                    //$($republicpgSliders[i].container).find('.swiper-slide-active').find('.content').children().each(function(i){
	...
	function resizeToCover() {
		$('.republicpg-slider-wrap').each(function(i){
          ...
          var $windowWidth = $(window).width() - $leftHeaderSize;
    			...
    			//width resize 
    			if($('body > #boxed').length == 0 && $('.republicpg-slider-wrap[data-full-width="true"]').parent().attr('id') != 'portfolio-extra' && $(this).parents('.post-area:not(".span_12")').length == 0){ 
    				$('.republicpg-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .republicpg-slider-wrap').css({'left': -( ($windowWidth-$smoothSrollWidth)/2 - $('.main-content').width()/2), 'margin-left': '0' });
    				$('.republicpg-slider-wrap[data-full-width="true"] .swiper-container, .republicpg-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .swiper-container, .parallax_slider_outer.first-section .republicpg-slider-wrap').css('width',$windowWidth);
    				...
    				//backup incase only slider is used with nothing else in boxed mode
    				if($($container).width() == '0' && $('body > #boxed').length > 0) $container = '#boxed';
    				$('.republicpg-slider-wrap[data-full-width="true"] .swiper-container, .republicpg-slider-wrap[data-full-width="true"], .parallax_slider_outer.first-section .swiper-container, .parallax_slider_outer.first-section .republicpg-slider-wrap').css({'width':$($container).width(), 'margin-left': '0'});
    			}
          ...
          if(!$(this).is('[data-parallax="true"]')) { 
                ...
                /*if($('body[data-header-format="left-header"]').length > 0) {
                    $('.parallax_slider_outer.first-section .republicpg-slider-wrap, .parallax_slider_outer.first-section .republicpg-slider-wrap .swiper-container').css('width',$('#ajax-content-wrap').width());
  ...
  var previousSlide = 0;
	...
	function captionTransition(obj){ 
			...
			(typeof obj == 'undefined') ? $containerClass = 'div[id^=ns-id-]' : $containerClass = '#'+$(obj.container).parents('.republicpg-slider-wrap').attr('id'); ;
        ...
        if($($containerClass).attr('data-overall_style') != 'directional') {
            ...
            setTimeout(function(){
                ...
                if($('.slider-next').hasClass('next-arrow-move')) {
                    $('.republicpg-slider-wrap[data-button-styling="btn_with_preview"] .swiper-container .slider-next').trigger('mouseenter');
                } else if($('.slider-prev').hasClass('prev-arrow-move')) {
                    $('.republicpg-slider-wrap[data-button-styling="btn_with_preview"] .swiper-container .slider-prev').trigger('mouseenter');
                }
  ...
  function NSsplitLineText() {
		$('.republicpg-slider-wrap[data-caption-trans="reveal_title"] .content h2').each(function(){
...
function charming(element, options) {
  ...
  function captionTransAnimation(obj,index,animationName) {
	...
	function slideContentPos(){
		...
		$('.swiper-wrapper').each(function(){
			...
			var $extraHeight = ($(this).parents('.republicpg-slider-wrap').hasClass('first-section') || $(this).parents('.parallax_slider_outer').hasClass('first-section')) ? 30 : 0;
	...
	function sliderLoadIn(slider,index) { 
		...
		slider.find('.republicpg-slider-loading').fadeOut(800,'easeInOutExpo');
    
    setTimeout(function(){
      slider.find('.republicpg-slider-loading').css('display','none');
    },1000);
    ...
    function autorotateInit(slider,num) {
    	...
    	//$('.republicpg-slider-wrap').each(function(i){
    		...
    		if(typeof $autoplayVal !='undefined' && $autoplayVal.length != '0' && parseInt($autoplayVal)) { 
    			republicpgSlideRotateInit(slider,$autoplayVal,$sliderNum);
	...
	function republicpgSlideRotateInit(slider,interval,sliderNum){

		autoplay[sliderAutoplayCount] = { interval: setInterval(function(){ republicpgSlideRotate(slider, sliderNum); } ,interval), republicpgSliderNum: sliderNum, autoplayNum: sliderAutoplayCount, republicpgSliderID: slider.attr('id') };
    ...
    var sliderNumClosure = sliderNum;
      ...
      republicpgSlideRotateReset(sliderClosure, sliderAutoplayCountClosure, intervalClosure, sliderNumClosure);
  ...
  function republicpgSlideRotateReset(slider, sliderAutoplayCount, interval,sliderNum){
    ...
    if( sliderAutoplayCount === 'unknown') {
      ...
      $.each(autoplay,function(k,v){
        ...
        if( $('body').find('#' + v.republicpgSliderID).length > 0 && v.republicpgSliderID == $(slider).attr('id') ) {
          
          sliderAutoplayCount = v.autoplayNum;
          interval = ($('body').find('#' + v.republicpgSliderID).attr('data-autorotate').length > 0 && parseInt($('body').find('#' + v.republicpgSliderID).attr('data-autorotate')) > 1000) ? $('body').find('#' + v.republicpgSliderID).attr('data-autorotate') : 4000;
          sliderNum = v.republicpgSliderNum;
    ...
    if( sliderAutoplayCount !== 'unknown') {
      ...
      autoplay[sliderAutoplayCount].interval = setInterval(function(){ republicpgSlideRotate(slider, sliderNum); } ,interval);
    }
  ...
  function republicpgSlideRotateResetTouch(slider){
    ...
    republicpgSlideRotateReset(slider);
	...
	function republicpgSlideRotate(slider, sliderNum){
        ...
        //non looped
		if($republicpgSliders[sliderNum].activeIndex + 1 < $(slider).find('.swiper-wrapper > div.swiper-slide').length){
            ...
            if($(slider).attr('data-overall_style') != 'directional') {
                $republicpgSliders[sliderNum].swipeNext();
            } else {
                //directional based
                $($republicpgSliders[sliderNum].container).find('.slider-next').trigger('click');
            }
            ...
            //regular sliders
                ...
                if($(slider).attr('data-overall_style') != 'directional') {
                    $republicpgSliders[sliderNum].swipeTo(0,550);
                } else {
                    ...
                    var $timeout2;     
                    clearTimeout($timeout2);
                    $timeout2 = setTimeout(function(){ onChangeStart($republicpgSliders[sliderNum]); } ,100);
                }
	...
	function onChangeStart(e){
        ...
        if($($obj.container).parent().attr('data-overall_style') != 'directional') {
            if( $($obj.container).parents('.first-section').length > 0 && $($obj.container).find('.swiper-slide-active[data-color-scheme="dark"]').length > 0 ||
                $('#republicpg_fullscreen_rows').length > 0 && $($obj.container).find('.swiper-slide-active[data-color-scheme="dark"]').length > 0) {
                $('#header-outer').addClass('dark-slide');
            } else if( $($obj.container).parents('.first-section').length > 0 || $('#republicpg_fullscreen_rows').length > 0) {
                $('#header-outer').removeClass('dark-slide');
            }
        } 
    ...
    if($($obj.container).parent().is('[data-bg-animation="ken_burns"]') && $($obj.container).parents('.republicpg-slider-wrap[data-overall_style="directional"]').length == 0 ) {
    ...
    var nsTimeout = ($($obj.container).parents('.republicpg-slider-wrap[data-transition="fade"]').length > 0) ? 350 : 525;
    
		clearTimeout(slideAnimationQueues[sliderIndex].captionInterval);
    if($($obj.container).parents('.republicpg-slider-wrap[data-overall_style="directional"]').length == 0) {
        ...
        if( $($obj.container).attr('data-loop') == 'true' ) {
            ...
            $.each($republicpgSliders,function(k,v){
              $republicpgSliders[k].updateActiveSlide();
              $republicpgSliders[k].fixLoop(); 
            });
        }
	...
	function hideSlider() {
		...
		if( $(window).scrollTop()/($sliderHeight + portfolioHeaderHeight + 125) >= 1){
			$('.parallax_slider_outer .republicpg-slider-wrap, .project-title.parallax-effect').css('visibility','hidden').hide();
			$('.parallax_slider_outer').removeClass('element-in-view').addClass('element-out-of-view');

            //directional slider autorotate clear
            if($('.parallax_slider_outer .republicpg-slider-wrap[data-overall_style="directional"]').length > 0) {
                var $autoplayVal = $('.parallax_slider_outer .republicpg-slider-wrap[data-overall_style="directional"]').attr('data-autorotate');
                if(typeof $autoplayVal !='undefined' && $autoplayVal.length != '0' && parseInt($autoplayVal)) { 
                    clearInterval( autoplay[$('.parallax_slider_outer .republicpg-slider-wrap').attr('autoplay-id')].interval ); 
                }
            }
	...
	function showSlider() {
		if( $(window).scrollTop()/($sliderHeight + portfolioHeaderHeight + 125) <= 1){
			...
			$('.parallax_slider_outer .republicpg-slider-wrap, .project-title.parallax-effect').css('visibility','visible').show();
			$('.parallax_slider_outer').addClass('element-in-view');

            //directional slider autorotate restart
            if($('.parallax_slider_outer .republicpg-slider-wrap[data-overall_style="directional"]').length > 0 && $('.parallax_slider_outer.element-out-of-view').length > 0 && $('.parallax_slider_outer.user-stopped').length == 0) {
                var $autoplayVal = $('.parallax_slider_outer .republicpg-slider-wrap[data-overall_style="directional"]').attr('data-autorotate');
                if(typeof $autoplayVal !='undefined' && $autoplayVal.length != '0' && parseInt($autoplayVal)) { 
                    republicpgSlideRotateInit($('.parallax_slider_outer .republicpg-slider-wrap'),$autoplayVal,0);
                } 
            }  
			...
			if($('.parallax_slider_outer').length > 0) {
				var fromLeft = Math.abs(parseInt($('.parallax_slider_outer .republicpg-slider-wrap .swiper-wrapper').css('left')));
				var currentSlide = Math.round(fromLeft/$('.parallax_slider_outer .republicpg-slider-wrap .swiper-slide').width()); 
  ...
  var republicpgDisableForSafari = (navigator.userAgent.indexOf('Safari') != -1 && navigator.userAgent.indexOf('Chrome') == -1);
  var $scrollTop = $(window).scrollTop();
  var parallaxSliderStyle = (parallaxSliderEl.find('> .republicpg-slider-wrap[data-parallax-style="bg_only"]').length > 0) ? 'bg-only' : 'both';
	...
	function parallaxScroll(){
        ...
        if($onMobileBrowser){
          $('.parallax_slider_outer .republicpg-slider-wrap .slide-bg-wrap').css({ 'transform': 'translate3d(0, '+$scrollTop*0.25+'px, 0)' });
          ...
          $('.parallax_slider_outer .republicpg-slider-wrap .slide-bg-wrap').css({ 'transform': 'translate3d(0, '+$scrollTop*0.25+'px, 0)' });
            ...
            if($smoothActive == 1 && republicpgDisableForSafari) { return false; }
            ...
            $('.parallax_slider_outer.first-section .republicpg-slider-wrap').css({ 'transform': 'translateY('+$scrollTop*-$multiplier1+'px)' });
            
            $('.parallax_slider_outer.first-section .swiper-slide:not(".static"):not(".caption-no-fade") .content, .republicpg-slider-wrap .swiper-container .slider-next, .republicpg-slider-wrap .swiper-container .slider-prev, .swiper-wrapper .slider-down-arrow').css({ 'transform': 'translateY('+$scrollTop*-$multiplier2+'px)' });
            
            if(!$headerRemoveStickyness) {
                $('.parallax_slider_outer.first-section .swiper-slide:not(".static"):not(".caption-no-fade") .content, .republicpg-slider-wrap .swiper-container .slider-next, .republicpg-slider-wrap .swiper-container .slider-prev, .swiper-wrapper .slider-down-arrow').css({ 'opacity': 1-($scrollTop/($sliderHeight-120)) });
            }
    ...
    */
        ...
        //$(window).off('scroll.nsCorrectDisplayCheck');
          ...
          'width' : $('#ajax-content-wrap').width()
    		...
    		if($('.project-title.parallax-effect').length > 0) {
    			$('.parallax_slider_outer.first-section .swiper-slide .content, .republicpg-slider-wrap.first-section .swiper-slide .content').css('margin-top','0px');
	...
	function prettyPhotoInit(){
		...
		$(".republicpg-slider-wrap a[rel^='prettyPhoto']").prettyPhoto({
			theme: 'dark_rounded',
			allow_resize: true,
			default_width: 690,
			opacity: 0.85, 
			...
			markup: '<div class="pp_pic_holder"> \
						   <div class="ppt">&nbsp;</div> \
							<div class="pp_details"> \
								<div class="pp_nav"> \
								    <a href="#" class="pp_arrow_previous"> <i class="icon-blueprint-left-arrow-thin icon-default-style"></i> </a> \
									<a href="#" class="pp_arrow_next"> <i class="icon-blueprint-right-arrow-thin icon-default-style"></i> </a> \
									<p class="currentTextHolder">0/0</p> \
								</div> \
								<a class="pp_close" href="#"><span class="icon-blueprint-x icon-default-style"></span></a> \
							</div> \
