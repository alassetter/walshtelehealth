...
(function(global, factory) {
    ...
    if($('.republicpg_using_pfsr').length > 0) {
      var iscrollOptions = {
          scrollbars: true,
          mouseWheel: false,
          hideScrollbars: false,
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        FP.reBuild = function(resizing){
            ...
            $(SECTION_SEL).each(function(){
             ...
             /* republicpg addition */ 
            if($('#republicpg_fullscreen_rows[data-animation="none"]').length == 0) { 
                $('#republicpg_fullscreen_rows').css('height', windowsHeight + 'px');
            }

            //middle alignment of rows when desktop scroll overflow is turned off
            if($('#republicpg_fullscreen_rows[data-content-overflow="hidden"]').length > 0) { 
            	$('#republicpg_fullscreen_rows>.vc_row.vc_row-flex:not(#footer-outer)>.fp-tableCell>.full-page-inner-wrap-outer>.full-page-inner-wrap[data-content-pos="middle"] > .full-page-inner>.container>.span_12').css('height', windowsHeight + 'px');
            	$('#republicpg_fullscreen_rows>.vc_row.vc_row-flex:not(#footer-outer)>.fp-tableCell>.full-page-inner-wrap-outer>.full-page-inner-wrap[data-content-pos="middle"]').css('overflow', 'hidden');
            }
        ...
        function bindEvents(){
            $window
                ...
                $(window).on( 'vc_reload',function(){
                  ...
                  $('#republicpg_fullscreen_rows > div.vc_element').addClass('fp-section');
                  $('#republicpg_fullscreen_rows > div.vc_element').each(function(){
        ...
        */
        function styleSection(section, index){
            ...
            if($('#republicpg_fullscreen_rows[data-content-overflow="hidden"]').length > 0) $('#republicpg_fullscreen_rows>.vc_row.vc_row-flex:not(#footer-outer)>.fp-tableCell>.full-page-inner-wrap-outer>.full-page-inner-wrap[data-content-pos="middle"] > .full-page-inner>.container>.span_12').css('height', windowsHeight + 'px');
        ...
        */
        ...
        function addVerticalNavigation(){
            if($('#republicpg_fullscreen_rows').attr('data-dot-navigation') == 'hidden') { return; }

            if($('#boxed').length > 0) {
            	$('#boxed').append('<div id="' + SECTION_NAV + '" class="'+$('#republicpg_fullscreen_rows').attr('data-dot-navigation')+'"><ul></ul></div>');
            }
            else {
            	$body.append('<div id="' + SECTION_NAV + '" class="'+$('#republicpg_fullscreen_rows').attr('data-dot-navigation')+'"><ul></ul></div>');
            }
            ...
            /*republicpg addition - front end editor create new section control */
            if(window.vc_iframe) {
              var $addnewElClone = $('#republicpg_fullscreen_rows > #vc_no-content-helper').clone();
              setTimeout(function(){
              ...
              $('body').on('click.vc_fp_new_section_rel','#fp-nav ul .vc-c-icon-add',function(e) {
                 $('#republicpg_fullscreen_rows > #vc_no-content-helper #vc_not-empty-add-element .vc-c-icon-add').trigger('click');
                 e.preventDefault();
                 return false;
              });
            }
            ...
            if($('#republicpg_fullscreen_rows[data-footer="last_row"]').length > 0 || $('#republicpg_fullscreen_rows[data-footer="default"]').length > 0) {
        ...
        function scrolling(type, scrollable){
            ...
            if(scrollable.length > 0 ){
                ...
                if(options.scrollOverflowHandler.isScrolled(check, scrollable)){
                	...
                	//* republicpg addition */
                	if( $('#republicpg_fullscreen_rows.nextSectionAllowed').length > 0) {
                   		scrollSection();
                   	}
                    setTimeout(function(){ $('#republicpg_fullscreen_rows').addClass('nextSectionAllowed'); },150);
                }else{
                    return true;
                }
            }else{
        ...
        */
        function scrollPage(element, callback, isMovementUp){
        	/* republicpg addition of ||canScroll and element.length == 0  */ 
        ...
        */
        function performMovement(v){
            ...
            if($('#republicpg_fullscreen_rows[data-animation-speed="medium"]').length > 0) {
                    var $timeOutDur = ($('.last-before-footer').length == 0) ? 910 : 530;
                }
                else if($('#republicpg_fullscreen_rows[data-animation-speed="slow"]').length > 0) {
            ...
            if (options.css3 && !options.scrollBar && $('#republicpg_fullscreen_rows[data-animation="none"]').length == 0) {
                  ...
                  if($('.last-before-footer').length == 0) {
                        ...
                        if(options.scrollingSpeed){
                          ...
                          if(window.vc_iframe) {
                            ...
                            var $cur_section = $('#republicpg_fullscreen_rows > .active');
                            requestAnimationFrame(switchedSection);
      ...
      $('#republicpg_fullscreen_rows').removeClass('trans-animation-active');
        ...
        */
        function playMedia(destiny){
            ...
            destiny.find('video.republicpg-video-bg').each(function(){
                ...
                if(  typeof element.play === 'function' ) {
                    ...
                    if( navigator.userAgent.match(/(Android|iPod|iPhone|iPad|BlackBerry|IEMobile|Opera Mini)/)) {
                        element.onplay = function(){
                           videoBGStored.parents('.republicpg-video-wrap').animate({'opacity':'1'},200);
                        }
                    }
            ...
            //youtube videos
            destiny.find('.republicpg-youtube-bg iframe[src*="youtube.com/embed/"]').each(function(){
                var element = $(this).get(0);
        ...
        */
        ...
        function sectionBulletHandler(e){
            e.preventDefault();
            /* republicpg addition */ 
            if($('#republicpg_fullscreen_rows .wpb_row.transition-out').length == 0) {
        ...
        */
        ...
        function resizeHandler(){
        	if($('#republicpg_fullscreen_rows.afterLoaded').length == 0) return false;
        ...
        */
        function createSlimScrolling(element){
        	...
        	var $fpScrollOverflow = ($('#republicpg_fullscreen_rows').attr('data-content-overflow') == 'hidden') ? false : true;
            ...
            //needs scroll?
             if ( contentHeight > windowsHeight+5 && $(element).find('.republicpg-slider-wrap[data-fullscreen="true"]').length == 0 && !($(window).width() > 1000 && $fpScrollOverflow == false) ) {
        ...
        function addTableClass(element){
            /*republicpg addition - front end editor*/
            if(window.vc_iframe) {
    ...
    var iscrollHandler = {
        ...
        */
        ...
        isScrolled: function(type, scrollable) {
            ...
            /* republicpg addition */ 
            if (type === 'top') {
            	$('#republicpg_fullscreen_rows').addClass('nextSectionAllowed');
