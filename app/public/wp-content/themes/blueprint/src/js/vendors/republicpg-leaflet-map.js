jQuery(document).ready(function($){
  ...
  var maps = [];
   ...
   $(window).on( 'vc_reload', function() {
     ...
     maps = [];
     republicpgLeafletInit();
   });
   
  function republicpgLeafletInit() {
    
    $('.republicpg-leaflet-map').each(function(i){
        ...
        $('.map-marker-list.'+mapID).each(function(){
                  ...
                  if(markerStyle == 'republicpg') {
                    ...
                    //regular
                    var customIcon = L.divIcon({
                        html: '<div class="republicpg-leaflet-pin"></div>',
                        iconSize: [34, 34],
                        popupAnchor: [-3, -13],
                        iconAnchor: [20, 20],
                    });
